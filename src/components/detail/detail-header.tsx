      ...
      <div className="mx-auto max-w-5xl px-4">
        <div className="flex h-16 items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={handleShare}
              className="inline-flex min-h-[40px] items-center gap-1.5 rounded-[4px] border border-[color:var(--ink-line-15)] bg-[var(--veil-80)] px-3 py-2 text-sm font-medium text-secondary transition hover:border-primary hover:bg-background"
