...
export const shoe: Shoe = {
  ...
  reviews: [
    ...
    {
        userType: '예상 적합 — 체중 부담이 큰 러너의 충격 완화',
        text: '체중이 있는 편이거나 착지 충격을 줄이는 것이 최우선인 러너를 겨냥한 맥시멀 쿠션화입니다. 41mm 스택이라 체중이 실려도 폼이 끝까지 눌리지 않는 쪽으로 설계돼, 느린 페이스의 장거리에서 안정적입니다. 기본 토박스가 72.5mm로 이 등급치고 넉넉하지 않아 발볼이 넓다면 와이드 선택이 사실상 필요합니다. 내구성 550km 기준 km당 약 416원으로 22만원대 가격 대비 운용 비용은 무난합니다. 다만 신발이 무릎 통증을 없애주지는 않습니다 — 쿠션은 충격의 크기를 줄일 뿐이고, 통증이 반복된다면 전문의 진단과 훈련량 조정이 먼저입니다.',
      },
    {
        userType: '예상 적합 — 7분대 페이스의 25km급 롱런',
        text: '7분/km 전후의 느린 페이스로 25km급 롱런을 소화하는 용도에 맞습니다. SA 146의 충격흡수와 힐 41mm 스택이라 20km를 넘겨도 발바닥에 피로가 쌓이지 않는 쪽이고, 플랫폼이 123.2mm로 넓어 평발 성향에서도 접지가 안정적입니다. 다만 303g으로 무거워 페이스가 올라가면 부담이 그대로 느껴지므로, 그룹런처럼 페이스가 변동하는 상황에는 맞지 않습니다. 기본 토박스가 72.5mm로 좁아 발볼이 넓다면 와이드가 사실상 필요하고, 내구성 550km 기준 km당 약 416원입니다.',
      },
  ],
  ...
  purchaseLinks: [{ store: '네이버', url: 'https://naver.me/551Gf7lV' }, { store: '쿠팡', url: 'https://link.coupang.com/a/g5YCpGHGAC' }],
};
