...
export const shoe: Shoe = {
  ...
  purchaseLinks: [{ store: '네이버', url: 'https://naver.me/xslD1XqM' }, { store: '쿠팡', url: 'https://link.coupang.com/a/g5YE8feqFo' }],
};
