...
export const shoe: Shoe = {
  ...
  reviews: [
    {
      userType: '에디터 분석',
      rating: 87,
      text: '호카의 가벼움과 반응성을 원하는 중급 러너에게 최적의 데일리 트레이너입니다. 232g 경량에 65.4% 에너지 리턴으로 클리프톤/본디보다 빠른 페이스에 적합하며, 36mm 힐 스택과 10mm 드롭으로 힐스트라이커에게 편안합니다. 18만 5천원으로 페가수스 41(15만 9천원)보다 저렴해 가성비가 좋고, 450km 내구성으로 km당 약 411원 수준입니다. 토박스가 70.1mm로 좁아 발볼 넓은 한국 러너는 와이드 옵션을 반드시 선택하세요. 통기성 5/5 최상위급으로 여름 러닝에 쾌적하지만, 겨울에는 Supercritical EVA 폼이 42% 더 단단해져 무릎 보호를 위해 클리프톤으로 교체하는 것을 권장합니다. 평발 러너도 무난하게 착용 가능하며 템포런부터 롱런까지 다용도 활용이 가능한 올라운더입니다.',
    },
    {
        userType: '예상 적합 — 훈련 전반을 한 켤레로 커버',
        text: '인터벌·템포런·롱런을 한 켤레로 소화하려는 러너에게 맞는 만능형 데일리입니다. 232g의 무게라 빠른 구간에서도 둔하지 않고, 에너지 리턴 65.4%로 템포 페이스에서 반발이 살아 있는 편입니다. 신발을 용도별로 나누기 전 단계에서 활용도가 높은 성격입니다. 토박스 70.1mm로 좁은 편이라 발볼이 넓거나 발등이 높다면 와이드를 권합니다. 폼이 오래 버티는 편이라 400km 이후에도 쿠션 저하가 급격하지 않아 운용 비용 면에서 유리합니다.',
      },
    {
        userType: '계절 적합성 — 여름 강점, 겨울 경화 주의',
        text: '계절에 따라 평가가 갈리는 모델입니다. 어퍼 통기성이 좋아 한여름에도 열감이 적은 반면, EVA 계열 폼이라 저온에서 경도가 약 42% 상승해 겨울에는 충격이 그대로 올라옵니다. 겨울 러닝 비중이 크다면 저온 경화가 적은 모델과 나눠 쓰는 운용이 필요합니다. 성능 자체는 232g의 무게에 힐 36mm 스택, 에너지 리턴 65.4%로 데일리 전반을 소화하는 수준입니다. 와이드 옵션이 있어 발볼 넓은 경우에도 대응되고, 내구성 450km 기준 km당 약 411원입니다.',
      },
  ],
  ...
  purchaseLinks: [{ store: '네이버', url: 'https://naver.me/xMnfwsEh' }, { store: '쿠팡', url: 'https://link.coupang.com/a/g5YEskxTzw' }],
};
