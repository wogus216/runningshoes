...
export const shoe: Shoe = {
  ...
  brand: 'Hoka',
  name: '스피드고트 7',
  image: '/images/shoes/hoka/speedgoat7/side.webp',
  images: [
    '/images/shoes/hoka/speedgoat7/side.webp',
    '/images/shoes/hoka/speedgoat7/front.webp',
    '/images/shoes/hoka/speedgoat7/back.webp',
    '/images/shoes/hoka/speedgoat7/angle.webp',
    '/images/shoes/hoka/speedgoat7/outsole.webp',
  ],
  category: '트레일',
  rating: 4.5,
  price: 219000,
  ...
  reviews: [
    ...
    {
        userType: '세대 비교 — 반발은 개선, 토박스는 후퇴',
        text: '전작 6과 비교하면 오르막에서 치고 나가는 반발이 개선됐고 그립은 그대로 유지됩니다. 반면 앞부분이 좁아져 발볼이 넓으면 6보다 조이는 느낌이 생기므로 반 치수 업이 필요할 수 있습니다. 가격도 올라, 반발 개선이 필요하지 않다면 6의 재고 가격이 합리적인 선택이 됩니다.',
      },
    {
        userType: '세대 비교 — 슈퍼크리티컬 폼 도입',
        text: '미드솔이 슈퍼크리티컬 폼으로 바뀌면서 오르막 구간의 반발이 살아난 것이 세대 변화의 핵심입니다. 트레일화가 무겁고 둔하게 느껴졌다면 체감 차이가 있습니다. 다만 토박스가 71.4mm로 전작보다 좁아져, 발볼이 넓으면 반 치수 업이 필요합니다. 가격도 219,000원으로 올라, 반발보다 핏과 가격을 우선한다면 전작 재고가 나은 선택일 수 있습니다.',
      },
  ],
