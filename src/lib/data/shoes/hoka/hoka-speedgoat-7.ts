...
export const shoe: Shoe = {
  ...
  reviews: [
    ...
    },
    {
      userType: '중급 러너',
      rating: 4,
      text: '주 40km 정도 뛰는 중급 러너인데, 스피드고트 6에서 7로 갈아탄 지 두 달째입니다. 관악산·불암산을 오가며 뛰는데 슈퍼크리티컬 폼으로 바뀌면서 오르막 치고 나가는 느낌이 확실히 살아났어요. 다만 제 발볼이 넓은 편이라 71.4mm로 좁아진 토박스가 6보다 조이는 느낌이 있어서 반 사이즈 크게 신었습니다. 219,000원으로 가격이 오른 게 아쉽지만 반발력 개선은 체감됩니다.',
    },
  ],
