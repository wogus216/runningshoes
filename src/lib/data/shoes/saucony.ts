...
export const sauconyShoes: Shoe[] = [
  {
    ...
    reviews: [
      ...
      { userType: '중급 러너', rating: 4, text: '주간 40km 훈련용으로 사용 중입니다. 라이드 17에서 업그레이드했는데, 255g으로 33g 감량이 체감됩니다. 대구 수성못 둘레길에서 주로 달리는데, HA 26 정도의 단단한 느낌이 오히려 안정적이라 좋아요. 님버스처럼 푹신한 건 아니지만 6분/km 데일리 페이스에서 무릎이나 발이 피로하지 않습니다. 토박스가 표준 폭이라 발볼 넓으면 와이드 필수이고, 600km 내구성은 고스트 17(800km)보다 짧지만 km당 266원이면 가성비 좋습니다.' },
  ...
  },
  {
    ...
    reviews: [
      ...
      { userType: '중급 러너', rating: 4, text: '반년째 데일리 + 템포런 겸용으로 사용 중입니다. 194g 경량에 4mm 드롭이라 2년 훈련으로 종아리 근력이 어느 정도 받쳐주니까 무리 없어요. 다만 솔직히 20km 이상 장거리에서는 SA 117 쿠셔닝이 부족합니다. 15km까지는 완벽한 신발인데, 그 이상 가면 무릎과 발바닥이 아파오기 시작해요. 토박스가 72mm로 표준이라 발볼 넓으면 빡빡할 수 있고, 장거리는 트라이엄프 23으로 돌리고 10km 이하 훈련에만 킨바라를 씁니다. 500km 내구성에 km당 310원으로 가성비 좋습니다.' },
  ...
  },
  {
    ...
    reviews: [
      ...
      { userType: '상급 러너', rating: 5, text: '알파플라이 3, 메타스피드 스카이+, 엔돌핀 엘리트 2 세 켤레 다 보유 중입니다. 197g 경량에 80.6% 에너지 리턴이라 순수 반발력만 놓고 보면 엘리트 2가 최강입니다. HA 6.5 극소프트 폼인데도 발이 빠지는 느낌이 아니라 튕겨주는 느낌이에요. 무릎 충격 흡수도 좋은 편입니다. 대신 토박스가 진짜 좁아서 255mm 이하 좁은 발이 아니면 고통스럽습니다. 발볼 넓은 한국 러너 평균 기준으로는 도박에 가깝고, 가성비도 km당 1,700원이라 대회 전용입니다.' },
    ],
    ...
    reviews: [
      {
        userType: '에디터 분석',
        rating: 82,
        text: '가성비 최강의 템포/레이싱 겸용 러닝화입니다. 21만 9천원에 73.2% 에너지 리턴과 SA 136 충격흡수를 제공하며, 한국 러닝 커뮤니티에서 "가성비 갓신발"로 불립니다. 218g 경량에 39mm 힐 스택, 8mm 드롭 구성이고, 나일론 플레이트로 카본보다 유연해 데일리 훈련에도 부담없습니다. HA 18.5로 v4보다 소프트해져 착화감이 좋아졌고, 토박스가 넓어져 발볼 걱정도 줄었습니다. 통기성 5/5로 여름에도 쾌적하고, 500km 내구성에 km당 438원으로 가성비 우수합니다. 무릎 보호와 추진력 모두 잡은 올라운더로, 서브4~서브3:30 목표 러너가 슈퍼슈즈 전에 먼저 경험해볼 추천 모델입니다. 와이드 옵션은 없지만 표준 발볼이면 편하고, 평발이 아닌 중립 러너에게 특히 적합합니다.',
      },
      { userType: '중급 러너', rating: 5, text: '한국 러닝 커뮤니티에서 "갓신발"이라길래 반신반의했는데, 진짜였습니다. 21만 9천원에 73.2% 에너지 리턴은 사기급 가성비예요. 218g 경량에 나일론 플레이트라 카본처럼 딱딱하지 않아서 매일 신어도 무릎이나 종아리에 무리가 없습니다. SA 136 충격흡수가 무릎 보호도 해주고, HA 18.5 소프트 폼으로 착화감이 편안합니다. 토박스도 넓어져서 270mm 발볼에 편하고, 서울대공원~과천 구간 왕복 14km를 주 3회 이 신발로 소화하고 있는데 400km째 성능 저하 없습니다. 와이드 옵션이 없는 게 아쉽지만 표준 발볼이면 충분하고, 500km 내구성에 km당 438원이면 훈련화로도 레이싱화로도 최고입니다.' },
      ...
      { userType: '입문 러너', rating: 4, text: '러닝 8개월 차인데 속도에 욕심이 생겨서 구매했습니다. 218g 경량에 킨바라 16이랑 비교하면 SA 136 쿠셔닝이 훨씬 좋으면서도 가볍고 빠른 느낌이에요. HA 18.5로 소프트해져서 무릎 부담이 적고, 73.2% 에너지 리턴 덕에 5분/km 페이스에서도 추진력을 느낍니다. 토박스도 넓어져서 발볼 265mm 표준인 제 발에 딱 맞습니다. 한 가지 아쉬운 점은 와이드 옵션이 없다는 것. 발볼 넓은 한국 러너는 시착 필수이고, 500km 내구성에 km당 438원이면 가성비 좋습니다. 한국 러닝 커뮤니티에서 입문 템포화로 추천하는 이유를 알겠어요.' },
    ],
  ...
  },
  {
    ...
    reviews: [
      ...
      { userType: '중급 러너', rating: 3, text: '냉정하게 평가하면, 285g은 슈퍼트레이너라기엔 무거운 편입니다. 줌플라이 6(269g)이나 하이페리온 맥스 3(283g)이 비슷한 가격에 더 가볍거든요. IncrediRUN 폼의 76.3% 에너지 리턴 반발력은 인정하지만, 토박스 70.1mm가 발볼 넓은 한국 러너에게 좁고, 4:30/km 템포런에서 무게가 걸림돌이에요. 무릎 보호와 가성비(km당 366원)는 좋지만 5:00/km 이상 장거리 훈련 전용으로 생각해야 합니다.' },
    ],
  ...
  },
  {
    ...
    reviews: [
      ...
      { userType: '중급 러너', rating: 4, text: '하프마라톤 1시간 35분 목표 러너입니다. 프로 4에서 업그레이드했는데 슬롯 플레이트 덕분에 전환이 더 자연스러워졌어요. 8mm 드롭이 후족부 착지에서 전족부로의 이행을 부드럽게 해줍니다. 다만 300km 내구성은 대회 전용으로만 써야 하는 제약이 있고, km당 997원이라 가성비는 아쉽습니다. 훈련은 스피드 5로, 대회는 프로 5로 나눠 신고 있어요. 발볼이 270mm 표준인데 토박스 여유가 있어서 와이드 없이도 편합니다. 무릎 보호 면에서도 39.5mm 스택이 충격을 잘 흡수해줍니다.' },
    ],
  ...
  },
  {
    ...
    reviews: [
      ...
      { userType: '입문 러너', rating: 4, text: '러닝 6개월차, 처음으로 퍼포먼스 트레이너를 사봤습니다. 이전에 라이드 18 신었는데 아주라가 233g으로 확실히 가볍고 반응이 좋아요. 265mm로 딱 맞게 신고 있는데 토박스 폭이 넉넉하진 않아 발볼 넓은 분은 주의하세요. 40mm 스택 쿠셔닝 덕에 무릎 충격이 잘 흡수되고 통기성도 괜찮습니다. 18만 9천원에 km당 315원이면 가성비 좋고, 한국 러닝 커뮤니티에서 평가도 좋아서 만족합니다.' },
    ],
  ...
  },
  {
    ...
    reviews: [
      ...
      { userType: '입문 러너', rating: 5, text: '라이드 18에서 업그레이드했어요. 265mm 와이드 착용 중인데, 전족부가 10mm 넓어져서 토박스 압박이 완전히 사라졌습니다. 발볼이 넓은 편이라 와이드 옵션이 있는 게 결정적이었어요. 한강 잠원~반포 구간 주 3회 5km 뛰는데, 확실히 착지가 부드러워져서 무릎 부담이 줄었습니다. 252g이라 가벼운 느낌이고, 700km 내구성이면 km당 256원이라 가성비도 좋아요. 한국 러닝 커뮤니티에서 입문화 추천 1순위인 이유를 알겠습니다.' },
      { userType: '중급 러너', rating: 4, text: '주간 35km 데일리 훈련용으로 쓰고 있습니다. 5분30초/km 페이스에서 252g 무게가 부담 없고, 37mm 힐 스택 덕에 18보다 쿠셔닝이 부드러워져서 장거리 15km 이상에서 피로감이 덜해요. 토박스가 넓어져서 발볼 270mm인 저도 표준 폭으로 편하게 신습니다. 다만 빠른 페이스(4:30/km 이하)에서는 여전히 물렁한 느낌이라 템포런은 스피드 5로 돌리고 있습니다. 무릎 보호와 가성비(km당 256원)를 모두 잡은 데일리화입니다.' },
    ],
