...
export const shoe: Shoe = {
  ...
  reviews: [
    ...
    {
        userType: '모델 선택 — 마하 X 3 대비 측면 안정성',
        text: '같은 슈퍼트레이너군에서 마하 X 계열(249,000원)보다 7만원 비싼데, 차별점은 측면 플레어의 안정감입니다. 스택이 높은 트레이너에서 좌우 흔들림이 신경 쓰였다면 이 구조가 값을 합니다. 201g으로 4분/km 인터벌에서도 가볍고, 39mm 스택이라 20km 장거리에서도 쿠션이 유지돼 한 켤레로 두 용도를 커버합니다. 토박스는 표준 수준입니다. 다만 내구성 400km로 짧아 km당 약 798원이라, 주행거리가 많으면 운용 비용이 빠르게 올라갑니다.',
      },
    {
        userType: '예상 적합 — 첫 슈퍼트레이너, 지지가 필요한 경우',
        text: '플레이트가 들어간 신발을 처음 신으면서 안정성도 필요한 경우에 맞습니다. 카본 인퓨즈드 나일론 플레이트라 순수 카본보다 강성이 낮아 전환이 급격하지 않고, 측면 플레어가 착지 시 발목 흔들림을 잡습니다. 5.5mm 드롭이라 미드풋 착지에 무리가 없습니다. 토박스가 한국 러너 평균 발볼(103mm 안팎)에 맞는 편이라 별도 와이드 없이도 압박이 적은 편입니다. 다만 힐이 각진 구조라 걷거나 계단을 내려갈 때 뒤꿈치가 걸리는 감각이 있고, 319,000원으로 진입 가격이 높습니다.',
      },
  ],
  ...
  purchaseLinks: [{ store: '쿠팡', url: 'https://link.coupang.com/a/g5YIuv3ECO' }],
};
