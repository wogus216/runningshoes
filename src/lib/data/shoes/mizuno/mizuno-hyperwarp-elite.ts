...
export const shoe: Shoe = {
  ...
  editorComment: '하이퍼워프 엘리트는 퓨어(139g/34mm)와 프로(201g/39mm) 사이에서 최적의 균형점을 찾은 마라톤 레이싱화입니다. 170g에 38mm 스택은 풀마라톤 후반부에서도 충분한 쿠셔닝을 제공하면서 가벼움을 유지합니다. 3-3.5mm 로우 드롭과 PEBA+카본 조합이 효율적인 전방 추진을 만들어내며, 서브엘리트~엘리트 러너의 마라톤 무기로 최적입니다. 34만 9천원으로 베이퍼플라이(30만 9천원)와 경쟁하며, 안정적인 플랫폼이 장점입니다. 슈퍼폼은 쓸수록 조용히 죽습니다 — 640km 시점 실측에서 충격 흡수가 20~28% 떨어졌는데 러너 본인은 2.7%만 줄었다고 느꼈다는 연구가 있습니다. 체감보다 누적 킬로미터로 교체 시점을 관리하세요.\n\n사이즈·구매 가이드: 토박스가 좁은 내로우 폭이고 와이드 옵션이 없으므로 발볼 넓은 러너는 반드시 반 사이즈 업 후 매장 시착을 거치세요. 349,000원에 km당 약 1,163원은 레이스 전용 투자이며, 풀마라톤 서브3~서브3:30 목표 러너에게 적합합니다. 베이퍼플라이 4나 메타스피드 스카이+를 함께 비교해 착화감과 안정성 차이를 확인해보세요.',
