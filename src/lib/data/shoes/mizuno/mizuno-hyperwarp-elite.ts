...
export const shoe: Shoe = {
  ...
  reviews: [
    ...
    {
        userType: '예상 적합 — 서브3 목표 마라토너',
        text: '풀코스 서브3를 노리는 러너를 겨냥한 레이싱화입니다. 170g의 무게에 38mm 스택을 유지해 30km 이후 구간에서도 쿠셔닝이 남도록 설계됐고, 3.5mm의 낮은 드롭이 전방 추진을 유도합니다. PEBA 폼이라 후반 무릎에 걸리는 부하를 흡수하는 쪽에 강점이 있습니다. 같은 급의 베이퍼플라이(309,000원)보다 안정감을 우선하고, 씨엘로보다는 가벼운 포지션입니다. 다만 토박스가 좁아 발볼이 넓다면 반 사이즈 업 또는 매장 시착이 필요합니다. 내구성 300km 수준의 레이스 전용이라 풀코스 3~4회 정도로 보는 것이 현실적입니다.',
      },
    {
        userType: '모델 선택 — 엘리트 vs 프로(안정성으로 갈린다)',
        text: '같은 라인에서 엘리트와 프로는 안정성으로 갈립니다. 엘리트는 170g의 경량에 카본 플레이트로 추진에 집중한 구성이라, 안정 요소가 적어 평발 성향이면 20km 이후 발 안쪽 피로가 누적될 수 있습니다. 지지가 필요하다면 측면 플레어가 있는 프로 쪽이 맞습니다. 토박스가 좁고 와이드 옵션이 없어, 발볼 106mm 이상이면 반 치수를 올려도 조임이 남습니다. km당 약 1,163원으로 레이스 전용 운용이 전제입니다.',
      },
  ],
