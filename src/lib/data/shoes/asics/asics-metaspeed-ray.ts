...
export const shoe: Shoe = {
  ...
  editorComment: '메타스피드 레이는 129g이라는 시장 최경량 무게로 "가벼움의 극한"을 추구한 엘리트 레이싱화입니다. FF Leap(ATPU) 폼은 FF Turbo+ 대비 15% 가볍고 13.7% 더 탄성 있으며, 전족부 에너지 리턴 81%는 업계 최고 수준입니다. 3/4 카본 플레이트라는 파격적 선택으로 전족부 착지 러너에게 최적화되어 있지만, 힐스트라이커에겐 비추천입니다. 39만 9천원으로 메타스피드 스카이(32만 9천원)보다 비싸지만, 5K~마라톤 전 거리에서 기록 단축을 노리는 엘리트에게 새로운 무기입니다. 초경량 카본화일수록 개인차 확인이 중요합니다 — 카본 이점이 러너에 따라 +11%에서 −11%까지 갈렸다는 연구가 있으니, 결전 투입 전 본인 페이스로 반드시 검증하세요.\n\n사이즈·구매 가이드: 토박스가 좁고 와이드 옵션이 없어 발볼 넓은 러너에게는 맞지 않습니다. 반드시 매장에서 착화 후 결정하거나, 발볼이 넓다면 메타스피드 스카이+를 선택하세요. 정가 399,000원에 내구성 200km 기준 km당 약 1,995원으로 대회 전용으로만 아껴 사용해야 합니다. 전족부 착지 패턴이 아니라면 메타스피드 스카이+나 메타스피드 엣지+가 더 적합합니다.',
  ...
  reviews: [
    ...
    {
        userType: '예상 적합 — 전족부 착지의 엘리트급 러너',
        text: '129g이라는 극단적 경량이 이 모델의 정체성입니다. 39.5mm 스택을 유지하면서 100g대에 들어간 조합이라, 스택 대비 무게로는 시판 레이서 중 최상단입니다. 카본의 스냅이 전족부에 집중되는 구조라 전족부 착지 러너에게 추진 효율이 높은 반면, 힐 착지 성향에서는 이점이 크게 줄어듭니다. 토박스가 좁고 와이드 옵션이 없어 발볼이 넓다면 후보에서 빼는 편이 낫습니다. 내구성 200km 기준 km당 약 1,995원으로 훈련 투입은 비효율적이고, 대회 3~4회를 목표로 아껴 쓰는 운용이 전제입니다.',
      },
    {
        userType: '비적합 — 힐 착지 성향 러너',
        text: '힐 착지 성향이면 이 모델의 성능을 쓸 수 없습니다. 플레이트가 3/4 길이라 뒤꿈치 아래에는 지지가 없어, 힐부터 닿는 착지에서는 반발이 만들어지지 않고 오히려 미끄러지는 감각이 생깁니다. 129g의 무게와 에너지 리턴 81%는 전족부 착지를 전제로 설계된 수치입니다. 399,000원이라는 가격을 감안하면, 시계에 기록된 착지 패턴이나 트레드밀 분석으로 본인 성향을 먼저 확인하는 편이 안전합니다. 힐 착지 비중이 높다면 같은 라인의 스카이+처럼 풀렝스 플레이트 모델이 맞습니다. 토박스도 좁아 발볼이 넓으면 5km 이후 압박이 생깁니다.',
      },
  ],
  ...
  purchaseLinks: [{ store: '네이버', url: 'https://naver.me/xEXKXHlH' }],
};
