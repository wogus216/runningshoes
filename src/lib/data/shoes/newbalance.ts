    ...
    reviews: [
      {
        userType: '에디터 분석',
        rating: 88,
        text: '860 V15는 안정화 본연의 역할에 매우 충실합니다. 과내전 제어와 쿠션의 균형이 좋고, 2E 옵션과 넓어진 힐 덕분에 발볼 넓은 러너도 접근성이 높습니다. 330g이 가볍진 않지만 easy run과 장거리에서 오히려 이 무게가 안정감으로 느껴질 가능성이 큽니다.',
      },
      {
        userType: '평발 러너',
        rating: 4.5,
        text: '860 v14보다 뒤꿈치가 더 편안하게 잡히고, 장거리에서 발이 안쪽으로 무너지는 느낌이 덜합니다. 2E로 신으면 앞발 공간도 충분해서 15km 넘어가도 발가락이 덜 답답해요. 속도 훈련보다는 매일 안정적으로 뛰기 좋은 신발입니다.',
      },
      {
        userType: '입문 러너',
        rating: 4.5,
        text: '중립화만 신으면 무릎 안쪽이 피곤했는데 860 V15는 착지부터 훨씬 안심이 됩니다. 출퇴근 워킹과 저녁 조깅을 같이 하는데 하루 종일 신어도 부담이 적고, 반사 디테일과 어퍼 마감도 만족스럽습니다.',
      },
    ],
