    ...
    reviews: [
      {
        userType: '에디터 분석',
        rating: 85,
        text: '입문~중급 러너에게 최적의 가성비 맥시멀 쿠션화입니다. 18만 9천원에 1080급 39.7mm 힐 스택을 제공하며, 무릎 부담이 걱정되는 초보 러너에게 추천합니다. 286g으로 무거운 편이라 5분/km 이하 빠른 페이스에는 부적합하지만, Fresh Foam X 미드솔이 8/10 쿠셔닝으로 장거리에서 무릎과 발바닥 충격을 확실히 흡수합니다. 4mm 로우드롭이 자연스러운 착지-이탈 전환을 돕고, 안정성 8/10으로 뒤꿈치 착지 러너에게도 안정적입니다. 2E/4E 와이드 옵션이 있어 발볼 넓은 한국 러너도 편하게 착용할 수 있고, 토박스 여유가 충분해 장거리 부종에도 대응됩니다. 600km 내구성으로 km당 315원의 가성비를 제공하며, 평발 러너도 편안합니다. "무릎 괜찮나요?" 질문에 자신있게 추천할 수 있는 신발입니다.',
      },
      {
        userType: '입문 러너',
        rating: 88,
      ...
      },
      {
        userType: '중급 러너',
        rating: 78,
        text: '월 120km 정도 뛰는데 리커버리 데이용으로 씁니다. 1080 v14가 메인이고 880은 천천히 뛸 때 신는 용도예요. 286g이 인터벌이나 빠른 페이스에는 확실히 부담되지만 6:00/km 이상 편하게 뛸 때는 40mm 힐 스택의 Fresh Foam X 쿠셔닝이 묵직하고 무릎 보호에 좋습니다. 4mm 드롭이 자연스러운 전환을 도와 뒤꿈치 착지에서 전족부로 부드럽게 넘어갑니다. 400km 넘게 신었는데 아웃솔 마모도 거의 없어서 600km 내구성은 충분히 달성할 것 같고, km당 315원으로 가성비가 뛰어납니다. 발볼이 넓어서 275mm 2E 와이드로 착용 중인데 토박스 여유가 충분해 한국 러너 발에 잘 맞고, 18만 9천원에 가성비 최고의 리커버리화입니다.',
      },
      {
        userType: '평발 러너',
        rating: 85,
        text: '평발이라 신발 고르기가 항상 어려웠는데, 275mm 2E 와이드로 신으니 발볼이 편하고 아치 부분도 너무 세게 잡지 않아서 좋습니다. 토박스 여유가 넉넉해 발가락이 자유롭고 장거리 뛸 때 부종이 와도 괜찮습니다. 분당 탄천에서 주 3회 5~7km 뛰고 있는데 286g 무게가 오히려 안정적으로 느껴지고, 39.7mm 힐 스택이 무릎 충격을 확실히 줄여줍니다. 이전에 신던 나이키 페가수스가 토박스가 좁아 발볼이 꽉 끼었는데 880은 처음부터 길들일 필요가 없었습니다. 한국 러너 중 평발이 많다고 하는데, 880이 안정성 8/10으로 평발에도 충분히 대응되고 18만 9천원에 600km 내구성이면 km당 315원으로 가성비까지 좋습니다. 4mm 드롭의 자연스러운 전환도 평발 특유의 과내전을 완화해주는 느낌이에요.',
      },
    ],
    ...
    reviews: [
      {
        userType: '에디터 분석',
        rating: 86,
        text: '프리미엄 쿠션화를 찾는 중급 이상 러너에게 추천합니다. HA 11.9 초소프트 미드솔로 착화감이 매우 편안하고, SA 142 충격흡수로 37mm 힐 스택에서 장거리에서도 무릎 부담이 적습니다. 4mm 드롭의 자연스러운 전환이 뒤꿈치 착지부터 이탈까지 매끄럽습니다. 단, 토박스가 68mm 미만으로 좁아 발볼 넓은 한국 러너는 반드시 2E 와이드를 선택하세요. 285g으로 가벼운 편은 아니지만, 550km 내구성으로 km당 400원의 가성비를 제공하며 리커버리 러닝에 최적화되어 있습니다. 에너지 리턴 60.8%(힐)로 쿠션화치고 반발력도 괜찮고, 평발 러너에게도 안정성 7/10으로 충분합니다. 19만 9천원 투자 가치가 있는 고급 데일리 트레이너입니다.',
      },
      {
        userType: '입문 러너',
        rating: 82,
    ...
    reviews: [
      {
        userType: '에디터 분석',
        rating: 88,
        text: '860 V15는 안정화 본연의 역할에 매우 충실합니다. 3/4 EVA 필름 플레이트와 이중 밀도 Fresh Foam X의 과내전 제어와 쿠션 균형이 좋고, 2E 와이드 옵션과 넓어진 힐 덕분에 발볼 넓은 한국 러너도 토박스 걱정 없이 착용 가능합니다. 330g이 가볍진 않지만 32mm 힐 스택이 무릎 부담을 확실히 줄여주며, 6mm 드롭의 자연스러운 전환이 뒤꿈치 착지 러너에게 안정적입니다. 600km 이상 내구성으로 km당 315원의 가성비를 제공하고, 카야노 32(26만원)보다 7만원 저렴한 18만 9천원에 9/10 안정성을 갖춰 평발 러너의 첫 안정화로 추천합니다. 다만 빠른 페이스(5:00/km 이하)에서는 무게감이 느껴지므로 easy run과 장거리 전용으로 활용하는 것이 좋습니다.',
      },
      {
        userType: '평발 러너',
        rating: 4.5,
