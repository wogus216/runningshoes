  ...
  },
  {
    ...
    reviews: [
      ...
      },
      {
        userType: '중급 러너',
        rating: 4.5,
        text: '카본 플레이트가 부담스러워서 무플레이트 슈퍼폼을 찾다가 골랐습니다. 220g이라 발이 가볍고, 100% PEBA 폼이 디비4보다 더 말랑하게 받아줘요. 한강 데일리 8~12km에 쓰는데 이지런도 편하고 중간에 페이스 올려도 폼이 따라옵니다. 플레이트 특유의 튕기는 느낌은 없지만 그게 오히려 매일 신기 편한 이유예요. 18만 9천원에 800km 설계라 km당 236원, 가성비가 좋습니다. 여름 통기성도 괜찮아서 더운 날 데일리로 제격입니다. 발볼은 표준이고 와이드가 아직 없어서 볼 넓은 분은 신어보고 사세요.',
      },
    ],
