    ...
    reviews: [
      {
        userType: 'RunRepeat 전문 리뷰어',
        rating: 82,
        text: '"한강도 뛰고 공원 트레일도 뛰는데 하나로 안 되나요?"에 추천하는 로드+트레일 하이브리드 쿠션화입니다. ZoomX 폼으로 로드에서 편안하면서도 러그 패턴 아웃솔로 가벼운 트레일에서도 대응 가능합니다. 17만원대로 가격 대비 다용도 활용이 가능하고, 550km 내구성으로 km당 325원 수준입니다. 넓은 토박스(Wide fit)로 발볼 넓은 한국 러너에게 편하고, 발목 보호 패딩으로 트레일에서 안정감을 제공합니다. 다만 292g으로 무겁고, 순수 로드/순수 트레일에서는 전문화에 못 미칩니다. "둘 다 가끔 뛴다"면 좋은 선택입니다.',
      },
      {
        userType: '입문 러너',
        rating: 4,
