...
export const nikeShoes: Shoe[] = [
  {
    ...
    brand: 'Nike',
    name: '페가수스 41',
    image: '/images/shoes/nike/pegasus41.jpg',
    category: '입문화',
    rating: 4,
    price: 159000,
    ...
    priceAnalysis: {
      ...
      valueRating: 9,
      priceTier: 'mid',
      alternatives: ['asics-gel-nimbus-27', 'new-balance-880-v15', 'hoka-clifton-10'],
    },
    ...
    similarShoes: ['adidas-supernova-rise-2', 'asics-gel-nimbus-27', 'new-balance-880-v15', 'hoka-clifton-10'],
  },
  {
    ...
    brand: 'Nike',
    name: '페가수스 프리미엄',
    image: '/images/shoes/nike/pegasus_premium.jpg',
    category: '입문화',
    rating: 4.5,
    price: 189000,
    ...
    priceAnalysis: {
      ...
      valueRating: 8,
      priceTier: 'mid',
      alternatives: ['new-balance-1080-v14', 'asics-gel-nimbus-27'],
    },
    detailedSpecs: {
      weight: '308g (US 9 기준)',
  ...
  },
  {
    ...
    brand: 'Nike',
    name: '페가수스 플러스',
    image: '/images/shoes/nike/pegasus_plus.jpg',
    category: '데일리',
    rating: 4.5,
    price: 179000,
    ...
    priceAnalysis: {
      ...
      valueRating: 8,
      priceTier: 'mid',
      alternatives: ['hoka-clifton-10', 'asics-gel-nimbus-27'],
    },
    detailedSpecs: {
      weight: '244g (US 9 기준)',
  ...
  },
  {
    ...
    brand: 'Nike',
    name: '보메로 18',
    image: '/images/shoes/nike/vomero18.jpg',
    category: '쿠션화',
    rating: 5,
    price: 199000,
    ...
    priceAnalysis: {
      ...
      valueRating: 8,
      priceTier: 'premium',
      alternatives: ['asics-gel-nimbus-27', 'brooks-glycerin-22', 'hoka-bondi-9'],
    },
    detailedSpecs: {
      weight: '298g (US 9 기준)',
    ...
    similarShoes: ['asics-gel-nimbus-27', 'new-balance-1080-v14', 'hoka-bondi-9'],
  },
  {
    id: 'nike-vomero-plus',
    ...
    brand: 'Nike',
    name: '보메로 플러스',
    image: '/images/shoes/nike/vomero_plus.jpg',
    category: '쿠션화',
    rating: 5,
    price: 209000,
  ...
  },
  {
    ...
    brand: 'Nike',
    name: '보메로 프리미엄',
    image: '/images/shoes/nike/vomero_premium.jpg',
    category: '쿠션화',
    rating: 4.8,
    price: 269000,
  ...
  },
  {
    ...
    brand: 'Nike',
    name: '스트럭처 26',
    image: '/images/shoes/nike/structure26.jpg',
    category: '안정화',
    rating: 4,
    price: 149000,
    ...
    similarShoes: ['asics-gt-2000-14', 'new-balance-860-v14', 'brooks-ghost-17'],
  },

  {
    ...
    brand: 'Nike',
    name: '라이벌 플라이 4',
    image: '/images/shoes/nike/rivalfly4.avif',
    category: '데일리',
    rating: 4,
    price: 129000,
  ...
  },
  {
    ...
    brand: 'Nike',
    name: '알파플라이 3',
    image: '/images/shoes/nike/alphafly3.jpg',
    category: '레이싱',
    rating: 5,
    price: 349000,
  ...
  },
  {
    ...
    brand: 'Nike',
    name: '줌 플라이 6',
    image: '/images/shoes/nike/zoomfly6.jpg',
    category: '레이싱',
    rating: 4,
    price: 199000,
    description:
  ...
  },
  {
    ...
    brand: 'Nike',
    name: '베이퍼플라이 3',
    image: '/images/shoes/nike/vaporfly4.jpg',
    category: '레이싱',
    rating: 5,
    price: 299000,
    ...
    priceAnalysis: {
      ...
      valueRating: 7,
      priceTier: 'super-premium',
      alternatives: ['asics-metaspeed-sky-plus', 'adidas-adios-pro-4', 'saucony-endorphin-pro-4'],
    },
    detailedSpecs: {
      weight: '190g (US 9 기준)',
    ...
    reviews: [
      {
        userType: 'RunRepeat 전문 리뷰어',
        rating: 94,
        text: '서브-3:30 목표의 중급~상급 러너를 위한 마라톤 레이싱화의 정석입니다. ZoomX와 스푼형 카본 플레이트로 75% 에너지 리턴을 제공하며, 알파플라이보다 안정적이어서 더 많은 러너에게 적합합니다. 190g 초경량으로 3분~4분45초/km 빠른 페이스에서 잘 굴러갑니다. 29만원대로 알파플라이(34만원)보다 5만원 저렴하면서 250km 내구성(알파플라이 200km)으로 km당 1,196원, 레이싱화 중 가성비가 좋습니다. 다만 표준 사이즈도 좁은 편이고 와이드 옵션이 없어 발볼 넓은 한국 러너는 주의가 필요합니다. 입문 러너/평발/과내전 러너에게는 비추입니다.',
      },
      {
        userType: '상급 러너',
        rating: 5,
  ...
  },
  {
    ...
    brand: 'Nike',
    name: '스트릭플라이 2',
    image: '/images/shoes/nike/streakfly2.jpg',
    category: '레이싱',
    rating: 4,
    price: 179000,
