...
export const shoe: Shoe = {
  ...
  reviews: [
    ...
    {
        userType: '모델 선택 — 엔돌핀 스피드 5 대비 발볼',
        text: '같은 급 슈퍼트레이너인 엔돌핀 스피드 계열과 비교하면 반발과 발볼에서 갈립니다. 반발력 자체는 엔돌핀 스피드가 앞서지만, 전족부 117.7mm로 넓어 30km를 넘기는 훈련에서 토박스 압박이 적다는 점이 이쪽의 강점입니다. 카본 플레이트가 들어가 레이스 감각을 훈련에서 익힐 수 있고, HA 8.8의 울트라소프트 폼에 힐 37mm 스택이라 인터벌과 장거리를 모두 소화합니다. 에너지 리턴 66.1%, 249,000원·내구성 500km 기준입니다.',
      },
    {
    ...
    {
        userType: '비용 관점 — 카본 훈련화 3종 가격 비교',
        text: '카본 훈련화군에서 가격은 중간 위치입니다. 249,000원으로 마하 X 계열(27만원대)보다 낮고 매직 스피드 계열(22만원대)보다 높은데, 차별점은 발볼입니다. 전족부 117.7mm로 이 등급에서 가장 넓은 축이라 30km급 장거리 후반에 발이 부어도 압박이 적습니다. 278g으로 무거운 편이지만 SA 144의 충격흡수와 힐 37mm 스택으로 착지 부담을 낮췄고, 에너지 리턴 66.1%로 카본의 추진도 확보했습니다. 월 200km 수준 운용에서 400km까지 아웃솔·반발이 유지되는 편입니다.',
      },
  ],
