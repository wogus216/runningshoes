...
export const shoe: Shoe = {
  ...
  reviews: [
      ...
      },
    {
        ...
        text: '최상위 레이서군에서 가격만 놓고 보면 상대적으로 낮은 축입니다. 할인가 29만원 초반대 기준으로 베이퍼플라이 3(31만원)·알파플라이 3(33만 9천원)보다 낮고, 내구성 300km 기준 km당 약 1,063원입니다. 절대 금액은 크지만 대회 전용으로 한정하면 풀코스 3~4회가 사용 범위라 레이스당 비용으로 환산해 판단하는 편이 현실적입니다. 성능은 198g의 무게에 힐 39mm 스택의 100% PEBA, 에너지 리턴 74.8%로 이 등급에 부족함이 없습니다. 여기에 토박스 74.5mm로 슈퍼슈즈 중 가장 넓은 축이고 와이드 옵션까지 있어, 발볼 때문에 선택지가 없던 경우에는 가격 이전에 이 점이 결정적입니다.',
      },
  ],
  ...
  purchaseLinks: [{ store: '네이버', url: 'https://naver.me/5EC4W6S9' }, { store: '쿠팡', url: 'https://link.coupang.com/a/g5YSGPBv9U' }],
};
