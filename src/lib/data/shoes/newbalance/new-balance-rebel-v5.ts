...
export const shoe: Shoe = {
  ...
  reviews: [
      ...
      },
    {
        ...
        text: '경량 스피드 트레이너 두 모델은 폼 경도에서 갈립니다. 레벨 v5는 HA 11.5로 부드럽고, 킨바라 16은 HA 7.0으로 더 탄탄합니다. 반발이 즉각적인 쪽을 원하면 킨바라, 착지 충격을 덜 받고 싶으면 레벨입니다. 한국 러너 기준으로는 토박스 75mm의 레벨 쪽이 발볼 여유가 크다는 점이 실질적인 차이입니다. 220g에 힐 33mm 스택으로 인터벌과 가벼운 템포런을 겸하기에 맞고, SA 145로 반복 착지에서도 충격이 과하지 않습니다. 189,000원으로 같은 브랜드 노바블라스트 계열(21만원)보다 낮은 가격대입니다.',
      },
    {
        userType: '비용 관점 — 경량 데일리 3종 가격 비교',
        text: '경량 데일리군에서 가격이 낮은 축입니다. 189,000원으로 노바블라스트 계열(21만원)·마하 계열(21.9만원)보다 낮으면서, 220g의 무게와 성능은 크게 밀리지 않습니다. 토박스가 75mm로 넓어 와이드 옵션이 없어도 발볼 대응이 되는 점이 실질적인 이점입니다. 힐 33mm 스택의 HA 11.5 FuelCell 폼이라 6분/km 데일리부터 4분40초 템포까지 한 켤레로 커버합니다. 내구성 500km 기준 km당 약 378원입니다.',
      },
  ],
