...
export const shoe: Shoe = {
  ...
  reviews: [
    ...
    {
        userType: '모델 선택 — 아드레날린 GTS 25 대비 쿠션',
        text: '같은 안정화군에서 아드레날린 GTS 계열과 비교하면 교정 강도는 비슷하고 쿠션이 더 부드럽습니다. HA 10.9/23.8의 듀얼 레이어 구조라 위층은 충격을 흡수하고 아래층이 지지를 담당해, 안정화 특유의 단단함이 덜합니다. 힐 에너지 리턴 60.8%로 안정화치고 반발도 있는 편입니다. 2E 와이드가 있어 10km 후반 발이 부어도 토박스 여유가 유지됩니다. 179,000원으로 카야노 계열(26만원대)보다 9만원 낮으면서 지지 성능은 크게 밀리지 않습니다.',
      },
  ],

  similarShoes: ['asics-gel-kayano-33', 'brooks-adrenaline-gts-25', 'saucony-guide-18'],
  purchaseLinks: [{ store: '네이버', url: 'https://naver.me/GowyA70j' }, { store: '쿠팡', url: 'https://link.coupang.com/a/g5YPh2sfls' }],
};
