...
export const shoe: Shoe = {
  ...
  reviews: [
    ...
    {
        userType: '모델 선택 — 1080 계열 대비 바운스를 원할 때',
        text: '같은 브랜드 1080 계열과 비교하면 성격이 바운스 쪽으로 확실히 기울어 있습니다. PEBA 폼이라 착지마다 튀어오르는 감각이 뚜렷하고, 261g으로 1080 v14보다 20g가량 가볍습니다. 6mm 드롭에 로커를 얹어 전환도 매끄럽습니다. 다만 4:30/km 수준으로 페이스를 올리면 폼이 눌리며 물러지는 구간이 있어, 속도 훈련보다 편안한 페이스의 10km대 데일리에 맞습니다. PEBA 특성상 폼 꺼짐이 느려 주행거리를 쌓아도 쿠션 저하가 완만한 편입니다. 2E 와이드가 있어 발볼 넓은 경우에도 대응되며, 259,000원으로 데일리치고는 진입 가격이 높습니다.',
      },
    {
        userType: '비용 관점 — 1080 v15와의 5만원 차이',
        text: '입문 단계에서 이 모델을 고를지는 5만원 차이를 어떻게 보느냐에 달렸습니다. 259,000원·내구성 500km 기준 km당 약 518원으로 데일리치고 운용 비용이 높은 편이고, 같은 브랜드 1080 v15가 5만원 낮으면서 쿠션량은 비슷합니다. 이 모델의 차별점은 PEBA 블렌드 폼 특유의 탄력으로, 부드러우면서 튀어오르는 감각을 원한다면 값을 하는 쪽입니다. 힐 38.5mm 스택에 6mm 드롭, 261g으로 조깅에서 가볍게 느껴지고 2E 와이드가 있어 발볼도 대응됩니다. 예산이 빠듯하다면 1080 쪽이 합리적입니다.',
      },
  ],
