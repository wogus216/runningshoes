  ...
  },
  {
    ...
    reviews: [
      ...
      },
      {
        userType: '입문 러너',
        rating: 4,
        text: '러닝화 하나로 워킹까지 해결하려고 샀는데 목적에 딱 맞았습니다. 회사까지 20분 걷고 저녁에 6분대 페이스로 5km 뛰는 일과인데 두 용도 모두 편안합니다. 6분대 페이스 조깅에서는 착지부터 밀어주는 느낌보다 안정적으로 굴러가는 느낌이 강하고, 어퍼가 편해서 처음부터 길들이기 스트레스가 적었습니다. 발볼이 한국인 평균 수준인데 어퍼 여유가 있어서 불편함이 없었어요. 와이드 옵션은 없지만 넉넉한 어퍼 설계 덕분에 발볼이 약간 넓어도 대응이 됩니다. 무릎이 약한 편이라 충격 흡수가 좋은 신발을 찾았는데 8mm 드롭에 37mm 스택이 무릎 부담을 줄여줍니다. 가성비 면에서는 19만 9천원에 550km 내구성이면 km당 362원으로 만족스럽습니다.',
      },
    ],
    detailedSpecs: {
