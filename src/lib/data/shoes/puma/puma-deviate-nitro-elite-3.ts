...
export const shoe: Shoe = {
  ...
  reviews: [
    {
        userType: '비용 관점 — 최상위 레이서 중 가격 경쟁력',
        text: '최상위 레이서군에서 성능 대비 가격이 유리한 구간입니다. 204g으로 베이퍼플라이 계열(194g)과 무게 차이가 크지 않으면서 정가 289,000원 대 310,000원으로 낮고, 세일가 25만원대까지 내려오면 격차가 더 벌어집니다. A-TPU 폼이라 에너지 리턴 77%의 반발이 30km 이후에도 유지되는 성격이고, 힐 39.2mm 스택으로 후반 충격 흡수도 확보했습니다. 토박스가 좁아 한국 러너 평균 발볼에서는 반 치수 업이 사실상 필요하며, 내구성 300km라 레이스 전용 운용이 전제입니다. 아치 지지가 약해 평발 성향이면 인솔 교체를 검토하세요.',
      },
    {
      userType: '에디터 분석',
      rating: 92,
      text: '"가성비 좋은 슈퍼슈즈 뭐가 좋아요?" 질문에 최고의 답변입니다. 289,000원으로 베이퍼플라이 3(310,000원), 메타스피드 스카이+(329,000원)보다 저렴하면서 77% 에너지 리턴은 슈퍼슈즈 시장 최고 수준입니다. 204g으로 베이퍼플라이(194g)와 비슷한 경량성, A-TPU 기반 Nitro Elite 폼으로 탄탄한 반발력을 제공합니다. 39.2mm 힐 스택이 마라톤 후반 무릎과 관절을 보호해주고, 10.6mm 드롭이 힐스트라이크 러너에게도 자연스러운 전환을 유도합니다. 발볼이 좁아 한국인 발에는 반사이즈 업 필수이며, 토박스 폭이 좁은 편이라 와이드 발볼 러너는 주의하세요. 300km 내구성으로 km당 약 963원의 가성비는 레이싱화 카테고리에서 합리적입니다. 서브4:00 목표의 하프/풀 마라톤 레이스에 강력 추천하는 가성비 슈퍼슈즈입니다.',
    },
    {
        userType: '예상 적합 — 봄가을 레이스 전용',
        text: '204g의 무게에 에너지 리턴 77%로, 30km 이후 페이스 유지가 과제인 러너를 겨냥한 레이서입니다. 힐 39.2mm 스택이라 장거리에서 충격 흡수도 확보한 구성입니다. 다만 계절 제약이 뚜렷합니다 — 이 폼은 저온에서 경화가 두드러지는 편이라 영하권 레이스에서는 반발이 떨어집니다. 겨울 대회가 주력이라면 저온 경화율이 낮은 모델을 함께 검토하세요. 토박스가 좁아 평소보다 반 치수 올려야 할 수 있고, 내구성 300km 수준이라 레이스 전용 운용이 전제입니다.',
      },
  ],
