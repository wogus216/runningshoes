...
export const shoe: Shoe = {
  ...
  reviews: [
    ...
    },
    {
      userType: '상급 러너',
      rating: 5,
      text: '올해 동아마라톤 레이스데이 전용으로 산 신발입니다. 204g 초경량에 77% 에너지 리턴 덕분에 30km 이후에도 다리가 덜 무거웠고, 3분55초 페이스를 후반까지 유지하는 데 확실히 도움이 됐습니다. 다만 겨울 훈련 때 영하 날씨에서 신어봤더니 폼이 눈에 띄게 딱딱해지는 게 느껴져서, 이 신발은 봄가을 레이스에만 쓰기로 했습니다. 토박스가 좁아서 평소 270mm인데 275mm로 사이즈업했고, 39.2mm 힐 스택의 쿠셔닝이 장거리에서도 무릎을 잘 보호해줍니다. 300km 레이스 전용 설계라 매 대회마다 신진 상태로 아껴 쓰고 있어요.',
    },
  ],
