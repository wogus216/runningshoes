...
export const shoe: Shoe = {
  ...
  reviews: [
    ...
    },
    {
      userType: '상급 러너',
      rating: 5,
      text: '체중 80kg에 발볼이 넓은 편인 상급 러너입니다. 그동안 카본화들은 발볼이 좁아서 항상 반사이즈를 올려야 했는데, 디비에이트4는 와이드 옵션이 있어서 정사이즈로도 편하게 신을 수 있었어요. 잠실종합운동장 트랙에서 주 1회 하프마라톤 페이스(4분15초/km) 인터벌 훈련에 쓰는데, 250g 무게에도 카본 플레이트 반발력이 확실히 느껴집니다. 38mm 힐 스택 쿠셔닝이 트랙 훈련 후 무릎 부담을 줄여주고, 다만 반발력이 좋은 만큼 느린 회복 러닝에는 오히려 과하게 느껴져서 그런 날은 다른 신발을 신습니다. 219,000원에 800km 내구성이면 카본 슈퍼트레이너 중 가성비도 훌륭한 편입니다.',
    },
  ],
