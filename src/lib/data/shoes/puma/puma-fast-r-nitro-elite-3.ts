...
export const shoe: Shoe = {
  ...
  reviews: [
    {
        userType: '계절 적합성 — 봄가을 레이스 한정',
        text: '기온이 성능을 크게 좌우하는 모델입니다. 10~15도 구간에서는 에너지 리턴 80% 이상이 그대로 나오지만, 영하권에서는 폼 경화가 뚜렷해 반발이 떨어집니다. 봄·가을 대회가 주력이라면 강점이 살아나고, 겨울 레이스를 노린다면 저온 경화율이 낮은 모델을 따로 봐야 합니다. 173g으로 최상위 레이서 중에서도 가벼운 축이고, 힐 38.5mm 스택이라 30km 이후 충격 흡수도 확보돼 있습니다. 토박스가 좁아 반 치수 업이 사실상 필요하며 와이드가 없어 발볼 110mm 이상이면 맞지 않습니다. 379,000원·내구성 250km 기준 km당 약 1,516원입니다.',
      },
    {
      userType: '에디터 분석',
      rating: 89,
      text: '푸마 최상위 풀 마라톤 레이싱화입니다. 173g으로 알파플라이 3(190g)보다 17g 가볍고, 80% 이상의 에너지 리턴으로 최고 수준의 반발력을 제공합니다. 379,000원으로 알파플라이 3(349,000원)보다 3만원 비싸지만 순수 무게에서 확실히 우위입니다. 8.3mm 드롭에 38.5mm 힐 스택으로 전방 착지 러너에게 최적화된 설계입니다. 발볼이 좁아 한국인 발에는 반사이즈 업 필수이고, 토박스 폭이 좁은 편이라 발볼 넓은 러너는 착화 테스트를 꼭 해보세요. 250km 내구성으로 km당 약 1,516원의 가성비는 순수 레이스 전용이라는 점을 감안하면 납득 가능합니다. 평발이나 무릎 부상 이력이 있는 러너보다는 서브3:00을 목표로 하는 엘리트 러너의 풀 마라톤 레이스용으로 추천합니다.',
    },
    {
        userType: '예상 적합 — 대회 전용 장비를 마련하려는 서브3:30 전후 러너',
        text: '훈련화와 별개로 대회 전용 장비를 두려는 서브3:30 전후 러너를 겨냥한 모델입니다. 173g의 무게에 힐 38.5mm 스택이라 30km 이후 누적되는 다리 피로를 줄이는 쪽으로 설계됐습니다. 다만 379,000원·내구성 250km 기준 km당 약 1,516원으로 이 등급에서도 비용 부담이 큰 편이라, 일상 훈련까지 겸하는 용도로는 맞지 않습니다. 토박스가 좁아 평소 사이즈보다 반 치수 올려야 할 수 있으니, 발볼이 넓다면 시착이 사실상 필수입니다.',
      },
  ],
  ...
  purchaseLinks: [{ store: '네이버', url: 'https://naver.me/5PWrWYWo' }],
};
