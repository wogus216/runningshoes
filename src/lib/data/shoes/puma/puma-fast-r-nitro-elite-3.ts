...
export const shoe: Shoe = {
  ...
  reviews: [
      ...
      },
    {
      userType: '에디터 분석',
      rating: 89,
      text: '푸마 최상위 풀 마라톤 레이싱화입니다. 173g으로 알파플라이 3(190g)보다 17g 가볍고, 80% 이상의 에너지 리턴으로 최고 수준의 반발력을 제공합니다. 379,000원으로 알파플라이 3(339,000원)보다 4만원 비싸지만 순수 무게에서 확실히 우위입니다. 8.3mm 드롭에 38.5mm 힐 스택으로 전방 착지 러너에게 최적화된 설계입니다. 발볼이 좁아 한국인 발에는 반사이즈 업 필수이고, 토박스 폭이 좁은 편이라 발볼 넓은 러너는 착화 테스트를 꼭 해보세요. 250km 내구성으로 km당 약 1,516원의 가성비는 순수 레이스 전용이라는 점을 감안하면 납득 가능합니다. 평발이나 무릎 부상 이력이 있는 러너보다는 서브3:00을 목표로 하는 엘리트 러너의 풀 마라톤 레이스용으로 추천합니다.',
    },
    {
