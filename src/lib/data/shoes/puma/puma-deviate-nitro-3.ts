  ...
  reviews: [
    {
        ...
        text: '같은 급의 엔돌핀 스피드 계열과 비교하면 추진력은 비슷하되 착지감이 갈립니다. Nitro Foam 듀얼폼이라 더 단단하고 직접적인 감각이고, 폼이 눌리는 느낌을 싫어하는 경우 이쪽이 맞습니다. 힐 37.4mm 스택이라 10km급 페이스 훈련에서 충격 흡수도 확보됩니다. 268g으로 인터벌보다는 템포런 쪽에 적합한 무게입니다. 가격 면에서는 마하 X 계열(269,000원)보다 8만원가량 낮은 구간이며, 세일가 기준 km당 약 487원입니다. 다만 내구성 450km로 짧은 편이고, 토박스가 좁아 한국 러너 평균 발볼에서는 반 치수 업을 권합니다.',
      },
    {
      userType: '에디터 분석',
      rating: 87,
