  ...
  reviews: [
    {
        ...
        text: '맥시멀 쿠션화군에서 진입 가격이 낮은 축입니다. 199,000원으로 본디 9(220,000원)·님버스 28(259,000원)보다 낮고, 세일가 17만원대까지 내려오면 격차가 더 벌어집니다. 성능 면에서도 40mm PEBA 폼이라 15km 이후 충격 흡수가 유지되고, 264g으로 맥시멀치고 가벼운 편입니다. 10mm 드롭이라 힐 착지에서 안정적이고, 통기성이 좋아 여름 장거리에도 부담이 적습니다. 폼 저하가 완만해 주행거리를 쌓아도 쿠션이 오래 유지됩니다. 토박스도 압박이 적어 표준 발볼이면 무리가 없습니다.',
      },
    {
      userType: '에디터 분석',
      rating: 84,
    ...
    },
    {
      userType: '평발 러너',
      rating: 4,
      text: '평발 진단 받고 인솔 없이도 편하게 뛸 수 있는 신발을 찾다가 매그니파이를 신어봤습니다. 체중 75kg에 주 2회 회복 러닝으로 도림천에서 8km씩 6분30초 페이스로 뛰는데, 40mm 힐 스택의 부드러운 착지가 평발 특유의 충격을 잘 흡수해줍니다. PEBA 폼 반발력이 강한 편은 아니라서 페이스를 올리려 하면 살짝 둔하게 느껴지지만, 애초에 회복 러닝용으로 산 거라 크게 아쉽지 않아요. 264g 무게도 맥시멀 쿠션화치고 가벼워서 부담 없이 신고 있습니다.',
    },
  ],
