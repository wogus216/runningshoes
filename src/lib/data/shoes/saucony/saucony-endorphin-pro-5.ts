...
export const shoe: Shoe = {
  ...
  editorComment: '엔돌핀 프로 5는 전작과 동일한 206g/39.5mm 스택/8mm 드롭을 유지하면서 카본 플레이트를 슬롯 디자인으로 변경해 전환 효율을 높였습니다. PWRTRAC 아웃솔이 새로 적용되어 그립력이 향상되었고, PWRRUN HG 상층+PWRRUN PB 하층의 듀얼 폼 구성은 그대로입니다. 29만 9천원으로 베이퍼플라이 4(30만 9천원)보다 1만원 저렴하면서 더 넓은 핏을 제공합니다. 단, 레이싱 전용이라 내구성(300km)이 짧고 데일리 훈련에는 비적합합니다. 슈퍼폼의 성능 저하는 발이 못 느낍니다 — 640km 시점 객관 지표는 20~28% 떨어졌는데 착용자 체감은 2.7%였다는 연구가 있습니다. 아직 푹신하다는 느낌을 믿지 말고 누적 거리로 교체를 판단하세요.\n\n사이즈·구매 가이드: 토박스가 표준 폭이며 와이드 옵션이 없으므로, 발볼이 넓다면 시착을 권장합니다. 정가 299,000원에 내구성 300km 기준 km당 약 997원으로 대회 전용 운용을 권장합니다. 같은 레이싱화로는 베이퍼플라이 4·아디제로 아디오스 프로 4가 대안입니다.',
