...
export const shoe: Shoe = {
  ...
  reviews: [
      ...
      },
    {
        ...
        text: '첫 슈퍼슈즈를 고를 때 가격 부담을 낮추는 선택지입니다. 26만원대로 최상단 모델(알파플라이 3 33만 9천원) 대비 7만원 낮고, 내구성 300km 기준 대회 3회면 회당 약 8만원 수준입니다. 성능은 220g의 무게에 에너지 리턴 71.7%, SA 139의 충격흡수로 서브4~서브3:30 구간에 부족함이 없습니다. 즉 기록 목표가 아직 확정적이지 않은 단계에서 슈퍼슈즈 감각을 확인하기에 위험이 적은 가격대입니다. 토박스가 좁아 발볼이 넓다면 불편할 수 있습니다.',
      },
  ],
  ...
  purchaseLinks: [{ store: '네이버', url: 'https://naver.me/x0OoxmwE' }, { store: '쿠팡', url: 'https://link.coupang.com/a/g5ZfeMbi68' }],
};
