...
export const shoe: Shoe = {
  ...
  reviews: [
    ...
    {
        userType: '의학·멀티테스터 관점(DOR·RTR) — 아킬레스 부담이 있는 경우',
        text: '힐 카운터가 없어 아킬레스 부착부 통증이나 하글런드 변형이 있는 러너에게 레이싱화 중 최선으로 평가됩니다. 토박스가 평균보다 넓고 직각형이라 표준~넓은 발에 편안하고, 측면 컷아웃 제거로 미드풋이 채워져 중립 안정성이 B+ 수준으로 올라왔습니다. 다만 비틀림 강성이 낮아 코너나 요철 노면에서는 불안정하니 평탄한 코스(하프~풀마라톤)에 어울립니다. 부드러운 미드솔 특성상 평발·과내전 러너에게는 지지가 부족해 권하지 않습니다. 마라톤 페이스(km당 4:30~5:20)에서 5인 테스터 전원이 에너지를 느꼈다는 평가입니다.',
      },
  ],
  ...
  purchaseLinks: [{ store: '네이버', url: 'https://naver.me/5394IQWo' }],
};
