...
export const shoe: Shoe = {
  ...
  reviews: [
    ...
    },
    {
        ...
        text: '같은 브랜드 최상위 레이서(엘리트 2)의 IncrediRUN 폼을 훈련용 내구성으로 옮긴 구성입니다. 대회 신발과 훈련 신발의 감각 차이를 줄이려는 운용에 맞습니다. 285g으로 무거운 편이지만 에너지 리턴 76.3%라 경사가 섞인 코스에서도 추진이 유지됩니다. 경쟁 모델인 슈퍼블라스트 2(24만 9천원)보다 4만원 낮으면서 내구성 600km라 주행거리를 많이 쌓는 경우 운용 비용에서 유리합니다. 토박스가 70.1mm로 좁아 발볼이 넓다면 시착이 필요합니다.',
      },
    {
  ...
  purchaseLinks: [{ store: '네이버', url: 'https://naver.me/GM323csQ' }, { store: '쿠팡', url: 'https://link.coupang.com/a/g5ZhhoqzGC' }],
};
