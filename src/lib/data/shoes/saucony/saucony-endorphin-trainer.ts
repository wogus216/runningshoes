...
export const shoe: Shoe = {
  ...
  reviews: [
    ...
    {
        userType: '로테이션 — 최상위 레이서 폼을 훈련에서 쓰는 구성',
        text: '같은 브랜드 최상위 레이서(엘리트 2)의 IncrediRUN 폼을 훈련용 내구성으로 옮긴 구성입니다. 대회 신발과 훈련 신발의 감각 차이를 줄이려는 운용에 맞습니다. 285g으로 무거운 편이지만 에너지 리턴 76.3%라 경사가 섞인 코스에서도 추진이 유지됩니다. 경쟁 모델인 슈퍼블라스트 2(26만원)보다 4만원 낮으면서 내구성 600km라 주행거리를 많이 쌓는 경우 운용 비용에서 유리합니다. 토박스가 70.1mm로 좁아 발볼이 넓다면 시착이 필요합니다.',
      },
    {
        userType: '모델 선택 — 엔돌핀 스피드 5 대비 장거리 안정성',
        text: '같은 라인의 스피드 5와 비교하면 장거리 쪽에 무게가 실려 있습니다. 3/4 카본 플레이트로 에너지 리턴 76.3%를 확보해 추진력은 스피드보다 앞서고, 플랫폼이 121.7mm로 넓어 30km급 장거리 후반의 접지 안정감이 좋습니다. 대신 285g으로 무거워 짧고 빠른 세션에는 스피드 5가 맞습니다. 토박스가 70.1mm로 좁아 발볼이 넓다면 반 치수 업이 필요하고, 내구성 600km 기준입니다.',
      },
    {
        userType: '적합성 경계 — 5분대 이상 장거리 전용',
        text: '무게가 용도를 제한합니다. 285g은 슈퍼트레이너 중 무거운 축으로, 같은 가격대의 줌 플라이 6(269g)·하이페리온 맥스 3(283g)보다 무겁습니다. 4:30/km 수준의 템포런에서는 이 무게가 걸림돌이 되므로, 5분대 이상의 장거리 훈련 전용으로 보는 편이 현실적입니다. IncrediRUN 폼의 에너지 리턴 76.3%라는 반발 자체는 확실하고, km당 약 365원으로 운용 비용도 낮습니다. 토박스 70.1mm로 좁아 발볼이 넓다면 제약이 있습니다.',
      },
  ],
