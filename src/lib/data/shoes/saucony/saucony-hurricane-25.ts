...
export const shoe: Shoe = {
  ...
  reviews: [
    ...
    },
    {
        ...
        text: '같은 브랜드 안정화 라인에서 가이드 계열의 지지가 부족한 경우 올라가는 상위 모델입니다. 크래들 구조가 뒤꿈치를 감싸는 방식이라, 미드솔에 포스트를 넣어 안쪽을 받치는 방식과는 지지 감각이 다릅니다. 과내전이 강하게 나오는 경우 이 구조가 더 확실하게 잡아줍니다. SA 151로 충격흡수도 최상위권이고, EE 와이드까지 폭 옵션이 있어 넓은 발에서도 토박스 여유가 있습니다. 카야노 32와 비교하면 6만원가량 낮은 가격대에서 유사한 수준의 지지를 제공하는 구성입니다.',
      },
    {
      ...
      },
    {
        ...
        text: '과내전이 있으면서 체중까지 실린 조건에서 쿠션량을 우선할 때 맞습니다. 바닥 폭이 124mm로 넓어 하중이 실려도 착지가 흔들리지 않고, SA 151의 충격흡수와 HA 16.6의 부드러운 폼이라 안정화 중에서는 착화감이 편한 축입니다. 286g으로 무겁지만 6분30초 안팎의 페이스에서는 체감이 작습니다. 카야노 계열(26만원대)보다 8만원가량 낮은 가격대이고, 와이드 옵션이 있어 발볼 대응도 됩니다.',
      },
  ],
