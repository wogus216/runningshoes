...
export const shoe: Shoe = {
  ...
  reviews: [
    ...
    {
        userType: '모델 선택 — 페가수스 대비 가볍고 통기성이 좋은 입문화',
        text: '입문화 후보로 페가수스 계열과 자주 맞붙는 모델입니다. 255g으로 약 26g 가볍고, 어퍼 통기성이 좋아 여름철 열감이 덜하다는 점이 실사용 차이입니다. HA 26 수준이라 미드솔은 단단한 편이지만 SA 141의 충격흡수를 확보해, 단단한 감각을 선호하면서도 관절 부담은 줄이려는 경우에 맞습니다. 토박스가 넉넉하고 와이드 옵션도 있어 발볼 넓은 입문자의 선택지가 됩니다.',
      },
    {
        userType: '세대 비교 — 라이드 17 대비 33g 경량화',
        text: '전작 17에서 255g으로 약 33g 가벼워진 것이 체감 변화의 핵심입니다. HA 26 수준이라 미드솔은 단단한 편인데, 푹신함보다 안정감을 주는 성격이라 6분/km 데일리에서 발과 무릎에 피로가 덜 쌓입니다. 맥시멀 쿠션화의 물렁한 감각을 선호하지 않는 경우에 맞습니다. 내구성 600km로 같은 급의 고스트 계열(800km)보다는 짧지만 km당 약 265원으로 운용 비용은 낮습니다. 토박스가 표준 폭이라 발볼이 넓으면 와이드가 필요합니다.',
      },
    {
        userType: '모델 선택 — 클리프톤 대비 지면 감각',
        text: '같은 데일리 쿠션화군에서 클리프톤 계열과 비교하면 성격이 갈립니다. 255g으로 더 가볍고 HA 26.1이라 미드솔이 단단한 편이어서 지면 감각이 남는 반면, 클리프톤은 더 부드럽고 로커로 굴려주는 쪽입니다. 발밑이 물러지는 느낌을 싫어한다면 이쪽이 맞습니다. SA 141의 충격흡수는 확보돼 있어 단단함이 관절 부담으로 직결되지는 않습니다. 아치를 과하게 잡지 않는 중립 설계라 가벼운 평발 성향까지는 대응되고, 2E 와이드가 있어 발볼도 선택지가 있습니다. 통기성이 좋아 여름철 장시간 착용에도 유리합니다.',
      },
  ],

  similarShoes: ['nike-pegasus-41', 'asics-gel-nimbus-28', 'hoka-clifton-10', 'new-balance-880-v15'],
  purchaseLinks: [{ store: '쿠팡', url: 'https://link.coupang.com/a/g5Zj79hA8y' }],
};
