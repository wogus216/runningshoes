...
export const shoe: Shoe = {
  ...
  oneliner: '카야노보다 4만원 낮은 121.9mm 광폭 플랫폼 안정화',
  editorComment: '15만 9천원이라는 가격은 카야노 32(₩199,000)의 61%에 불과하지만, 121.9mm 넓은 플랫폼이 착지 시 좌우 흔들림을 효과적으로 억제합니다. 61.3% 에너지 리턴은 안정화 카테고리 평균 이상이고, 통기성 5/5로 여름에도 쾌적하게 달릴 수 있습니다. 과내전이 심하지 않은 경도~중등도 수준이라면 이 가격대에서 가이드 18만큼 합리적인 선택은 드뭅니다. 다만 노출 폼 비율이 높아 아웃솔 내구성이 약한 편이라 아스팔트 위주 러너는 주의하세요.\n\n사이즈·구매 가이드: 토박스가 표준 폭이라 발볼이 보통인 러너에게 맞으며, 넓은 발볼이라면 와이드(2E) 옵션을 선택하세요. 정가 159,000원에 내구성 600km 기준 km당 약 265원으로 안정화 중 가성비가 뛰어납니다. 같은 안정화로는 젤 카야노 32·아드레날린 GTS 25가 대안입니다.',
  tags: ['안정화', '입문', '과내전 지원'],
  ...
  reviews: [
    ...
    },
    {
        ...
        text: '안정화가 필요하지만 최상위 모델의 가격이 부담스러운 경우의 대안입니다. 15만 9천원으로 카야노 계열(19만 9천원)보다 4만원 낮으면서, Guidance Frame이 과내전 움직임을 잡습니다. 지지 강도 자체는 최상위 안정화보다 약하므로 과내전이 심하면 부족할 수 있지만, 경증~중등도라면 충분한 수준입니다. 278g으로 데일리에 적당한 무게이고, 와이드 옵션이 있어 발볼 넓은 경우에도 토박스 여유가 있습니다.',
      },
    {
