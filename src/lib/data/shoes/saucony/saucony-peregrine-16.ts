...
export const shoe: Shoe = {
  ...
  editorComment:
    '페레그린 16의 변화는 아웃솔에 집중돼 있습니다. 전 세대까지의 자체 러버에서 Vibram Megagrip + 트랙션 러그로 바뀌면서, 젖은 바위처럼 미끄러운 노면에서의 접지가 눈에 띄게 좋아졌다는 평이 일관됩니다. RunRepeat 실측 기준 러그 깊이는 15세대의 4.7mm에서 3.5mm로 오히려 낮아졌는데, 접지력 계수(CoF) 0.72로 트레일화 평균(0.67)을 웃돌아 고무 자체의 그립이 올라가 오르막·내리막 모두에서 손해가 없다는 것이 실측으로도 확인됩니다.\n\n성격은 "민첩한 트레일화"입니다. RunRepeat 실측 스택은 힐 31.7mm·전족 26.9mm(브랜드 공식 32/28mm와 거의 일치), 드롭은 4.8mm(브랜드 표기 4mm)로 낮고 평평해, 기술적인 바위·나무뿌리 구간에서 발밑 감각이 살아 있습니다. 충격흡수는 SA 힐 124·전족 106으로 트레일화 평균(122 SA)과 비슷한 수준이고, 에너지 리턴은 58.1%/64.5%로 평균(59.6%)을 살짝 웃돕니다. 미드솔 경도는 31.3 AC로 15세대(31.6 AC)와 거의 같아 쿠셔닝감은 세대 간 큰 변화가 없습니다. 반대로 울트라 거리의 충격 누적을 견디는 용도라면 스택이 더 높은 엑소더스 울트라 4(36/30mm) 쪽이 맞습니다.\n\n사이즈·구매 가이드: 국내 공식몰에 와이드 옵션이 함께 유통됩니다. RunRepeat 실측 토박스 너비는 70.3mm로 우리 기준 표준 구간(68~75mm)에 들지만, 트레일화 평균(74.3mm)보다는 좁은 편이고 RunRepeat도 "테이퍼드(좁아지는) 토박스"를 단점으로 꼽았습니다 — 발볼이 넓은 러너는 매장 착화를 권합니다. 아웃솔 마모는 0.5mm로 15세대 대비 거의 절반(내구성 실측 최상위권)이지만, 토박스 내구성은 5점 만점에 2점(평균 3.1점)으로 상대적으로 약한 편입니다. 드롭 4mm대는 로드화(보통 8~10mm)에서 넘어오면 종아리·아킬레스 부하가 확실히 다르니, 첫 몇 회는 거리를 줄여 적응하세요. 2026-08-15 기준 국내 유통 2종 전량이 20% 할인된 143,200원입니다.',
  ...
  biomechanics: {
    stackHeight: { heel: 31.7, forefoot: 26.9 },
    drop: 4.8,
    carbonPlate: false,
    plateType: null,
  ...
  features: [
    ...
    'RunRepeat 실측 러그 깊이 4.7mm → 3.5mm로 낮아졌으나 접지력(CoF 0.72)은 트레일화 평균(0.67) 상회',
    'RunRepeat 실측 스택 힐 31.7mm·전족 26.9mm(브랜드 공식 32/28mm), 미드솔 경도 31.3 AC로 전작과 거의 동일',
    '드롭 4.8mm(RunRepeat 실측, 브랜드 표기 4mm) — 써코니 라인 중 가장 낮은 축',
  ...
  reviews: [
    {
      userType: '에디터 분석',
      rating: 88,
      text: '페레그린은 오랫동안 "무난한 트레일 표준"이었는데, 16세대에서 Vibram Megagrip을 얻으면서 약점이던 젖은 노면 접지가 정리됐습니다. RunRepeat 실측으로 러그 깊이는 4.7mm에서 3.5mm로 낮아졌지만 접지력 계수(CoF)는 0.72로 트레일화 평균(0.67)을 웃돌아, 낮아진 러그에도 그립이 개선됐다는 평가가 실측으로 뒷받침됩니다. 스택은 힐 31.7mm·전족 26.9mm(브랜드 공식 32/28mm)로 여전히 낮은 편이고 드롭도 4.8mm라, 성격은 "푹신하게 오래"보다 "발밑을 읽으며 민첩하게" 쪽입니다. 충격흡수(SA 힐 124)와 에너지 리턴(58.1%/64.5%)은 트레일화 평균과 비슷하거나 소폭 상회하는 수준입니다. 기술적 지형에서 이 구성이 강점이 되지만, 장시간 충격 누적에는 불리하니 울트라 거리는 다른 모델을 보는 편이 낫습니다. 아웃솔 마모는 0.5mm로 15세대 대비 거의 절반이라 내구성은 뛰어나지만, 토박스 내구성은 2/5(평균 3.1)로 상대적으로 약합니다.',
    },
    {
  ...
  detailedSpecs: {
    weight: '278g (RunRepeat 실측 US M9) · 브랜드 공식 271g(남성)/239g(여성)',
    stackHeight: '힐 31.7mm / 포어풋 26.9mm (RunRepeat 실측) · 브랜드 공식 32/28mm',
    drop: '4.8mm (RunRepeat 실측) · 브랜드 공식 4mm',
    midsole: 'PWRRUN (16세대에서 소폭 소프트화, 경도 31.3 AC — RunRepeat 실측)',
    plate: '록플레이트 (돌 보호)',
