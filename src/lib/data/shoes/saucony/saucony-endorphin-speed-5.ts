...
export const shoe: Shoe = {
  ...
  features: ['PWRRUN PB 미드솔', '나일론 플레이트', '공식 8mm 드롭 (RunRepeat 실측 10.6mm)', '버사타일'],
  ...
  detailedSpecs: {
    weight: '238g (남성 US 9 기준, 브랜드 공식) — RunRepeat 실측 241g',
    stackHeight: '힐 36mm / 포어풋 28mm (브랜드 공식) — RunRepeat 실측 37.4/26.8mm',
    drop: '8mm (브랜드 공식) — RunRepeat 실측 10.6mm',
  ...
  reviews: [
      ...
      },
    {
        ...
        text: '30만원대 슈퍼슈즈 없이 풀코스를 준비할 때 현실적인 대안입니다. 219,000원으로 최상위 레이서의 3분의 2 수준 가격이면서, 나일론 플레이트 특유의 부드러운 추진이 30km 이후에도 유지됩니다. 카본만큼 강한 반발은 아니지만, 서브4 전후 페이스에서는 그 차이보다 후반 충격 흡수(SA 136)와 착화 편의가 더 크게 작용합니다. 238g에 HA 18.5의 부드러운 폼이라 장거리 피로도 낮은 편입니다. 토박스가 이전 세대보다 넓어져 발볼이 다소 넓어도 풀코스 완주에 무리가 적습니다.',
      },
    {
        userType: '모델 선택 — 킨바라 16 대비 쿠션',
        text: '같은 경량 스피드 트레이너군에서 킨바라 계열과 비교하면 쿠션에서 크게 앞섭니다. SA 136에 HA 18.5의 부드러운 폼이라, 194g대의 초경량 모델에서 흔한 문제 — 쿠션이 부족해 다리가 먼저 지치는 현상이 없습니다. 238g으로 약간 무겁지만 그 차이로 소화 가능한 거리가 늘어납니다. 에너지 리턴 73.2%로 5분/km 안팎에서 추진도 느껴집니다. 토박스가 이전 세대보다 넓어졌으나 와이드 옵션은 없어, 발볼이 넓다면 시착이 필요합니다. 내구성 500km 기준 km당 약 438원입니다.',
      },
  ],
  ...
  purchaseLinks: [{ store: '네이버', url: 'https://naver.me/GuDSfLaW' }, { store: '쿠팡', url: 'https://link.coupang.com/a/g5ZgBi24J2' }],
};
