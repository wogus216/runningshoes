  ...
  },
  {
    ...
    reviews: [
      ...
      },
      {
        userType: '올라운드 러너',
        rating: 4,
        text: '여름 러닝에 통기성이 최고예요. 새벽 5시 북한산 둘레길 입구까지 왕복 8km 뛰는데, 7월에도 발이 쾌적합니다. 36mm 힐 스택이 아스팔트 충격을 잘 잡아주고, 232g 경량에 65.4% 에너지 리턴 덕에 언덕 오르막에서도 무릎에 부담이 적어요. 반면 12월에 같은 코스 뛸 때는 EVA 폼이 42% 더 단단해져서 충격이 그대로 올라오더라고요. 겨울에는 클리프톤으로 바꿔 신고, 마하 6는 3월~10월 전용으로 씁니다. 발볼이 넓은 한국 러너라 와이드 옵션을 골랐는데 토박스가 여유로워서 좋고, 450km 내구성에 km당 380원 가성비면 데일리 트레이너로 만점이에요. 평발이지만 안정성도 무난해서 별도 인솔 없이도 편안합니다.',
      },
    ],
    ...
    reviews: [
      {
        userType: '에디터 분석',
        rating: 80,
        text: '안정성(10/10) 최상위급 J-Frame 기술로 심한 과내전 러너를 위한 프리미엄 안정화입니다. 듀얼 폼 시스템이 발목을 확실히 잡아주며, 2mm 초로우드롭은 아킬레스건 부담을 줄여줍니다. 299g 무게에 35mm 힐/33mm 전족부 스택으로 안정적인 쿠셔닝을 제공하고, 500km 내구성으로 km당 370원 수준입니다. 23만 9천원은 Adrenaline GTS 25(17만원)보다 7만원 비싸 가성비는 아쉽지만, 토박스 75mm 이상의 와이드 핏과 와이드 옵션으로 발볼 넓은 한국 러너에게는 맞춤형 선택지입니다. 평발 러너에게 J-Frame의 아치 서포트가 탁월하며, 무릎/발목 보호가 필요한 과내전 러너에게 최고의 안정화입니다. 다만 낮은 반발력(5/10)으로 빠른 페이스에서는 답답하고, 6:30/km 이상의 편안한 조깅에서 진가를 발휘합니다.',
      },
      {
        userType: '과내전 러너',
        rating: 5,
