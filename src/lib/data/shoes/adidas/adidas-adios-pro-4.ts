...
export const shoe: Shoe = {
  ...
  reviews: [
    ...
    },
    {
        ...
        text: '30만원대 최상위 레이서를 비용 관점에서 보면, 대회 전용으로 한정할 때 풀코스 3회·하프 2회 정도가 현실적인 사용 범위입니다. 경쟁 모델인 알파플라이(34만원)·메타스피드 스카이(30만원)와 비교하면 가격대는 비슷한 구간이고, 할인가 26만원대를 잡으면 km당 약 1,495원까지 내려갑니다. 성능 면에서는 200g의 무게에 힐 37mm 스택, 컨티넨탈 러버 아웃솔로 접지까지 갖춘 구성입니다. 다만 이 비용은 기록 목표가 뚜렷할 때만 정당화되며, 와이드 옵션이 없어 발볼이 넓거나 안정성이 필요한 평발 성향에는 맞지 않습니다.',
      },
    {
      userType: '평발 러너',
      rating: 3,
