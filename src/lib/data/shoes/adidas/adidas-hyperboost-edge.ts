...
export const shoe: Shoe = {
  ...
  reviews: [
    ...
    {
        userType: '한국 러너 관점 — 계절과 발등 높이가 승부처',
        text: '한국에서 이 신발의 승부처는 계절입니다. 통기성 62는 러닝화 평균 이하이고 갑피가 촘촘한 우븐이라, 7~8월에 신으면 발에 열이 갇힙니다. 반대로 저온 경도 변화가 9%에 그쳐 겨울에 폼이 거의 굳지 않는데, 이건 한겨울 새벽 러닝이 잦은 러너에게 실질적인 장점입니다. 발 문제도 짚어야 합니다. 토박스 폭 자체는 71.4mm로 표준이지만 높이가 24.8mm로 낮아, 발볼보다 발등이 높은 발에서 압박이 옵니다. 와이드 옵션이 없다는 점까지 감안하면 발볼 넓은 러너에게는 선택지가 좁습니다. 249,000원이라는 가격에 이런 제약이 붙으니, 매장 착화 없이 온라인으로 사는 것은 권하지 않습니다.',
      },
    {
        userType: '해외 전문 리뷰 종합 — 단점이 갑피 한 곳에 집중',
