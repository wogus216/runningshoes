...
export const SATURDAY_CHAT: ChatBurst[] = [
  {
    ...
    lines: [
      { who: '재춘', at: '11:22', text: '입금하신 분들 한해서 기록용 사이트 만들어서 한번 체계적으로 관리 해드릴게요' },
      { who: '지자', at: '12:01', text: '재춘 7만원 다시 입금 좀' },
      { who: '지자', at: '12:02', text: '미틴 돈 왜 받아?' },
      { who: '지자', at: '12:02', text: '취소할걸' },
      { who: '기태', at: '12:02', text: '나도 취소할까 하고 고민중이었는데' },
      { who: '재춘', at: '12:15', text: '신청 완료했습니다!!', punch: true },
    ],
  },
  {
    id: 'gwangmuk',
    ...
    lines: [
      ...
      { who: '광묵', at: '12:08', text: '안녕하세요 인사 씨게 박습니다 초보 런린이입니다', punch: true },
      { who: '기태', at: '12:10', text: 'ㅋㅋ안녕하십니까 행님 화이팅입니다' },
      { who: '광묵', at: '20:12', text: '나 10키로는 이번 주말에 특훈 받아서 가능하지!' },
    ],
  },
  {
    id: 'fee',
    ...
    lines: [
      { who: '형가', at: '17:22', text: '완주하고 내면 안 되겠지?' },
      { who: '남길', at: '17:23', text: '용돈 다 떨어졌는데' },
      { who: '감자', at: '17:24', text: '성공하고 주면 기분 좋을 듯' },
      { who: '형가', at: '17:24', text: '재춘아 무이자 할부 가능하냐?' },
      { who: '형가', at: '17:40', text: '가조쿠 특별 할인 없나여?? 저희 3명인데' },
      { who: '남길', at: '17:42', text: '부가세만이라도' },
      { who: '기태', at: '17:43', text: '아이스크림이라도 하나만 사줘라', punch: true },
    ],
  },
  {
    id: 'mileage',
    ...
    lines: [
      { who: '기태', at: '18:03', text: '최소 월 200씩은 뛰어야 완주되겠지' },
      { who: '재춘', at: '18:04', text: '감자 내가 체계적으로 훈련 짜줄게' },
      { who: '감자', at: '18:04', text: '나오기나 해', punch: true },
      { who: '감자', at: '18:04', text: '겨우 주 1회 뛰어줄까 말까잖아' },
      { who: '감자', at: '08.13 18:16', text: '그걸 했으면 마라톤 선수 했겠지' },
      { who: '광묵', at: '08.17 11:58', text: '어제 6키로 뛰고 소주 마셨는데 반성해야겠다..' },
    ],
  },
  {
    id: 'fear',
    label: '겁이 나기 시작했다',
    lines: [
      { who: '감자', at: '17:20', text: '과연 내가 저걸 해낼 수 있는지를' },
      { who: '감자', at: '17:55', text: '풀마라톤 버려지면 어케 완주함?' },
      { who: '감자', at: '17:55', text: '앰뷸 탈 수 있나?' },
      { who: '형가', at: '17:55', text: '휴 벌써부터' },
      { who: '형가', at: '17:56', text: '포기하려 하네 후' },
      { who: '남길', at: '18:01', text: '그냥 믿고 따라와' },
      { who: '감자', at: '08.13 18:11', text: '다리 안 움직일 거 같은데 형가' },
      { who: '형가', at: '08.13 18:12', text: '아니 휠리스 바퀴 몰래 끼든가', punch: true },
    ],
  },
  {
    id: 'saturday',
    ...
    lines: [
      ...
      { who: '형가', at: '23:40', text: '7시 30분 확인' },
      { who: '형가', at: '08.17 06:36', text: '재춘 기태 일어나면 연락해, 도림천 매크로 돌리고 있을게' },
    ],
  },
  {
    id: 'why',
    ...
    lines: [
      { who: '재춘', at: '12:04', text: '야 이거 파티냐?' },
      { who: '재춘', at: '12:04', text: '일정 끝나고 사우나 코스까지 쫙 해야겠는데' },
      { who: '형가', at: '17:44', text: '풀마라톤 등록하니까 가슴 뜨거워지네' },
      { who: '형가', at: '17:44', text: '어떡하지?' },
      { who: '재춘', at: '18:05', text: '재밌는 추억 개많이 쌓이겠다', punch: true },
      { who: '남길', at: '08.18 07:36', text: '다들 잘 뛰네' },
    ],
  },
];
