...
export const septemberEvents: MarathonEvent[] = [
  ...
  },
  {
    ...
    courseInfo: {
      ...
      certification: '없음',
      courseDescription:
        '세 종목 모두 인천대 송도캠퍼스 정문 출발·피니시의 왕복 코스입니다. 하프는 송도 해안도로를 따라 홈플러스 송도점(1차)·블루오션CC 인근(2차)·송도 아트센터(3차) 3개 반환점을 돌고, 10K는 2개 반환점, 5K는 잭니클라우스GC 외곽을 한 바퀴 돕니다. 공식 코스도는 종목별 이미지 지도로 게시돼 있으며 고저도·급수 정보는 미게시입니다(2026-08-27 공식 코스도 확인).',
    },
    raceInfo: {
      entryFees: [
