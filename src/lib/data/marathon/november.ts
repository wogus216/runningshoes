...
export const novemberEvents: MarathonEvent[] = [
  ...
  },
  {
    ...
    description:
      '서울신문 주최 가을 러닝 대회. 2025년(11/9, 하프·10K·5K)에 이어 2026년은 11월 21일(토) 오전 7시 30분에 출발하며, 올해부터 아식스가 타이틀 스폰서로 붙어 대회명 자체가 "ASICS SEOUL SHINMUN GO FREE RUN"이 됐습니다. 종목은 하프·10K이고 참가비는 정상가 각 7만원, 서울신문 회원가입 완료자 선착순 3,000명에게 얼리버드 6만 5천원이 적용됩니다(신청 시 서울신문 ID 필수 입력). 일반 접수 시작일은 2026-08-18 기준 아직 공지되지 않았습니다. 다만 아식스가 참가권을 포함한 스페셜 패키지 래플을 먼저 엽니다 — 하프는 슈퍼블라스트 3, 10K는 노바블라스트 6에 참가 티켓·공식 티셔츠를 묶은 구성으로, 아식스 공식 온라인 스토어에서 8월 19일 10:00~8월 24일 23:59 응모, 8월 25일 당첨자 발표입니다(패키지 가격·수량은 미공개).',
    raceInfo: {
      entryFees: [
