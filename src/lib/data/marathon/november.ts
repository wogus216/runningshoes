...
export const novemberEvents: MarathonEvent[] = [
  ...
  },
  {
    ...
    registrationNote:
      '마지막 추가 접수가 9월 8일(화) 14시에 열려 진행 중입니다 — 창구는 JTBC 홈페이지가 아니라 러너블(runable.me)이고 마감은 9월 18일(금) 17시입니다. 다만 "접수일정은 상황에 따라 조기 종료될 수 있다"는 단서가 붙어 있어 정원이 차면 그 전에 닫힙니다. 1인 1매, 참가비는 본접수와 동일(풀 15만·10km 10만). 정보 수정·참가 취소·기록 제출도 모두 9월 18일 17시까지',
    description:
