...
export const novemberEvents: MarathonEvent[] = [
  ...
  },
  {
    ...
    registrationEnd: '2026-10-21',
    registrationNote:
      '8월 26일(수) 10시부터 선착순 — 공식 요강은 별도 마감일 없이 정원이 차면 종료한다고 안내합니다. 공식 유의사항상 수정·취소(환불)는 10월 21일(수) 17시까지 가능합니다. 10K 달리기 2,300명·3K 걷기 700명 정원이 차면 그 전에 닫힐 수 있습니다.',
