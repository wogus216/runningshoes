...
export const novemberEvents: MarathonEvent[] = [
  ...
  },
  {
    ...
    raceKit: {
      items: ['배번호(기록칩 부착)', '기념 티셔츠 — 접수 시 사이즈 선택, 변경 불가', '완주메달(완주자 현장 수령)', '완주기념품(완주자 현장 수령)'],
      pending: '기념품 메뉴는 2026-09-04 현재 COMING SOON — 티셔츠 외 구성은 미공개. 배번호·기념품은 대회 전 택배 순차 발송(배송비 주최 부담), 배송지 변경은 10월 19일 14시까지',
