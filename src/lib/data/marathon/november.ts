...
export const novemberEvents: MarathonEvent[] = [
  ...
  },
  {
    ...
    registrationNote: '9월 7일 참가접수 오픈 — 공식 안내 카드로 확정. 시각·선착순 여부·정원은 미고지 (2026-08-27 확인)',
    lastVerified: '2026-08-27',
    description:
      '인천시·대한육상연맹 주최 인천 최초·유일 공식 풀코스 마라톤(제2회). 2026-08-27 대회 공식 안내 카드로 참가접수 개시일이 9월 7일로 확정 공지됐습니다. 다만 같은 날 확인한 공식 홈페이지(incheonmarathon.or.kr)는 대회안내·참가신청·기념품·코스안내·커뮤니티 메뉴가 여전히 전부 "COMING SOON"이고, 메인 배너도 개최일 11월 22일·종목 풀코스/10km/5km·슬로건 "청라의 하늘 길을 달리다"만 걸려 있습니다. 즉 확정된 것은 접수 개시일까지이고 접수 시각·선착순 여부·정원·참가비·코스·기념품은 아직 공식 게시 전입니다. 풀코스 출발지가 영종구 운서역 일원으로 바뀌었다는 정리는 러닝 정보 계정(@runner_iffu) 기준이며 공식 확인되지 않았습니다 — 4월 언론 보도 단계의 코스 안은 아시아드주경기장 출발이었습니다. 참가비(풀 8만·10km 5만·5km 3만)와 총 2만 명(풀 8,000명) 규모도 4월 보도 기준이라 접수 개시 후 공식 요강을 확인하세요.',
  },
  {
