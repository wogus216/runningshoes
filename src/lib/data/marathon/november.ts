...
export const novemberEvents: MarathonEvent[] = [
  ...
  },
  {
    ...
    description:
      '1936 베를린올림픽 금메달리스트 손기정 선생을 기리는 평화·통일 테마 대회(2005년 제1회, 2026년 제22회). 접수가 8월 9일(일) 오전 9시 열렸고 마감일 없이 선착순 마감입니다(공식 대회요강 2026-08-10 확인). 2025년엔 9/13 오픈 후 약 2만 명이 일주일 안에 찼으니 서두르는 편이 안전합니다. 접수 시각 기준 24시간 안에 결제하지 않으면 신청내역이 삭제됩니다. 대회일은 11월 15일(일), 대회장은 고양 제2자유로에서 임진각 민통선 일대(파주)로 이전합니다("임진각~개성 남북평화마라톤으로 발전하는 출발점" 구상). 종목은 6km 슬로우가 신설돼 4개가 됐고 참가비는 전 종목 1만원 인상(풀 7만·하프 6.5만·10K 6만·6K 5만). 기념품·배번호 패키지는 11월 9일 우체국택배로 발송됩니다. 코스 상세는 공식 준비중 — 2025년까지의 제2자유로 코스와 달라질 수 있습니다.',
    courseInfo: {
      terrain: '평지',
      difficulty: '중급',
      courseDescription:
