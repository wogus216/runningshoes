...
export const novemberEvents: MarathonEvent[] = [
  {
    ...
    status: '마감',
    isMajor: false,
    website: 'https://www.saverace.co.kr/',
    registrationStart: '2026-09-07',
    registrationEnd: '2026-09-18',
    registrationNote:
      '**응모가 9월 18일(금) 17시에 마감됐습니다**(2026-09-21 공식 홈 확인, 연장·추가 접수 공지 없음). 선착순이 아니라 **랜덤 추첨**이었고, 카카오뱅크 앱 내 이벤트 페이지에서만 신청받아 7,000명을 선발합니다. 남은 일정은 두 가지입니다 — 당첨자 발표는 9월 30일(수) 공식 홈페이지와 카카오뱅크 앱에서, 참가비 결제는 9월 30일 10시부터 10월 7일(수) 17시까지 따로 해야 합니다. **결제 기한을 넘기면 당첨돼도 참가할 수 없습니다.**',
    lastVerified: '2026-09-21',
    description:
      '카카오뱅크와 유니세프한국위원회가 기후위기로 어려움을 겪는 어린이를 돕기 위해 여는 친환경 기부 마라톤입니다. 참가비 50,000원은 전액 참가자 본인 명의의 기부금으로 유니세프한국위원회에 전달되며, 7,000명 정원이 모두 차면 총 3억 5천만 원이 모입니다. 종목은 10km 단일 코스이고 여의도공원 문화의마당에서 출발해 서강대교를 지나 광흥창역 사거리에서 반환합니다. 집결 07:00, 출발 07:30입니다. 신청 방식이 다른 대회와 다릅니다 — 선착순이 아니라 추첨이고, 카카오뱅크 앱을 통해서만 접수하며, 당첨 발표(9/30)와 참가비 결제(9/30~10/7)가 접수와 분리돼 있습니다. 제한시간·급수대·기록 측정 방식·기념품 구성은 2026-09-18 기준 공식 미게시입니다(전년도 대회에서는 업사이클링 부자재로 만든 친환경 굿즈 패키지가 제공됐으나 올해 구성은 확인되지 않아 적지 않습니다). 주최는 카카오뱅크, 주관은 유니세프한국위원회입니다.',
    courseInfo: {
      terrain: '평지',
      difficulty: '초보자',
      courseDescription:
        '10K: 여의도공원 문화의마당(START) → 서강대교 → 광흥창역 사거리 반환 → 여의도공원 문화의마당(FINISH). 한강 북단을 왕복하는 반환형 도심 코스입니다. 고도·급수대 위치·상세 코스도는 공식 미게시(2026-09-18 확인).',
      isLoopCourse: false,
    },
    raceInfo: {
  ...
  },
  {
    ...
    registrationEnd: '2026-09-18',
    registrationNote:
      '**마지막 추가 접수가 9월 18일(금) 17시에 마감됐습니다** — 2026-09-21 확인 기준 러너블(runable.me) 목록에서 해당 상품이 내려갔고, JTBC 공식 공지사항의 최신 글은 9월 4일 「추가 접수 안내」로 그 뒤 연장·재개 공지가 올라오지 않았습니다. 9월 8일(화) 14시에 열렸던 이 추가 접수가 2026년 대회의 마지막 접수 기회였고, 창구는 JTBC 홈페이지가 아닌 러너블이었습니다(1인 1매, 참가비는 본접수와 동일한 풀 15만·10km 10만). **같은 9월 18일 17시에 정보 수정·참가 취소·기록 제출도 함께 마감됐습니다.** 남은 일정은 그룹 배정입니다 — 9월 30일 1차 공개, 10월 5일 17시까지 이의 신청, 10월 6일 최종 안내.',
    description:
      '국내 최대 규모 가을 풀코스 마라톤(11/1). 공식 대회 안내 기준 모집 인원은 30,000명이고, 출발은 상암월드컵공원, 피니시는 풀코스 올림픽공원·10K 여의도공원이며(주최 측 사정으로 변경 가능 단서 있음), 풀코스 출발 시간이 8시에서 7시 30분으로 앞당겨졌습니다. 풀코스는 만 18세 이상(2008년 11월 1일 이전 출생)이면서 5시간 이내 완주 가능한 러너로 자격이 제한되고, 10K는 신체 건강한 남녀면 됩니다. 상세 코스도·고저도는 아직 미게시 상태입니다(2026-08-29 공식 홈 확인 — 2025년에도 대회 직전 10월경 공개된 패턴). 본접수는 추첨제로 4월 마감됐고, 미등록 티켓 추가 기회 중 7월 KB 마라톤카드 래플(풀 1,000명·10K 3,000명)과 8월 KB국민카드 협찬 이벤트(풀 200명)를 거쳐 마지막 추가 접수가 9월 8일(화) 14시에 열려 9월 9일 밤 기준으로 아직 진행 중입니다. 접수 창구는 JTBC 홈페이지가 아니라 러너블(runable.me)이고, 상품 페이지에 접수 기간이 9월 8일 14시~9월 18일(금) 17시로 명시돼 있습니다 — 다만 "접수일정은 상황에 따라 조기 종료될 수 있다"는 단서가 붙어 있어 정원이 차면 그 전에 닫힙니다. 1인당 1매만 살 수 있고 참가비는 본접수와 같은 풀 15만원·10km 10만원입니다. 정보 수정·참가 취소도 모두 9월 18일(금) 17시까지입니다. 같은 날 공개된 그룹 배정 안내에 따르면 기록 제출은 9월 18일(금) 17시 마감이고 러너블 앱 [기록모아] 탭으로 냅니다 — 최근 3년 이내(2023.11.1~2026.9.18) 기록만 인정되지만 제출은 선택 사항이라 미제출해도 참가할 수 있습니다. 배정 그룹은 9월 30일 1차 공개, 10월 5일 17시까지 이의 신청, 10월 6일 최종 안내이며 풀코스는 A~H 8개 그룹(A그룹은 서브3 이내)·10K는 A~D 4개 그룹으로 나뉩니다. 2026년부터 레이스팩은 택배 없이 코리아 러닝 엑스포 현장 수령으로 바뀌었습니다 — 10/29(목)~30(금) 12~20시, 10/31(토) 10~23시에 SETEC 1관(학여울역 1번 출구)에서만 배부하고 별도 택배는 없으며, 개인 QR코드로 대리 수령이 가능합니다(방법 추후 안내). SETEC 주차장은 이용할 수 없습니다.',
    courseInfo: {
      terrain: '평지',
      difficulty: '중급',
      courseDescription:
  ...
  },
  {
    ...
    registrationStart: '2026-08-18',
    registrationNote:
      '8월 18일 접수 시작 → 다음 날인 8월 19일 "참가신청마감 및 추가신청 안내" 공지 → 8월 21일 추가접수 공지 순으로 진행됐고, 2026년 9월 16일 기준 공식 홈에 "참가신청 마감" 팝업이 떠 있습니다. 추가접수 종료일은 공식에 고지되지 않았습니다. ⚠️ 공식 홈 일정표의 9월 18일은 마라톤 접수가 아니라 "인권, 짧은 글짓기대회" 접수 마감일입니다 — 둘을 혼동하지 마세요.',
    lastVerified: '2026-09-16',
    description:
      '태화강변 코스를 달리는 울산 대표 시민 마라톤 21회차(공식 표기 제21회). 8월 18일 접수를 시작했으나 하루 만에 참가신청이 마감됐고, 8월 21일 추가접수가 공지된 뒤 그마저 닫혔습니다(2026-09-16 공식 확인). 기록 시상 없이 참가자 전원에게 동행기념품을 주는 방식이며, 장애인·18세 미만 할인가(하프·10km 25,000원, 5km 15,000원)와 장애인 동반 1인 참가비 면제가 있습니다.',
    raceInfo: {
      entryFees: [
  ...
  {
    id: 'seoul-bbangbbang-run-2026',
    name: '서울 빵빵런 2026',
    date: '2026-11-14',
    month: '11월',
    location: '서울 뚝섬한강공원 수변무대 (서울 광진구 자양동 435)',
    region: '서울',
    distances: ['10K', '5K'],
    status: '접수중',
    isMajor: false,
    website: 'https://seoul.bbangrun.com/',
    registrationStart: '2026-09-21',
    registrationNote: '2026-09-21(오늘) 15시 접수 오픈(출처: 인스타 @runsosik). 공식 사이트 자체 공지 텍스트로는 오픈 시각을 확인하지 못했으나, 참가권 구매 버튼이 활성 상태인 것으로 접수 진행 중임을 확인함(2026-09-21 21시경). 마감일 미고지.',
    lastVerified: '2026-09-21',
    description:
      '10월 대전에 이어 열리는 빵빵런 시리즈의 서울 개최로, 빵집 기념품을 완주 보상으로 주는 러닝 대회입니다. 뚝섬한강공원에서 열리며 종목은 10K·5K 두 가지, 참가비는 각 59,000원입니다. 출발은 10K가 8:30·8:35·8:40(A~C그룹), 5K가 9:30·9:35·9:40(A~C그룹)이고 그 이후에는 출발할 수 없습니다. ⚠️ 제한시간은 공식 페이지 간 표기가 다릅니다 — 참가권 페이지는 10K 100분·5K 60분, 코스 페이지는 10K·5K 모두 90분이라고 적혀 있어 더 짧은 쪽(10K 90분·5K 60분)을 기준으로 안내합니다. 넷타임 기록칩이 전 코스에 제공됩니다. 취소·환불은 10월 2일(금) 17시까지만 가능하고 이후에는 취소·환불·티셔츠 사이즈·코스·그룹 변경이 전부 불가합니다. 티셔츠·배번호표(기록칩 포함)는 11월 3일(화)부터 순차 택배 발송되고, 그 외 기념품은 당일 현장에서 받습니다. 완주 후 빵빵룩 어워즈(패션 시상, 시상식 10:30)·빵빵 스트레칭·포토존·이벤트존 등 부대 프로그램이 진행되며, 주최 측은 대회를 통해 모인 빵(베이커리류)을 소외계층 아동에게 기부합니다(역대 누적 31,100개). 전 연령 참가 가능하나 미성년자는 보호자 동반이 필수이고, 반려견·유모차 동반은 불가합니다. 주최·주관은 (주)1986프로덕션입니다.',
    courseInfo: {
      terrain: '평지',
      difficulty: '초보자',
      courseDescription:
        '10K: 뚝섬 수변무대(행사장) → 올림픽대교 → 광진정보도서관 인근 반환 → 뚝섬 수변무대(행사장). 5K: 뚝섬 수변무대(행사장) → 잠실대교 → 잠실철교 반환 → 뚝섬 수변무대(행사장). 두 코스 모두 한강 자전거·산책로를 따라 왕복하는 평지 코스입니다(공식 코스 페이지 기준, 2026-09-21 확인).',
      isLoopCourse: false,
    },
    raceInfo: {
      entryFees: [
        { distance: '10K', fee: 59000 },
        { distance: '5K', fee: 59000 },
      ],
      timeLimits: [
    ...
    raceKit: {
      items: [
        '공식 티셔츠·배번호표(기록칩 포함) — 사전 택배 발송(11/3부터 순차)',
        '빵 기념품 — 하츠베이커리 완두 크치 쫀득빵 · 나폴레옹과자점 소보로 in 소보로 · 소금빵 1종 랜덤(오월의 밀밭·셰프의 아이들·오소리 베이커리) · 삼정수제강정 딸기 모찌',
      ],
      pending: '빵 기념품 구성은 인스타 @runsosik 캡션 출처로, 공식 기념품 페이지(seoul.bbangrun.com/souvenirs)에서 재확인 권장. 완주메달 등 그 외 현장 수령 기념품 상세는 미확인.',
      verifiedAt: '2026-09-21',
    },
    logistics: {
      parking: '행사장 주차 공간이 협소해 공식은 대중교통 이용을 권장',
      publicTransport:
        '버스 2221·2222·2415·광진05(신자초등학교앞) · 2014(자양4동주민센터앞) · 광진05(자양종합복지관앞) · 2222·2412·광진05(자양우성아파트앞) / 지하철 자양(뚝섬한강공원)역 2·3번 출구 도보 약 20m',
      bagStorage: true,
    },
  },
  {
  ...
  },
  {
    ...
    registrationNote:
      '선착순, 마감일 미고지 — 본접수는 하프 6월 25일(목) 14시·10km 6월 26일(금) 14시에 열렸습니다(런잇 RUNIT, 단체신청 불가). 취소·환불은 8월 31일(월) 17시까지만 가능하고 이후에는 어떤 사유로도 되지 않습니다. 본접수 마감 후 취소분을 모아 추가접수가 열립니다 — 프로모션 접수 9월 18일(금) 14시, 10km 추가접수 9월 21일(월) 14시, 하프 추가접수 9월 22일(화) 14시, 모두 선착순 마감(공식 홈 2026-09-11 확인)',
    raceKit: {
  ...
  },
  {
    ...
    registrationStart: '2026-09-07',
    registrationNote:
      '9월 7일(월) 14시 접수 시작 — 마감일 미고지이고 9월 7일 밤까지 공식 마감 공지는 없습니다. 풀코스는 기록증 제출자만 신청 가능(2024.1.1~2026.10.19 대회에서 풀 4:59:59 이내 또는 하프 2:09:59 이내, 1인 1건만 제출). 단체 신청은 받지 않고 개인 신청만 가능합니다. 참가 취소·종목 변경·기록증 제출은 모두 10월 19일(월) 14시까지. 추가접수는 "참가신청 마감 이후 안내 예정"이라고만 공지돼 있습니다',
    lastVerified: '2026-09-09',
    description:
      '인천시·대한육상연맹 주최 인천 최초·유일 공식 풀코스 마라톤(제2회). 접수는 9월 7일(월) 14시에 시작하고, 정원은 총 2만 명으로 풀코스 8,000·10km 10,000·5km 2,000명으로 나뉩니다. 참가비는 풀 8만·10km 5만·5km 3만원입니다. 접수 나흘 전인 9월 3일 공식 홈페이지에 코스도와 유의사항이 올라오면서 준비중이던 항목 대부분이 확정됐습니다. 신청 전에 확인해야 할 가장 큰 조건은 풀코스 참가 자격입니다 — 만 18세 이상이면서 2024년 1월 1일~2026년 10월 19일 대회에서 풀코스를 4시간 59분 59초 이내로, 또는 하프를 2시간 9분 59초 이내로 완주한 기록증을 런카이브로 제출해야 합니다. 기간 내 미제출 시 자동 환불 처리된다고 공식이 명시했습니다. 10km·5km는 기록 조건이 없습니다. 제한시간은 풀 5시간·10km·5km 1시간 30분이며, 공식은 도심 교통통제 해제 시간 때문에 이를 엄격히 적용한다고 밝혔습니다. 급수는 종목별로 크게 갈립니다 — 풀코스는 음료 공급대가 매 5km(스펀지는 7.5km 이후 매 5km)에 놓이지만 10km는 1개소뿐이고 5km는 별도 급수대를 운영하지 않습니다. 배번호·기록칩·기념품은 대회 1주 전까지 접수 시 입력한 주소로 택배 발송되고 완주메달과 완주기념품만 현장에서 받습니다. 물품보관소는 11월 22일(일) 06:30~15:00에 운영되며 귀중품과 캐리어처럼 부피가 큰 물품은 맡길 수 없습니다. 접수가 열린 9월 7일에 기념품·참가신청·공지사항 메뉴가 함께 공개되면서 종목별 구성이 확정됐습니다 — 풀코스는 번호표(기록칩)·티셔츠·완주메달·타월·블랭킷·에너지젤·마스크팩 7종, 10km는 번호표(기록칩)·티셔츠·완주메달·양말·마스크팩 5종, 5km는 같은 5종이되 번호표에 기록칩이 붙지 않습니다. 즉 5km는 기록이 남지 않고 급수대도 없는 종목입니다. 단체 신청은 받지 않고 개인 신청만 가능하며, 30인 이상 단체에는 추후 공지에 따라 부스만 배정합니다. 배번은 본인만 쓸 수 있고 양도·대리참가 시 실제 참가자와 보험가입자가 달라져 사고 보상이 제한될 수 있다고 공식이 고지했습니다. 주관은 인천시체육회·인천시육상연맹, 운영은 동아일보사·스포츠웨이브입니다.',
    courseInfo: {
      terrain: '평지',
      difficulty: '중급',
      courseDescription:
        '9월 3일 공개된 공식 코스도로 청라하늘대교 통과가 확정됐습니다. 인천시가 4월에 "추진한다"고만 밝혔던 사안이 코스도에 다리 이름과 함께 표기됐습니다. 풀코스는 영종구 운서역에서 출발해 영종 안쪽을 한 차례 돌아 인천중산중학교 방면까지 왕복한 뒤 청라하늘대교로 바다를 건너고, 청라국제도시역 방면을 왕복한 다음 크리스털 삼거리를 지나 인천아시아드 주경기장으로 들어옵니다. 세계육상연맹 공인은 "예정"으로 표기돼 있고, 공식은 코스가 변경될 수 있다고 함께 고지했습니다. 섬에서 출발해 육지에서 끝나는 편도라 출발지까지 이동을 따로 계획해야 하는데, 물품은 운서역 출발지에서 맡기면 골인지인 주경기장으로 옮겨줍니다. 집결은 두 종목 모두 오전 6시 30분(예정)이고 풀코스는 운서역 일원, 10km·5km는 주경기장입니다. 10km는 주경기장 옆에서 출발해 국제청라사거리를 지나 청라 호수공원 방면에서 반환한 뒤 주경기장 트랙으로 들어오고, 5km는 주경기장에서 출발해 초은고등학교 앞에서 반환해 주경기장 남측광장에서 끝납니다. 11월 하순 개최라 바다 위 구간의 바람과 체감온도가 변수입니다.',
    },
    raceInfo: {
      entryFees: [
      ...
      aidInterval: '풀코스 매 5km(스펀지는 7.5km 이후 매 5km) · 10km 1개소 · 5km 없음',
      expectedParticipants: 20000,
      startTime: '08:00',
    },
    logistics: {
      parking: '인천아시아드 주경기장 주차장은 이용할 수 없고, 대회 지정 주차장(추후 안내)만 쓸 수 있습니다',
      shuttle: '대회 지정 주차장 ↔ 풀코스 출발지·아시아드 주경기장 셔틀버스 운행',
      bagStorage: true,
    },
    raceKit: {
      byDistance: [
        { distance: '풀코스', item: '번호표(기록칩) · 대회 공식 티셔츠 · 완주 메달 · 타월 · 블랭킷 · 에너지젤 · 마스크팩' },
        { distance: '10km', item: '번호표(기록칩) · 대회 공식 티셔츠 · 완주 메달 · 양말 · 마스크팩' },
        { distance: '5km', item: '번호표(기록칩 없음) · 대회 공식 티셔츠 · 완주 메달 · 양말 · 마스크팩' },
      ],
      pending:
        '티셔츠는 접수 시 XS~2XL 중에서 고르고 변경할 수 없습니다(조견표 기준 어깨너비 40~50cm·가슴둘레 90~115cm·총기장 63~73cm). 배번호·기록칩·기념품은 대회 1주 전까지 접수 시 입력한 주소로 택배 발송되고, 완주 메달과 완주기념품만 현장에서 받습니다. 배번호표와 기록칩은 1인 1개만 주고 분실해도 재발급되지 않습니다.',
  ...
  },
  {
    ...
    isMajor: false,
    description:
      '남원종합스포츠타운에서 출발하며, 11월 하순에는 드물게 풀코스를 운영하는 대회입니다. 전국마라톤협회 주관으로 요강상 접수 기간은 7월 7일부터 10월 28일까지지만, 실제로는 선착순으로 먼저 닫힙니다 — 1차 접수가 선착순 6천 명을 채우고 8월 3일에 조기 마감됐고, 환불 기간이 끝난 뒤 2차 접수가 9월 11일(금) 오전 10시에 선착순 500명으로 열렸습니다. 제한시간은 풀 5시간(반환점 2시간 45분)·하프 3시간·10km 2시간이며, 10km 이상은 완주 메달과 지역상품권 1만원을 받습니다. 남원시민 5km는 20,000원.',
    website: 'https://mara1080.com/event/c2cec79b-c38a-4832-bf4f-7ecb499cdcd5',
    registrationStart: '2026-09-11',
    registrationEnd: '2026-10-28',
    registrationNote:
      '2차 접수 진행 중 — 공식 공지(2026-09-10 게시) 기준 9월 11일(금) 오전 10시에 선착순 500명으로 열렸습니다. 1차는 선착순 6천 명을 채우고 8월 3일 조기 마감됐습니다. 요강상 마감은 10월 28일이지만 선착순 500명이라 그 전에 닫힙니다 — 잔여 정원은 공식이 공개하지 않아 확인할 수 없으니(2026-09-11 22시 확인) 신청 전에 공식 페이지에서 직접 보세요. 입금·변경·환불은 9월 30일(수)까지.',
    raceKit: {
      byDistance: [
        { distance: '5km', item: '기능성 티셔츠(90~110)' },
