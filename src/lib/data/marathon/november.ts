...
export const novemberEvents: MarathonEvent[] = [
  ...
  },
  {
    ...
    description:
      '서울신문 주최 가을 러닝 대회. 2025년(11/9, 하프·10K·5K)에 이어 2026년은 11월 21일(토)에 열리며, 올해부터 아식스가 타이틀 스폰서로 붙어 대회명 자체가 "ASICS SEOUL SHINMUN GO FREE RUN"이 됐습니다. 종목은 하프·10K이고 참가비는 각 7만원입니다. 접수는 스페셜 패키지 래플(8/19~24, 당첨 발표 8/25)을 거쳐 9월 1일(화)부터 선착순 본접수로 알려졌으나, 2026-08-13 확인 시점 공식 홈페이지 대회요강에는 여전히 "참가접수 미정"으로 표기돼 있습니다(공지사항 게시글 0건). 8월 초까지 안내되던 서울신문 회원 얼리버드(선착순 3,000명 6만 5천원) 문구도 현재 참가신청 안내에서는 확인되지 않고 "일반접수 70,000원"만 남아 있습니다. 신청 전 공식 요강을 반드시 확인하세요.',
    raceInfo: {
      entryFees: [
