...
export const novemberEvents: MarathonEvent[] = [
  {
    ...
    registrationNote:
      '선착순이 아니라 **랜덤 추첨**입니다. 9월 7일(월) 10시부터 9월 18일(금) 17시까지 카카오뱅크 앱 내 이벤트 페이지에서만 신청받고, 추첨으로 7,000명을 선발합니다. 당첨자는 9월 30일(수) 공식 홈페이지와 카카오뱅크 앱에서 발표하며, 참가비 결제는 9월 30일 10시부터 10월 7일(수) 17시까지 따로 해야 합니다 — 결제 기한을 넘기면 당첨돼도 참가할 수 없습니다.',
  ...
  },
  {
    ...
    registrationEnd: '2026-09-18',
    registrationNote:
      '마지막 추가 접수가 9월 8일(화) 14시에 열렸고 2026년 9월 11일 22시 기준 러너블 메인에 "2026 JTBC 서울마라톤 추가접수 09.08 14:00 OPEN"이 마감 표시 없이 걸려 있습니다(잔여 정원은 비공개라 소진 여부까지는 확인 불가). 창구는 JTBC 홈페이지가 아니라 러너블(runable.me)이고 마감은 9월 18일(금) 17시입니다. 다만 "접수일정은 상황에 따라 조기 종료될 수 있다"는 단서가 붙어 있어 정원이 차면 그 전에 닫힙니다. 1인 1매, 참가비는 본접수와 동일(풀 15만·10km 10만). 정보 수정·참가 취소·기록 제출도 모두 9월 18일 17시까지',
    description:
