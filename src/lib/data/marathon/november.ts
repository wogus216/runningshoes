...
export const novemberEvents: MarathonEvent[] = [
  {
    id: 'purme-run-2026',
    name: '2026 푸르메런 (넥슨과 함께하는 Miracle365 푸르메런)',
    date: '2026-11-07',
    month: '11월',
    location: '월드컵공원 평화의공원 평화광장 (서울 마포구)',
    region: '서울',
    distances: ['10K'],
    status: '접수중',
    isMajor: false,
    website: 'https://purmerun.com/',
    registrationStart: '2026-08-26',
    registrationEnd: '2026-09-23',
    registrationNote:
      '8월 26일(수) 10시부터 선착순 — 공식 요강은 "선착순 마감"으로만 표기하고 마감일을 두지 않았습니다. 재단 보도자료(2026-08-26)와 러닝 캘린더가 9월 23일까지로 안내하고 공식 유의사항의 수정·취소 마감이 9월 23일(수) 17시라 그 시각을 접수 마감으로 봅니다. 10K 달리기 2,300명·3K 걷기 700명 정원이 차면 그 전에 닫힙니다.',
    lastVerified: '2026-09-03',
    description:
      '푸르메재단 넥슨어린이재활병원 10주년을 기념하는 기부 대회로, 참가비 전액이 장애어린이 재활치료비로 기부됩니다. 다만 티셔츠·메달 등 리워드가 제공되는 보상형 크라우드펀딩 방식이라 기부금품법상 기부금영수증은 발급되지 않습니다(공식 요강·FAQ 명시). 종목은 10K 달리기 50,000원(2,300명)과 3K 걷기 20,000원(700명)이고 제한시간은 전 부문 2시간입니다. 신청 시 후원할 어린이의 꿈(휠체어 레이서·아티스트·축구선수·재활치료사)을 고르면 배번호에 인쇄돼 함께 달립니다. 코스는 평화광장에서 출발해 하늘공원·노을공원 사이 난지 순환길을 돌아 반환하며, 10K는 4~6km 구간이 비포장이라고 공식이 고지했고 3K는 하늘공원 방향 3km 지점에서 반환합니다. 고도·급수대·기록 측정 방식은 공식 미게시입니다. 연령 제한은 없으나 만 14세 미만은 법정대리인 동의 후 단체원으로만 신청할 수 있고, 반려견은 3K 걷기에만 동반 가능하며, 수동 휠체어·유아차는 보호자가 함께 신청하면 전 코스 참가 가능(전동 휠체어 불가)합니다. 시각장애인은 가이드러너와 함께 별도 페이지에서 신청합니다. 수정·취소는 9월 23일(수) 17시까지만 가능하고 이후에는 천재지변으로 행사가 취소돼도 환불되지 않습니다. 티셔츠(KS~3XL)·넥슨 캐릭터 반다나·퓨어더마 선크림·배번호·엽서는 사전 택배 발송, 완주 메달과 토마토즙·머핀·뽀로로 젤리·홍삼·에너지젤은 당일 현장 지급이며 불참 시 배송되지 않습니다. 현장에서 행운권 추첨(갤럭시 워치9 등)과 넥슨 베스트 드레서 이벤트가 열립니다. 넥슨은 2024년 창립 30주년 "넥슨 히어로" 캠페인으로 유저 16만 명이 참여한 34억 원의 기금을 모아 이 대회에 활용합니다. 주최 푸르메재단, 후원 NEXON·넥슨재단·넥슨 히어로. 대회장 배치·교통·시각별 일정은 2026-09-03 기준 "준비 중"입니다.',
    courseInfo: {
      terrain: '혼합',
      difficulty: '초보자',
      courseDescription:
        '10K: 평화광장(START) → 하늘공원 → 노을공원 → 10km 반환점 → 하늘공원 → 평화광장(FINISH), 난지 순환길. 공식 코스도가 "4km~6km 구간이 비포장 도로"라고 고지. 3K 걷기: 평화광장 → 하늘공원 → 3km 반환점 → 하늘공원 → 평화광장. 고도·급수대 미공개, 코스 변경 가능 고지.',
      isLoopCourse: false,
    },
    raceInfo: {
      entryFees: [
        { distance: '10K', fee: 50000 },
        { distance: '3K 걷기', fee: 20000 },
      ],
      timeLimits: [
        { distance: '10K', hours: 2, minutes: 0 },
        { distance: '3K 걷기', hours: 2, minutes: 0 },
      ],
      expectedParticipants: 3000,
      startTime: '09:00',
    },
    raceKit: {
      items: ['티셔츠(KS~3XL, 사전 택배)', '넥슨 게임 캐릭터 반다나(사전 택배)', '퓨어더마 퍼펙트 선크림 80ml(사전 택배)', '배번호·엽서(사전 택배)', '완주 메달(현장)', '푸르메소셜팜 토마토즙(현장)', '파니스 머핀(현장·랜덤)', '뽀로로 과일맛 젤리·홍삼쏙쏙(현장)', '임팩타임 에너지젤(현장)'],
      pending: '현장 기념품은 당일 참가자에게만 지급되며 불참 시 배송되지 않음. 행운권 추첨(갤럭시 워치9 44mm 1·르망고 데블백 4·미러박스 10 등)과 넥슨 베스트 드레서 시상은 현장 이벤트.',
      verifiedAt: '2026-09-03',
    },
    logistics: {
      parking: '대회장 안내 페이지 "준비 중"(2026-09-03 확인) — 교통·주차 미게시',
      bagStorage: true,
    },
  },
  {
