...
export const novemberEvents: MarathonEvent[] = [
  ...
  },
  {
    ...
    registrationNote:
      '9월 1일(화) 10시 접수 시작 — 마감일 없이 선착순. 얼리버드 65,000원은 서울신문 회원 선착순 3,000명 한정이고 신청 화면에서 서울신문 ID를 입력해야 적용되므로, 회원가입은 접수 전날까지 끝내두는 편이 안전합니다(공식 대회요강 2026-08-31 확인)',
    lastVerified: '2026-08-31',
    description:
  ...
  },
  {
    ...
    courseInfo: {
      ...
      difficulty: '중급',
      courseDescription:
        '풀코스만 영종구 운서역 일원에서 출발해 인천아시아드주경기장에서 끝나는 편도 코스입니다 — 왕복이 아니라 섬에서 출발해 육지로 들어오는 구조라, 출발지까지 이동을 따로 계획해야 하고 짐도 도착지로 옮겨야 합니다. 10km와 5km는 주경기장에서 출발해 주경기장으로 돌아옵니다. 영종과 도착지인 서구를 잇는 육로가 영종대교뿐이고 공식 슬로건이 "청라의 하늘 길을 달리다"인 점을 보면 대교 통과가 유력하지만, 코스도는 공식 준비중이라 경로·고저·급수는 아직 확정된 게 없습니다(공식 대회소개 2026-08-31 확인). 11월 하순 개최라 바다를 낀 구간의 바람과 체감온도가 변수입니다.',
    },
    raceInfo: {
      entryFees: [
