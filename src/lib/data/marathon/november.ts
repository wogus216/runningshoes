...
export const novemberEvents: MarathonEvent[] = [
  ...
  },
  {
    ...
    description:
      '1936 베를린올림픽 금메달리스트 손기정 선생을 기리는 평화·통일 테마 대회(2005년 제1회, 2026년 제22회). 2026년 대회일은 11월 15일(일) 확정, 대회장은 고양 제2자유로에서 임진각(파주)으로 이전합니다(공식 대회요강 2026-07 확인 — "임진각~개성 남북평화마라톤으로 발전하는 출발점" 구상). 종목은 6km가 신설돼 4개가 됐고 참가비는 전 종목 1만원 인상(풀 7만·하프 6.5만·10K 6만·6K 5만). 접수기간은 "8월 중 공지 예정"(2025년엔 9/13 오픈 후 약 2만 명 일주일 내 조기 마감). 코스 상세는 공식 준비중 — 2025년까지의 제2자유로 코스와 달라질 수 있습니다.',
    courseInfo: {
      terrain: '평지',
      difficulty: '중급',
      courseDescription:
