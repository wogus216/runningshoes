...
export const octoberEvents: MarathonEvent[] = [
  {
    id: 'heart-run-2026',
    name: '2026 하트런 (하트-하트재단 시각장애아동 기부런)',
    date: '2026-10-10',
    month: '10월',
    location: '올림픽공원 피크닉장 (서울 송파구)',
    region: '서울',
    distances: ['10K', '5K'],
    status: '접수중',
    isMajor: false,
    website: 'https://heartrun.co.kr/',
    registrationStart: '2026-08-24',
    registrationEnd: '2026-09-17',
    registrationNote:
      '1차 접수 8월 24일(월) 10시 ~ 9월 17일(목) 23:59, 2차 접수 9월 21일(월) 13시 ~ 9월 25일(금) 23:59 — 공식 공지 「참가 신청 안내」 기준. 요강 페이지에는 "8/24~9/18(금) 선착순 마감"으로 적혀 있어 하루 차이가 나며, 이 사이트는 이른 쪽(9/17 23:59)을 따랐습니다. 종목별 선착순 1,000명, ID당 1매. 버추얼런(4만원·500명·10/1~31 인증)은 9월 3일 확인 시 참가신청 상품이 품절 표시였습니다.',
    lastVerified: '2026-09-03',
    description:
      '1988년부터 활동해 온 사회복지법인 하트-하트재단이 여는 시각장애아동 기부 마라톤입니다. 참가비는 캄보디아·방글라데시 등 해외 실명예방(백내장 수술·검진)과 국내 점자촉각도서 제작·배포에 쓰이지만, 기념품이 제공되는 행사라 기부금 영수증은 발급되지 않습니다. 10km·5km 모두 참가비 50,000원에 종목별 정원 1,000명 선착순이고, 신청 화면에서 "뛰어서"와 "걸어서"를 종목마다 따로 고르게 돼 있어 걷기 참가를 공식 옵션으로 둔 대회입니다. 다만 코스 운영은 12시까지라 10km는 A그룹 10:20 출발 기준 1시간 40분 안에 들어와야 합니다. 기록은 배번호 기록칩 넷타임으로 측정되며 대회 후 홈페이지에서 확인합니다. 접수는 1차(8/24~9/17)와 2차(9/21 13시~9/25) 두 번 열리고, 취소·환불은 각각 9/18·9/28 23:59까지만 가능합니다. ID당 1매만 신청할 수 있어 일행은 각자 계정으로 신청해야 하고, 만 14세 미만은 부모 이메일로 별도 가입해 수령자 이름에 아동 정보를 적습니다. 개인 참가는 연령 제한이 없지만 만 18세 미만은 성인 보호자 동반이 필수이고, 미취학 아동은 신청 없이 동반 가능하며 유아차 주행도 허용됩니다. 기념품은 사전 배송 없이 대회 당일 9시부터 현장 수령이며, 집결은 9시 30분까지, 10시 개회식·스트레칭 후 10km A그룹 10:20·B그룹 10:25, 5km C그룹 10:30·D그룹 10:35 순으로 출발합니다. 코스는 피크닉장에서 출발해 서울올림픽기념관·평화의 광장·88마당·서울역사편찬원·서울백제어린이박물관을 지나 돌아오는 공원 내부 순환으로 5km는 1바퀴, 10km는 같은 코스를 2바퀴 돕니다. 12시부터 미니콘서트, 12시 30분부터 럭키드로우가 이어집니다. 주최 하트-하트재단, 주관 빅워크, 후원 국민체육진흥공단.',
    courseInfo: {
      terrain: '평지',
      difficulty: '초보자',
      courseDescription:
        '피크닉장(출발) → 서울올림픽기념관 → 몽촌호 인근 평화의 광장 → 88마당 → 서울역사편찬원 → 서울백제어린이박물관 → 피크닉장(도착). 5km는 이 순환을 1회, 10km는 같은 코스를 2회 반복합니다. 공식은 코스를 이미지로만 공개했고 고도·급수대 정보는 없습니다. 운영 상황에 따라 코스가 변동될 수 있다고 고지했습니다.',
      isLoopCourse: true,
    },
    raceInfo: {
      entryFees: [
    ...
    raceKit: {
      items: ['티셔츠(85~110 6사이즈)', '배번호·기록칩', '완주 메달', '스티커', '클라뷰 비건 징크 선크림', '우르오스 페이스워시', '동아오츠카 음료 2종', '퍼니트 링포유', '비소리 온열안대', '크라운제과 롱스·마이쮸', '해태제과 구운감자'],
      pending:
        '완주 기념품에 "추가 상품(미정)"이 남아 있고, 럭키드로우(볼티움 에어코어 3·매트릭스러닝 선글라스 40·스포벨 러닝벨트 20·컴포트 러닝양말 30·에버힐 아이싱젤 20)도 주최 측 사정에 따라 변동될 수 있다고 고지. 사전 배송 없이 대회 당일 9시부터 현장 수령이며 당일 참가자에게만 지급.',
      verifiedAt: '2026-09-03',
    },
    logistics: {
      parking: '공식 안내: "주차 장소가 협소하오니 가급적 대중교통을 이용해 주시기 바랍니다"',
      bagStorage: true,
    },
  },
  {
    ...
    description:
      '주최사 스탠즈(@stanz_official_kr)가 여는 공식 라이선스 이벤트로, 호그와트 네 기숙사로 나뉘어 달립니다. 5km 비경쟁·비기록 종목 하나만 운영합니다. 오전 9시·오후 2시 두 차례로 나눠 각 3,000명씩 총 6,000명을 모집하며 코스는 두 회차가 같습니다. 티켓은 9월 4일 11시부터 카카오톡 선물하기에서 선착순으로 팔았고 1인 4매까지 살 수 있었는데, 서류상 마감일(9월 18일)보다 훨씬 이르게 매진됐습니다 — 주최사 공식 인스타그램의 매진 공지가 같은 날 11시 38분에 올라왔으니 실제 소진은 그보다 이릅니다(주최사는 정확한 매진 시각을 밝히지 않았습니다). 공지는 매진과 함께 "취소표 및 추가 티켓"을 추후 안내하겠다고 밝혔고 추가분 창구도 카카오톡 선물하기라고 예고했습니다. 재판매 목적의 참가권 양도가 확인되면 티켓을 사전 예고 없이 취소한다는 경고도 함께 붙었습니다. 9월 7일 14시부터 Trip.com에서 파는 글로벌 티켓은 외국인 전용이라 국내 러너는 대상이 아닙니다. 참가 기념품 중 기숙사가 갈리는 품목(스포츠타올·배번호)은 고를 수 없고 랜덤 배정입니다 — 원하는 기숙사를 받는다는 보장이 없습니다. 러닝 외에 무대 프로그램과 부스 체험이 함께 열립니다.',
    courseInfo: {
      terrain: '평지',
      difficulty: '초보자',
      certification: '없음',
      courseDescription:
        '부산 북항친수공원 부근에서 열리는 5km 비경쟁·비기록 코스. 오전·오후 회차의 코스가 동일하며, 세부 구간과 출발 지점은 공개되지 않았습니다. 장소는 주최사 공식 인스타그램이 2026년 9월 4일 게시물에서 "부산 북항친수공원 부근"으로 밝힌 것으로, 그 전까지 안내되던 "부산역 인근"보다 구체화된 표기입니다.',
    },
    raceInfo: {
    ...
    registrationNote:
      '매진됐습니다 — 9월 4일(금) 11시 카카오톡 선물하기에서 판매를 시작해 서류상 마감(9월 18일)보다 훨씬 이르게 정원 6,000명이 소진됐습니다(주최사 공식 인스타 매진 공지, 정확한 매진 시각은 미고지). 추가 티켓·취소표는 "일정 추후공지"로만 안내돼 있고 카카오톡 선물하기에서 다시 연다고 예고됐습니다. 9월 7일(월) 14시부터 Trip.com에서 파는 글로벌 티켓은 외국인 전용이라 국내 러너는 대상이 아닙니다. 기념품 KIT는 9월 중순부터 주문 시 입력한 주소로 순차 배송되며 배송비는 없습니다.',
  ...
  },
  {
    ...
    registrationNote:
      '두 차례 접수가 모두 개시 4분 만에 끝났습니다 — 구민 300명은 9월 1일 10시 04분, 일반 500명은 9월 7일 10시 04분에 마감됐고 공식 게시판에 각각 마감 공지가 올라와 있습니다. 서류상 마감일은 9월 11일 17시였지만 실제로는 나흘 일찍 끝난 셈입니다. 환불 마감은 배번칩 제작 때문에 9월 30일에서 9월 23일 18시로 앞당겨졌습니다(9월 6일 공지).',
    lastVerified: '2026-09-07',
  },
  {
  ...
  },
  {
    ...
    registrationNote: '접수 마감 — 2026-09-04 공식 페이지에 "구매 기간 종료" 표시 확인',
  ...
  },
  {
    ...
    registrationNote:
      '추가 참가신청이 두 종목 모두 선착순 마감됐습니다 — 풀코스는 9월 8일(화) 14시에 열려 사무국이 같은 날 14시 02분에 마감 공지를 올렸고, 10km는 9월 9일(수) 14시에 열려 14시 10분에 마감 공지가 올라왔습니다(공지 게시 시각 기준이라 실제 소진은 그보다 이릅니다). 남은 일정은 결제뿐입니다 — 9월 10일(목) 오전 10시~오후 6시 단 하루이고, 홈페이지 참가신청 > 신청확인/결제에서 진행하며 이 기간 이후에는 어떤 경우에도 결제가 불가합니다. 결제를 마친 신청자만 공식 참가자로 인정됩니다. 조선일보 구독자는 결제 기간에 구독자 인증을 하면 참가비가 10% 할인됩니다(본인만 가능). 취소·환불·개인정보 변경은 9월 23일(수) 18시까지만 가능합니다.',
    description:
      '"가을의 전설" — 1946년 창설돼 2026년 창설 80주년(제80회)을 맞는 가을 풀코스 명문. 의암호 국제공인 순환코스, 25km 지점 오르막이 핵심 변수. 대회일 10/25(일) 9시, 집결지 춘천 공지천 인조잔디구장. 참가비 풀 15만원·10K 10만원, 제한시간 풀 5시간 30분·10km 1시간 30분. 참가 자격은 풀코스 만 18세 이상, 10km는 누구나입니다. 7월에 끝났던 본접수(명예의전당·얼리버드·5~8회 완주자·일반 5단계) 이후 미결제분과 취소분으로 열렸던 추가 참가신청은 두 종목 모두 선착순 마감됐습니다 — 풀코스는 9월 8일 14시 개시 후 같은 날 14시 02분에, 10km는 9월 9일 14시 개시 후 14시 10분에 사무국 마감 공지가 올라왔습니다. 남은 일정은 결제 하루뿐입니다: 9월 10일(목) 오전 10시~오후 6시, 이 시각을 넘기면 어떤 경우에도 결제가 불가하고 결제를 마친 신청자만 공식 참가자로 인정됩니다. 조선일보 구독자는 결제 시 구독자 인증으로 10% 할인을 받습니다. 취소·환불·개인정보 변경은 9월 23일(수) 18시까지입니다. 출발그룹은 8월 25일자로 1차 배정이 끝났고, 2차 기록증 제출·정정 기간이 9월 15일(화) 오전 10시~9월 16일(수) 오후 6시로 예정돼 있습니다 — 이 기간 이후에는 제출이 불가하며 10월 초에 최종 그룹이 확정됩니다. 기록증을 내지 않은 참가자는 신청 순서대로 후미 그룹에 배정되지만 참가에는 문제가 없고, 춘천마라톤 풀·10km 기록과 서울하프마라톤 10km 기록은 자동 반영됩니다.',
    courseInfo: {
      terrain: '언덕',
      difficulty: '상급',
      certification: 'IAAF',
  ...
  },
  {
    ...
    registrationNote: '9월 1일(화) 오전 10시 롯데백화점몰 선착순 — 정원 7,000명이 당일 매진(2026-09-02 확인). 2025년(6,000명)도 사전 접수 5시간 만에 매진됐던 대회. 취소분 추가 접수는 작년엔 한 차례 있었으나 올해는 미공지',
  ...
  },
  {
    ...
    raceInfo: {
      entryFees: [
        { distance: '10K', fee: 80000 },
        { distance: '5K', fee: 70000 },
      ],
    },
    raceKit: {
      items: ['티셔츠', '반다나', '배번호', '양말', '스트링백'],
      pending:
        '완주자에게는 완주메달·리유저블백이 추가로 제공되며, "추가 굿즈 업데이트 예정"이라고만 고지돼 있어 최종 구성은 미확정입니다. 코스·출발 시각별 그룹 편성도 아직 공개되지 않았습니다.',
