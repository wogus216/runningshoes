...
export const octoberEvents: MarathonEvent[] = [
  {
    ...
    registrationNote:
      '최종 마감은 2차 접수 종료일(9/25) 기준 — 2026-09-18 공식 홈 "8. 24.(월) ~ 9. 18.(금) 선착순 마감" 표기 재확인. 1차 접수 8월 24일(월) 10시 ~ 9월 17일(목) 23:59, 2차 접수 9월 21일(월) 13시 ~ 9월 25일(금) 23:59 — 공식 공지 「참가 신청 안내」 기준. 요강 페이지에는 "8/24~9/18(금) 선착순 마감"으로 적혀 있어 하루 차이가 나며, 이 사이트는 이른 쪽(9/17 23:59)을 따랐습니다. 종목별 선착순 1,000명, ID당 1매. 버추얼런(4만원·500명·10/1~31 인증)은 9월 3일 확인 시 참가신청 상품이 품절 표시였습니다.',
  ...
  },
  {
    ...
    registrationNote:
      '공식 홈이 아직 2026년 요강을 게시하지 않음 — 접수 일정 불명 (2026-09-16 재확인, 8월 27일과 동일). 공지 게시판 최신 글이 2025년 10월 24일(전년도 대회 스케치)이고, 그 위에 올라온 2026년 9월 날짜 글들은 전부 대출·보험 스팸이라 관리가 멈춘 상태로 보입니다. 대회일(10월 18일)이 한 달 앞인데 요강이 없으므로, DB의 날짜·종목도 전년도 기준 추정일 수 있습니다.',
  ...
  {
    id: 'daejeon-bbangbbang-run-2026',
    name: '대전 빵빵런 2026',
    date: '2026-10-09',
    month: '10월',
    ...
    registrationNote:
      '전 코스 품절 — 7/2 5K·10K 매진 공지, 2026-09-18 공식 판매 페이지에서 하프·10K·5K 참가권과 9/9 취소표 모두 판매 종료 확인',
    lastVerified: '2026-09-18',
    description:
      '대전 빵집들의 빵을 완주 보상으로 주는 러닝 대회로, 10월 9일(금·한글날)과 10일(토) 이틀 중 하루를 골라 참가합니다(행사 07:00~12:00). 주최·주관은 1986프로덕션, 후원은 대전관광공사이며, 2025년 5K·10K 두 종목에서 올해 하프가 추가됐습니다. 참가비는 하프 69,000원·10K·5K 59,000원이었고 6월 30일 정오에 열린 접수는 7월 2일 5K·10K가 매진됐으며, 9월 9일 풀린 취소표까지 끝나 현재 전 코스 품절입니다. 출발은 하프 07:30 일괄, 10K 07:40~07:55·5K 08:40~08:55(A~D 그룹 5분 간격)이고, 세 코스 모두 행사장에서 엑스포다리·둔산대교를 지나 반환하는 왕복 코스입니다(하프는 봉산LH3단지 부근, 10K는 대우엑스포아파트 부근, 5K는 카이스트교 반환). 제한시간은 하프 3시간, 10K·5K 1시간 30분이며 넷타임 기록칩이 전 코스에 지급됩니다. 빵가방에는 성심당 튀김소보로를 비롯한 대전 빵집 5곳의 빵이 한 개씩 들어갑니다. 우천 시에도 진행하고, 서울 잠실종합운동장역 왕복 셔틀(35,000원, 참가권 구매자 한정)이 운영됩니다.',
    raceInfo: {
      entryFees: [
        { distance: '하프', fee: 69000 },
    ...
    raceKit: {
      items: [
        ...
        '배번호표·기록칩',
        '완주메달',
        '빵가방 — 성심당 튀김소보로 · 하레하레 마시멜로 속 갸또 · 몽심 밀키연유 마들렌 · 소금빵(점선면·ㅅㄱㅃ·비머스트 중) · 삼정수제강정 귤모찌 각 1개',
        '풍년제과 우리밀 저당 초코파이 · 빙그레 아이스크림(3종 중 랜덤) · 베러블 카페인 스틱 · 백산수 500ml · 링티 500ml',
      ],
      pending: '티셔츠·배번은 9/29(화)부터 순차 택배, 메달과 빵가방은 당일 현장 수령(기념품 08:30~, 빵 09:00~)',
      verifiedAt: '2026-09-18',
    },
    logistics: {
      parking: '행사장 주차 공간이 협소해 공식은 대중교통 이용을 권장',
      publicTransport:
        '버스 911(예술의전당 정문) · 606(평송청소년문화센터) · 104·604·301·705·918(서구보건소) / 지하철 정부청사역 3번 출구 도보 약 20분',
      shuttle:
        '서울 잠실종합운동장역 왕복 셔틀 35,000원(참가권 구매자만) — 05:10·06:00 출발, 행사장 13:00 복귀. 공식은 06:00편이 하프·10K 출발 시각을 맞추기 어려울 수 있다고 안내',
      bagStorage: true,
    },
  },
  {
    id: 'smtown-run-club-2026',
    name: 'SMTOWN RUN CLUB 26',
    date: '2026-10-03',
    month: '10월',
    location: '왕산마리나항 (인천 중구 영종도)',
    region: '인천',
    distances: ['10K'],
    status: '마감',
    isMajor: false,
    website: 'https://smtownrunclub.com',
    registrationStart: '2026-08-06',
    registrationEnd: '2026-09-10',
    registrationNote:
      '1차(8/6~8/13 KREAM 선착순) 매진, 2차(8/18 18시~9/10, 추가 확보 수량) 판매 종료 — 2026-09-18 KREAM 상품 페이지 확인. 양도·재판매 불가',
    lastVerified: '2026-09-18',
    description:
      'SM엔터테인먼트가 여는 러닝 페스티벌로, 10월 3일(토·개천절) 인천 영종도 왕산마리나항에서 10K 단일 종목으로 열립니다(만 15세 이상, 참가비 89,000원). 접수는 KREAM(해외는 Melon Ticket Global)에서 1인 1매 본인 명의로 받았고, 8월 6일 1차가 매진된 뒤 추가 확보 수량으로 연 2차(8/18~9/10)까지 끝났습니다. 티켓 양도·증여·재판매는 금지이며 타인 배번 사용 시 실격입니다. 07:30 행사장 오픈, 10:00~10:30 A~F 그룹 순차 출발(그룹은 무작위 배정), 12:35 레이스 종료이고 제한시간은 2시간입니다. 코스는 왕산마리나항에서 용유로를 지나 영종해안북로에서 반환하는 왕복 10km로 급수대는 3km·7.5km 두 곳입니다. 샤이니 민호·동방신기 최강창민·소녀시대 유리·엑소 수호·WayV 멤버 4명·배우 조준영 등 9명이 함께 달리고, 15:30부터 약 60분간 WayV·민호·하츠투하츠가 공연합니다(전 구역 스탠딩, 배번호표 소지자만 그룹 순서대로 입장). 행사장·인근은 주차가 불가해 무료 셔틀(영종역·운서역·공항화물청사역·인천공항 T2)이나 카카오T 유료 셔틀 이용을 권장합니다.',
    raceInfo: {
      entryFees: [{ distance: '10K', fee: 89000 }],
      timeLimits: [{ distance: '10K', hours: 2, minutes: 0 }],
      aidStations: 2,
      startTime: '10:00',
    },
    raceKit: {
      items: [
        ...
        '러닝 짐색',
        '배번호표(기록칩 부착)',
        '뷰티·보급품 — 제로이드 마스크팩 · 우르오스 페이스워시 100g · 토코보 미니 선스틱 · 스포식스 부스터 젤 60g · 리바이탈 드링크 100ml · 플비아 초콜릿 · 리플렛·스티커팩',
        '완주메달(뒷면 "FINISHER 10K 2026.10.03")',
      ],
      pending: '클럽 키트는 국내 참가자에게 대회 전 택배 발송(발송일 미공지), 해외 참가자는 당일 현장 수령',
      verifiedAt: '2026-09-18',
    },
    logistics: {
      parking: '행사장과 인근 주차 불가 — 공식은 영종역·운서역·을왕리 쪽 공영주차장 이용을 권장',
      publicTransport: '공항철도 영종역·운서역·공항화물청사역에서 무료 셔틀 연계',
      shuttle:
        '무료 셔틀(예약 없음, 입석 불가) 행사장행 07:30~09:00 · 귀가 16:30~18:00 — 영종역 2번 출구, 운서역 1번 출구 건너편(하워드존슨호텔 정류장), 공항화물청사역 2번 출구, 인천공항 T2 1층 단체버스 승강장 6A·7A. 카카오T 유료 셔틀은 서울 8곳·경기 6곳·부산·대구·대전·광주 등에서 운행',
      bagStorage: true,
    },
  },
  {
    id: 'marvel-run-korea-2026',
    name: '2026 마블런 코리아 (MARVEL RUN KOREA)',
    date: '2026-10-31',
    month: '10월',
    location: '인제스피디움 (강원 인제군 기린면 상하답로 130)',
    region: '강원',
    distances: ['10K', '5K'],
    status: '접수예정',
    isMajor: false,
    website: 'https://marvelrunkorea2026.com/',
    registrationStart: '2026-09-22',
    registrationNote:
      '접수는 **2026년 9월 22일(화) 오후 2시**에 열립니다 — 공식 홈페이지 카운트다운과 공지사항 「참가 접수 오픈 안내」 기준(2026-09-21 확인). **정원과 선착순 여부는 공식 미고지**라 조기 마감 가능성을 예측할 수 없습니다. 접수처는 공식 홈페이지 한 곳이고, 단체접수·참가정보 변경·환불 안내가 공지사항에 따로 올라와 있습니다. 10km는 **만 12세 이하 참가 불가**이며, 5km·2.3km에는 어린이 참가비(40,000원)가 따로 있습니다.',
    lastVerified: '2026-09-21',
    description:
      '마블 히어로를 테마로 인제스피디움 **서킷**을 달리는 러닝 이벤트입니다. 자동차 경주 트랙을 러닝 코스로 여는 것이 이 대회의 핵심이라, 일반 도로 대회와 노면·동선이 다릅니다. 종목은 10km 풀 서킷(출발 13:30, 70,000원), 5km 액션 코스(14:00, 70,000원·어린이 40,000원), 2.3km 패밀리 코스(14:30, 55,000원·어린이 40,000원) 세 가지이고 버추얼런이 별도로 운영됩니다. 이 사이트의 종목 표기는 러닝 종목인 10km·5km만 담았습니다 — 2.3km 패밀리 코스는 참가비 항목과 이 설명에 남겨 뒀습니다. 코스는 연말 개봉하는 <어벤져스: 둠스데이>와 닥터 둠·캡틴 아메리카·토르 등 캐릭터를 테마로 꾸며지고 마블 영화 OST가 함께 나옵니다. 2016년 첫 개최 이후 매회 1만 명 이상이 참가했다고 주최 측이 밝혔습니다(문화일보 2026-09-17). 주최는 원유니버스스튜디오, 주관은 플럭스소닉(FLUX SONIC)이며 마블 IP는 월트디즈니 컴퍼니 코리아가 맡습니다. **정원·제한시간·급수대·기념품 구성·셔틀 운영은 2026-09-21 기준 공식 미게시**입니다(기념품 메뉴는 열려 있으나 품목이 아직 없습니다). 운영사무국은 서울 마포구 동교로18길 41 4층, 02-338-0344입니다.',
    raceInfo: {
      entryFees: [
        { distance: '10K', fee: 70000 },
        { distance: '5K', fee: 70000 },
        { distance: '5K 어린이', fee: 40000 },
        { distance: '2.3K 패밀리', fee: 55000 },
        { distance: '2.3K 패밀리 어린이', fee: 40000 },
      ],
      startTime: '13:30',
    },
  },
