...
export const octoberEvents: MarathonEvent[] = [
  ...
  },
  {
    ...
    description:
      '주최사 스탠즈(@stanz_official_kr)가 여는 공식 라이선스 이벤트로, 호그와트 네 기숙사로 나뉘어 달립니다. 5km 비경쟁·비기록 종목 하나만 운영합니다. 오전 9시·오후 2시 두 차례로 나눠 각 3,000명씩 총 6,000명을 모집하며 코스는 두 회차가 같습니다. 티켓은 9월 4일 11시부터 카카오톡 선물하기에서 선착순으로 팔았고 1인 4매까지 살 수 있었는데, 서류상 마감일(9월 18일)보다 훨씬 이르게 매진됐습니다 — 주최사 공식 인스타그램이 매진과 함께 "추가 티켓 오픈 일정 추후공지"를 알렸고 추가분도 카카오톡 선물하기에서 판다고 예고했습니다(정확한 매진 시각은 미고지). 9월 7일 14시부터 Trip.com에서 파는 글로벌 티켓은 외국인 전용이라 국내 러너는 대상이 아닙니다. 참가 기념품 중 기숙사가 갈리는 품목(스포츠타올·배번호)은 고를 수 없고 랜덤 배정입니다 — 원하는 기숙사를 받는다는 보장이 없습니다. 러닝 외에 무대 프로그램과 부스 체험이 함께 열립니다.',
    courseInfo: {
      terrain: '평지',
      difficulty: '초보자',
      certification: '없음',
