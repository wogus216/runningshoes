...
export const octoberEvents: MarathonEvent[] = [
  ...
  },
  {
    ...
    registrationNote:
      '공식 홈페이지에서 2026년 9월 22일(화) 오후 2시 접수가 열린 것을 확인했습니다(2026-09-23 확인). 접수 페이지가 열려 있어 현재 접수중으로 표시합니다. 공식 홈페이지는 정원·선착순 여부와 마감일을 별도로 고지하지 않았습니다. 10km는 만 12세 이하 참가 불가이며, 5km·2.3km에는 어린이 참가비가 따로 있습니다.',
