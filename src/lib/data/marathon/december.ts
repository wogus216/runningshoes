...
export const decemberEvents: MarathonEvent[] = [
  {
    ...
    description:
      '부산시·KNN·대한육상연맹이 주최하는 연말 대표 대회로, 구 부산국제마라톤이 부산브릿지마라톤으로 명칭을 바꿔 여는 첫 대회입니다. 광안대교·부산항대교·남항대교 3개 해상 교량을 모두 통과하는 국내 최초 트리플 브릿지 풀코스가 핵심이고, 종목은 풀코스와 10km 두 가지이며 하프는 없습니다. 정원 12,000명(풀 5,000·10km 7,000) 선착순으로 8월 24일(월) 오전 10시 접수를 열었고, 선착순 조기 마감됐습니다(공식 홈 안내, 2026-08-27 확인). 풀코스는 만 18세 이상 + 공식 기록증 기준 4시간 29분 59초 이내 완주 기록이 있어야 신청할 수 있었습니다 — 인정 범위는 2023년 10월 1일~2026년 10월 8일에 발급된 풀코스 기록증뿐이라 하프·10km 기록으로는 대체되지 않고, YES24 참가신청서로 제출하지 않으면 접수·결제가 자동 취소됩니다(공식 공지 2026-08-25). 제한시간은 풀 5시간·10km 1시간 30분(4시간 30분은 접수 자격 기준이며 당일 제한시간이 아닙니다). 풀코스는 07:30 출발.',
    courseInfo: {
      terrain: '혼합',
      difficulty: '중급',
      courseDescription:
  ...
  },
  {
    ...
    description:
      '⚠️ 개최 취소된 대회입니다(공식 공지 2026-08-03). 같은 날짜(12/5~6)에 "금산 국제 마라톤"이 열리게 되면서 취소됐고, 골드런 신청자에게는 후속 대회 우선 참가권이 부여됩니다. 참가비 환불은 공식 페이지 신청조회에서 가능하며, 기념품 마라톤화 수령자는 별도 환불 절차를 따릅니다. 후속 대회는 사바스티안 사웨(2026년 4월 런던마라톤 서브2 세계기록 보유자)가 참가하는 「2026 월드 레코드 인터내셔널 마라톤 페스티벌」로 확정됐습니다(`geumsan-world-record-marathon-festival-2026` 참고, 2026-09-11 확인).',
  ...
  {
    id: 'geumsan-world-record-marathon-festival-2026',
    name: '2026 월드 레코드 인터내셔널 마라톤 페스티벌',
    date: '2026-12-05',
    month: '12월',
    location: '금산세계인삼엑스포광장 (충남 금산군)',
    region: '충남',
    distances: ['10K'],
    status: '접수중',
    isMajor: false,
    website: 'https://mara1080.com/event/ccf77de8-1b14-4170-afcb-c2eeaee1a78d',
    description:
      '사바스티안 사웨(Sabastian Sawe, 케냐)가 참가하는 국제 마라톤 축제. 사웨는 2026년 4월 26일 런던마라톤에서 1시간 59분 30초로 인류 최초 공식 서브2(마라톤 2시간 벽 돌파) 기록을 세운 선수입니다(다수 외신 확인). 12월 5일·6일 이틀간 열리며 참가자는 하루를 선택해 달리고, 하루 모집 인원은 1만2,000명씩 이틀 합계 2만4,000명입니다. 사웨는 대회 다음 날(12/7) 국내 러너 대상 팬미팅도 예정돼 있습니다. 원래 이 날짜·장소에는 「금산 골드런 마라톤」이 예정돼 있었으나 이 대회로 대체되며 2026-08-03 취소됐습니다(`geumsan-goldrun-marathon-2026` 참고). 참가비는 공식 신청 절차(약관 동의 이후 단계)에서만 확인 가능해 이 페이지에는 미기재합니다 — 접수 전 공식 홈페이지에서 직접 확인하세요.',
    registrationStart: '2026-09-08',
    registrationNote: '이틀 각 1만2,000명 한도 — 접수 마감일은 공식 공지에 없음(선착순 여부도 명시 확인 안 됨)',
    lastVerified: '2026-09-11',
    raceInfo: {
      expectedParticipants: 24000,
      startTime: '10:00',
    },
  },
];
