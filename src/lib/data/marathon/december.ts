...
export const decemberEvents: MarathonEvent[] = [
  {
    ...
    description:
      '부산시·KNN·대한육상연맹이 주최하는 연말 대표 대회로, 구 부산국제마라톤이 부산브릿지마라톤으로 명칭을 바꿔 여는 첫 대회입니다. 광안대교·부산항대교·남항대교 3개 해상 교량을 모두 통과하는 국내 최초 트리플 브릿지 풀코스가 핵심이고, 종목은 풀코스와 10km 두 가지이며 하프는 없습니다. 정원 12,000명(풀 5,000·10km 7,000) 선착순으로 8월 24일(월) 오전 10시 접수를 열었고, **선착순 조기 마감됐습니다**(공식 홈 안내, 2026-08-27 확인). 풀코스는 만 18세 이상 + 다른 대회 공식기록증 기준 4시간 30분 이내 완주 기록이 있어야 신청할 수 있었습니다. 제한시간은 풀 5시간·10km 1시간 30분(4시간 30분은 접수 자격 기준이며 당일 제한시간이 아닙니다). 풀코스는 07:30 출발.',
    courseInfo: {
      terrain: '혼합',
      difficulty: '중급',
      courseDescription:
        '풀코스는 광안대교·부산항대교·남항대교 3개 해상 교량을 모두 건너는 트리플 브릿지 코스로, 공식 홈에 코스도와 고저도·경사 분석 그래프가 게시돼 있습니다. 교량 진출입 경사 구간이 반복돼 평지 PB 코스보다는 기복 대응이 필요한 코스입니다. 10K는 벡스코 출발 → 광안대교 상판 → 광안리 해변 산책로 피니시. 급수 배치와 풀코스 출발·피니시 지점은 미게시입니다(2026-08-27 공식 코스 페이지 확인).',
    },
    raceInfo: {
      entryFees: [
