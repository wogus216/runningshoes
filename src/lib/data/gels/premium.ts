...
export const premiumGels: Gel[] = [
  ...
  },
  {
    ...
    reviews: [
      {
        userType: '예상 적합 — 100km급 울트라의 대용량 보급',
        text: '섭취 횟수를 최소화해야 하는 초장거리에 맞춘 대용량 제품입니다. 서빙당 탄수화물 50g·200kcal이라 6개로 300g을 확보할 수 있어, 일반 젤로 12개를 먹어야 할 양을 절반으로 줄입니다. Cluster Dextrin 기반이라 대용량인데도 위 배출이 빠른 편이지만, 물 300ml 정도를 함께 마시는 것을 전제로 계획해야 합니다. 76g 패킷이라 러닝 조끼에 6개를 넣으면 무게가 실질적으로 느껴집니다. 개당 7,000원(벌크 5,500원)으로 가격은 최상단입니다.',
      },
      {
        userType: '적합성 한계 — 풀코스 이하에는 과한 용량',
        text: '풀코스 이하 거리에서는 용량이 과합니다. 76g 패킷이라 달리면서 한 번에 짜먹기 어렵고, 물 300ml를 함께 마셔야 해서 급수대 타이밍에 종속됩니다. 4시간 안팎의 풀코스라면 30분 간격으로 소용량 젤(32g·100kcal)을 나눠 먹는 편이 위장 부담과 휴대 모두에서 유리합니다. 서빙당 탄수화물 50g이라는 장점은 섭취 횟수를 크게 줄여야 하는 울트라나 사이클 종목에서 살아납니다.',
      },
      {
