...
<p>서울마라톤 공식 계정은 <strong>2030년을 '제100회'</strong>로 안내하며 동마칩(기록 측정 칩)과 동마클럽(공식 접수 플랫폼) 시스템을 알리기 시작했습니다. 1931년 제1회부터 회차로 세면 2030년이 제100회에 해당합니다. 중단과 공백, 개최지 이동을 모두 견디고 한 세기를 채우는 마라톤은 세계적으로도 흔치 않습니다.</p>
...
<p>그 밖에 9/5 철원DMZ평화마라톤, 9/5 순천만울트라(100km), 9/20 가평자라섬 등 지역·테마 대회가 가을 문을 엽니다.</p>
