...
`,
  },
  {
    ...
    title: '임진각으로 옮겨 달린다 — 2026 손기정평화마라톤 확정 | 11월 15일, 접수는 8월 공지·6km 신설·참가비 총정리',
    description:
      '2026 손기정평화마라톤(손기정 마라톤)이 확정됐습니다 — 11월 15일(일) 오전 9시 30분 출발, 대회장은 고양 제2자유로에서 임진각(파주)으로 이전. 6km 종목이 신설돼 4개 종목이 됐고 참가비는 전 종목 1만원 인상(풀 7만·하프 6.5만·10K 6만·6K 5만)됐습니다. 접수기간은 8월 중 공지 예정 — 2025년엔 9/13 오픈 후 약 2만 명이 일주일 만에 마감된 광클 대회라, 미리 준비할 것까지 정리했습니다.',
    ...
    faqs: [
      ...
      { question: '접수는 언제 시작하나요?', answer: '공식 대회요강 기준 "접수기간은 8월 중 공지 예정"입니다. 참고로 2025년에는 9월 13일 오후 4시에 열려 약 2만 명 정원이 일주일 안에 조기 마감됐습니다. 선착순 대회이니 공지가 뜨면 바로 신청하는 게 안전하고, 접수 후 24시간 내 미결제 시 신청이 자동 삭제되니 결제까지 한 번에 끝내세요.' },
...
<div class="tldr">
  ...
  <ul>
    ...
    <li><strong>접수기간은 "8월 중 공지 예정"</strong> — 2025년엔 9/13 오픈 후 약 2만 명이 일주일 만에 마감된 광클 대회입니다. 공지 전에 미리 준비하세요(아래 체크리스트).</li>
  </ul>
</div>
...
<div class="callout warning">
  <span class="callout-icon">📢</span>
  <div class="callout-body">
    <p class="callout-title">7/29 갱신 — 2026 대회요강 공식 게시</p>
    <p>이 글은 6월 발행 당시 "2026 일정 미발표" 상태로 작성됐으나, 공식 홈페이지에 <strong>2026 대회요강이 게시되어 확정 정보로 전면 갱신</strong>했습니다. 핵심 변화: ① 대회일 11/15 확정 ② <strong>대회장 임진각 이전</strong> ③ 6km 신설 ④ 참가비 인상 ⑤ 접수기간 8월 중 공지 예정.</p>
  </div>
</div>
...
<h2>접수 — "8월 중 공지", 광클 준비는 지금부터</h2>

<p>손기정평화마라톤의 가장 큰 주의점은 <strong>속도</strong>입니다. 2025년에는 <strong>9월 13일 오후 4시 접수 오픈 → 약 2만 명 정원이 일주일 안에 마감</strong>됐어요. 2026년엔 공식 대회요강이 <strong>"접수기간 8월 중 공지 예정"</strong>이라고 못 박아, 작년보다 한 달가량 빨라질 수 있습니다.</p>

<p><strong>오픈 전 체크리스트</strong>:</p>

<ul>
  <li><strong>레이스플랜 회원가입 미리</strong> — 접수처인 공식 홈페이지(<a href="https://www.sonkeechungrun.com/" target="_blank" rel="noopener">sonkeechungrun.com</a>)는 레이스플랜 계정으로 로그인합니다. 오픈 당일 가입하며 허둥대지 말고 미리 만들어 두세요.</li>
  <li><strong>필수 입력값 준비</strong> — 성명·생년월일·휴대폰·코스·기념품 사이즈·주소를 요구합니다. 기념품 사이즈를 미리 정해두면 광클이 빨라집니다.</li>
...
<div class="callout info">
  <span class="callout-icon">📅</span>
  <div class="callout-body">
    <p class="callout-title">접수 공지가 뜨면 이 글을 갱신합니다</p>
    <p>접수 오픈 일시가 공지되는 대로 이 글과 <a href="/marathon/sonkeechung-peace-marathon-2026">손기정평화마라톤 캘린더 페이지</a>를 갱신할 예정입니다. 공식 확인은 <a href="https://www.sonkeechungrun.com/" target="_blank" rel="noopener">공식 홈페이지</a> 공지사항에서 하세요.</p>
  </div>
</div>
