...
import { MAJOR_DEADLINES, MAJOR_DEADLINES_AS_OF, md } from '../major-deadlines';
...
<div class="faq">
  ...
  <p class="faq-a">A. 권하지 않습니다. 엘리트 3는 빠른 페이스(km당 4:30 이내)와 완성된 폼을 전제로 한 레이스 전용 카본화이고, 200km 내구성에 km당 약 1,845원으로 운용 비용도 높습니다. 서브4 이하라면 <a href="/shoes/saucony-endorphin-speed-5">엔돌핀 스피드 5</a>나 <a href="/shoes/saucony-endorphin-pro-5">프로 5</a>가 현실적입니다. 카본화가 처음이면 <a href="/blog/carbon-plate-running-shoes-lineup-tier-guide-2026">카본 플레이트화 비교 가이드</a>를 먼저 보세요.</p>
...
<p>같은 30만원대 카본 레이서를 함께 보면 SC Elite V5의 자리가 명확해집니다. 카본화가 처음이라면 <a href="/blog/carbon-plate-shoes-guide-2026">카본 플레이트화의 원리</a>부터 보세요.</p>
<ul>
...
<ul>
  ...
  <li><strong>② 카본은 '항상 빠른 신발'이 아닙니다.</strong> 프로·엘리트의 카본 플레이트는 일정 페이스(3:30~4:30/km) 이상에서 진가가 나옵니다. 그보다 느리면 딱딱하기만 하고 오히려 불편할 수 있어요. <a href="/blog/carbon-plate-shoes-guide-2026">카본화의 작동 원리</a>를 이해하고 사세요.</li>
...
`,
  },
  {
    ...
    description:
      '서울 도심 한복판을 달리는 런서울런이 9월 13일 서울광장에서 열립니다. 광화문·종로·흥인지문·숭례문을 잇는 평지 헤리티지 코스에 하프·10K 두 종목. 확정 참가비는 하프 80,000원·10km 70,000원(10km는 작년 대비 1.1만원 인상). 6월 29일 오전 10시부터 정원 12,000명 선착순 접수 중이며, 정원이 차면 마감됩니다. 일시·코스·종목·참가비·기념품을 한 장에 정리했습니다.',
...
<div class="tldr">
  ...
  <ul>
    ...
    <li>확정 참가비 <strong>하프 80,000원 / 10km 70,000원</strong> — 10km가 작년 59,000원에서 <strong>1.1만원 인상</strong></li>
    <li>6월 29일 10시부터 <strong>정원 12,000명 선착순 접수 중</strong>(2025년 참가 15,524명 대비 축소). 고정 마감일 없이 정원이 차면 종료라 서두르는 게 안전</li>
  </ul>
</div>
...
<table>
  ...
  <tbody>
    ...
    <tr><td>정원</td><td>결제 완료자 기준 12,000명 (2025년 참가 15,524명 대비 축소)</td></tr>
    <tr><td>참가비</td><td>하프 80,000원 / 10km 70,000원</td></tr>
    <tr><td>접수</td><td>6월 29일(월) 10:00 선착순 · 정원 소진 시 마감</td></tr>
...
<h2>접수·참가비 (2026-07-20 확정가 반영)</h2>
<p>접수는 <strong>6월 29일(월) 오전 10시</strong>부터 <a href="https://runseoulrun.com/" target="_blank" rel="noopener">공식 홈페이지</a>에서 선착순으로 진행 중입니다. 접수 오픈과 함께 공개된 <strong>2026년 확정 참가비는 하프(21km) 80,000원 / 10km 70,000원</strong>입니다.</p>
<table>
  <thead><tr><th>종목</th><th>2026 확정</th><th>2025(제19회)</th><th>인상폭</th></tr></thead>
  <tbody>
    <tr><td>하프(21km)</td><td><strong>80,000원</strong></td><td>79,000원</td><td>+1,000원</td></tr>
    <tr><td>10km</td><td><strong>70,000원</strong></td><td>59,000원</td><td><strong>+11,000원</strong></td></tr>
  </tbody>
</table>
<p><strong>10km가 1만원 넘게 올랐습니다.</strong> 하프는 사실상 동결인데 10km만 19% 인상돼, 두 종목 간 가격차가 2만원에서 1만원으로 좁혀졌습니다. 참가 정보 수정·환불은 <strong>8월 14일(금) 17시까지</strong> 가능합니다.</p>

<h2>정원 축소 → 광클 주의</h2>
<p>2026년 정원은 <strong>결제 완료자 기준 12,000명</strong>으로, 고정 마감일 없이 정원이 차면 종료됩니다. 2025년(제19회)에는 15,524명이 참가한 것으로 알려져 있어, 그 규모와 비교하면 <strong>약 20% 줄어든 셈</strong>입니다(축소 사유는 공식 발표되지 않았습니다). 수요는 그대로인데 자리가 줄었으니 <strong>하프부터 빠르게 마감될 가능성</strong>이 큽니다.</p>
...
<div class="callout warning">
  ...
  <div class="callout-body">
    ...
    <p>참가비는 2026-07-20 공식 접수 페이지에서 확인한 확정가(하프 80,000원·10km 70,000원)입니다. 고정 마감일 없이 <strong>정원 12,000명 소진 시 종료</strong>되므로, 이 글을 보는 시점에 이미 마감됐을 수 있습니다. 잔여 여부와 코스 통제 안내는 <a href="https://runseoulrun.com/" target="_blank" rel="noopener">공식 홈페이지</a>에서 최종 확인하세요.</p>
  </div>
</div>
`,
  },
...
`,
  },
  {
    ...
    event: {
      ...
      startDate: '2026-11-15T09:30:00+09:00',
      location: {
        name: '임진각',
        address: '경기도 파주시',
      },
      organizer: '손기정기념재단·스포티비뉴스',
      url: 'https://www.sonkeechungrun.com/',
      offers: [
        { name: '풀코스', priceKrw: 70000, url: 'https://www.sonkeechungrun.com/' },
        { name: '하프', priceKrw: 65000, url: 'https://www.sonkeechungrun.com/' },
        { name: '10km', priceKrw: 60000, url: 'https://www.sonkeechungrun.com/' },
        { name: '6km', priceKrw: 50000, url: 'https://www.sonkeechungrun.com/' },
      ],
    },
    faqs: [
      { question: '2026 손기정평화마라톤은 언제 열리나요?', answer: '2026년 11월 15일(일)로 확정됐습니다. 오전 8시 30분 집결, 9시 30분 출발입니다(공식 대회요강 기준). 2025년 대회는 11월 16일이었습니다.' },
      { question: '대회 장소가 임진각으로 바뀌었나요?', answer: '네. 2025년까지는 고양종합운동장에서 출발해 제2자유로를 달렸지만, 2026 대회요강은 대회장을 임진각(경기 파주)으로 공지했습니다. 2025년 대회 때 "2026년은 임진각에서 열어, 임진각~개성을 달리는 남북평화마라톤으로 발전하는 출발점으로 삼겠다"고 예고된 이전입니다.' },
      { question: '접수는 언제 시작하나요?', answer: '2026년 8월 9일(일) 오전 9시에 이미 열렸습니다. 공식 대회요강에 "8월 9일 09:00 ~ 선착순 마감"으로 공지돼 있어 마감 날짜가 따로 없고, 정원이 차면 그대로 끝납니다. 2025년에는 9월 13일 오후 4시에 열려 약 2만 명 정원이 일주일 안에 찼습니다. 접수 후 24시간 내 미결제 시 신청이 자동 삭제되니 결제까지 한 번에 끝내세요.' },
      { question: '종목과 참가비는 어떻게 되나요?', answer: '2026년부터 풀코스·하프·10km에 6km가 신설돼 4개 종목입니다. 참가비는 풀 70,000원, 하프 65,000원, 10km 60,000원, 6km 50,000원으로 전 종목이 2025년보다 1만원 올랐습니다. 제한시간은 풀 5시간, 하프 3시간, 10km 1시간 30분, 6km 1시간입니다.' },
      { question: '제2자유로는 이제 못 달리나요?', answer: '2026 코스 상세는 공식 홈페이지에서 아직 "준비중"입니다. 대회장이 임진각으로 옮겨진 만큼 2025년까지의 고양 제2자유로 코스와는 달라질 가능성이 높지만, 확정 코스는 공식 공개를 기다려야 합니다. 공개되면 이 글을 갱신하겠습니다.' },
      { question: '대회장까지 어떻게 가나요?', answer: '공식 교통·주차 안내가 아직 게시되지 않았습니다. 임진각 일대는 대회일 혼잡이 예상되니 공식 안내가 뜨면 확인하세요. 배번·기념품·칩은 11월 9일 우체국 택배로 사전 발송되므로 당일 현장 수령 부담은 적습니다.' },
    ],
    content: `
<div class="tldr">
  <span class="tldr-label">3줄 요약</span>
  <ul>
    <li><strong>2026 제22회가 확정됐습니다 — 11월 15일(일) 오전 9시 30분 출발, 대회장은 임진각(파주)</strong>. 2025년까지의 고양 제2자유로에서 옮겨, "임진각~개성 남북평화마라톤"으로 발전시키겠다는 구상의 첫걸음입니다.</li>
    <li><strong>6km 종목 신설로 4개 종목</strong>(풀·하프·10km·6km), 참가비는 전 종목 1만원 인상(풀 7만·하프 6.5만·10K 6만·6K 5만). 배번·기념품은 11/9 우체국 택배 사전 발송입니다.</li>
    <li><strong>접수가 8월 9일(일) 오전 9시 열렸습니다 — 마감일 없는 선착순</strong>. 2025년엔 9/13 오픈 후 약 2만 명이 일주일 만에 찬 대회라, 종목이 정해졌다면 미루지 않는 편이 안전합니다.</li>
  </ul>
</div>
...
<div class="callout warning">
  <span class="callout-icon">📢</span>
  <div class="callout-body">
    <p class="callout-title">8/10 갱신 — 접수 시작됨</p>
    <p>공식 대회요강의 접수기간이 <strong>"8월 9일 09:00 ~ 선착순 마감"</strong>으로 확정 게시됐습니다(2026-08-10 확인). 예고대로 작년(9/13)보다 <strong>한 달가량 빨라졌고</strong>, 마감 날짜가 따로 없어 정원이 차는 순간 끝납니다. 신청은 <a href="https://www.sonkeechungrun.com/entryperson" target="_blank" rel="noopener">공식 개인참가신청 페이지</a>에서 하고, <strong>접수 후 24시간 안에 결제</strong>하지 않으면 신청내역이 삭제됩니다.</p>
  </div>
</div>
...
<h2>2026, 임진각으로 — 무엇이 바뀌나</h2>

<table>
  <thead>
    <tr><th>항목</th><th>2025 (제21회)</th><th>2026 (제22회, 확정)</th></tr>
  </thead>
  <tbody>
    <tr><td>대회일</td><td>11/16(일)</td><td><strong>11/15(일)</strong> 집결 8:30 · 출발 9:30</td></tr>
    <tr><td>대회장</td><td>고양종합운동장 (제2자유로)</td><td><strong>임진각 (경기 파주)</strong></td></tr>
    <tr><td>종목</td><td>풀·하프·10K</td><td>풀·하프·10K + <strong>6km 신설</strong></td></tr>
    <tr><td>참가비</td><td>6만 / 5.5만 / 5만</td><td><strong>7만 / 6.5만 / 6만 / 5만(6K)</strong></td></tr>
    <tr><td>접수</td><td>9/13 16시 오픈 → 일주일 내 마감</td><td><strong>8월 중 공지 예정</strong></td></tr>
  </tbody>
</table>

<p>가장 큰 변화는 장소입니다. 2025년 대회 당시 주최 측은 <strong>"2026년 대회는 임진각에서 열어, 임진각~개성을 달리는 손기정남북평화마라톤으로 발전하는 출발점으로 삼겠다"</strong>고 예고했고, 실제로 2026 대회요강이 대회장을 임진각으로 공지하며 그 구상이 현실이 됐습니다. 분단의 상징이자 민간인이 갈 수 있는 북녘과 가장 가까운 땅에서, 일장기를 달고 달려야 했던 마라토너의 이름으로 달리는 셈이라 대회의 평화 서사는 오히려 더 짙어졌습니다.</p>

<h2>그럼 제2자유로는? — 2025년까지의 정체성</h2>

<p>지금까지 이 대회의 정체성은 <strong>제2자유로</strong>에 있었습니다. 제2자유로는 평소 보행·자전거가 금지된 <strong>자동차 전용도로</strong>인데, 손기정평화마라톤은 대회 당일에만 이 도로를 러너에게 통째로 내어주는 <strong>국내 유일 대회</strong>였어요.</p>

<div class="callout info">
  <span class="callout-icon">🛣️</span>
  <div class="callout-body">
    <p class="callout-title">2026 코스는 아직 "준비중"</p>
    <p>공식 홈페이지의 풀·하프·10km 코스 페이지는 현재 <strong>준비중</strong>입니다. 임진각 출발로 바뀐 만큼 제2자유로 왕복 코스가 유지될지, 자유로·평화누리 일대의 새 코스가 될지는 공식 공개를 기다려야 합니다. 코스가 공개되면 이 글을 갱신하겠습니다. 아래 제2자유로 설명은 2025년까지의 코스 기준입니다.</p>
  </div>
</div>
...
<h2>종목·참가비·제한시간 (2026 확정)</h2>

<table>
  <thead>
    <tr><th>종목</th><th>참가비</th><th>제한시간</th><th>참가자격</th></tr>
  </thead>
  <tbody>
    <tr><td><strong>풀코스</strong></td><td>70,000원</td><td>5시간</td><td>만 18세 이상</td></tr>
    <tr><td><strong>하프</strong></td><td>65,000원</td><td>3시간</td><td>제한 없음</td></tr>
    <tr><td><strong>10km</strong></td><td>60,000원</td><td>1시간 30분</td><td>제한 없음</td></tr>
    <tr><td><strong>6km</strong> <em>(신설)</em></td><td>50,000원</td><td>1시간</td><td>제한 없음</td></tr>
  </tbody>
</table>

<p>전 종목이 2025년보다 1만원씩 올랐고, 가족·입문 러너를 겨냥한 <strong>6km가 새로 생겼습니다</strong>. 출발은 오전 9시 30분(집결 8:30), 결제는 신용카드·가상계좌이며, 대한육상연맹 2024~2026 등록 엘리트 선수는 시상에서 제외됩니다.</p>

<h2>접수 — 8월 9일 오픈, 마감일 없는 선착순</h2>

<p>손기정평화마라톤의 가장 큰 주의점은 <strong>속도</strong>입니다. 2025년에는 <strong>9월 13일 오후 4시 접수 오픈 → 약 2만 명 정원이 일주일 안에 마감</strong>됐어요. 2026년은 예고대로 앞당겨져 <strong>8월 9일(일) 오전 9시</strong>에 열렸고, 공식 대회요강에 마감일 대신 <strong>"선착순 마감"</strong>이라고만 적혀 있습니다. 달력을 보며 기다릴 마감일이 없다는 뜻이라, 뛸 종목이 정해졌다면 지금 넣는 게 안전합니다.</p>

<p><strong>접수 전 체크리스트</strong>:</p>

<ul>
  <li><strong>레이스플랜 계정부터</strong> — 접수처인 공식 홈페이지(<a href="https://www.sonkeechungrun.com/" target="_blank" rel="noopener">sonkeechungrun.com</a>)는 레이스플랜 계정으로 로그인합니다. 계정이 없다면 가입이 첫 단계입니다.</li>
  <li><strong>필수 입력값 준비</strong> — 성명·생년월일·휴대폰·코스·기념품 사이즈·주소를 요구합니다. 기념품 사이즈를 미리 정해두면 접수가 빨라집니다.</li>
  <li><strong>결제까지 한 번에</strong> — 접수 후 <strong>24시간 내 미결제 시 신청 내역이 자동 삭제</strong>됩니다. 신용카드나 가상계좌로 그 자리에서 끝내세요.</li>
  <li><strong>단체(2인 이상)도 홈페이지 직접 접수</strong> — 별도 단체 양식은 접수 종료 후에만 제공됩니다.</li>
</ul>

<div class="callout info">
  <span class="callout-icon">📅</span>
  <div class="callout-body">
    <p class="callout-title">코스가 공개되면 이 글을 갱신합니다</p>
    <p>접수는 열렸지만 <strong>코스 상세는 여전히 공식 "준비중"</strong>입니다(2026-08-10 확인). 코스와 교통안내가 공개되는 대로 이 글과 <a href="/marathon/sonkeechung-peace-marathon-2026">손기정평화마라톤 캘린더 페이지</a>를 갱신하겠습니다. 최신 확인은 <a href="https://www.sonkeechungrun.com/" target="_blank" rel="noopener">공식 홈페이지</a> 공지사항에서 하세요.</p>
  </div>
</div>
...
<ul>
  <li><strong>교통·주차 안내는 준비중</strong> — 임진각으로 장소가 바뀐 만큼 공식 교통안내·교통통제 공지를 기다려야 합니다. 임진각 평화누리 일대는 대회일 혼잡이 예상되니 공지가 뜨면 확인하세요.</li>
  <li><strong>배번·기념품은 사전 택배</strong> — 마라톤 패키지(배번·칩·기념품)가 <strong>11월 9일 우체국 택배로 발송</strong>됩니다. 당일 현장 수령 줄을 설 필요가 없습니다.</li>
  <li><strong>11월 추위 대비</strong> — 출발 대기 시간이 길 수 있어 버리는 옷·우의로 체온을 유지하세요. 임진강변 바람이 변수입니다.</li>
</ul>
...
<p style="font-size:0.85em;color:#64748b;margin-top:2em;">※ 2026-07-29 갱신: 대회일(11/15)·장소(임진각)·종목(6km 신설)·참가비·제한시간·결제 방식·택배 발송일은 손기정평화마라톤 공식 홈페이지 대회요강(sonkeechungrun.com, 2026-07-29 확인) 기준 확정 정보입니다. 임진각 이전 배경("남북평화마라톤 발전 구상")은 2025-09 스포티비뉴스·쿠키뉴스 보도 기준. 2026 코스 상세와 접수 오픈 일시는 공식 "준비중/8월 중 공지 예정" 상태로, 공개 시 갱신합니다. 원문 발행 2026-06-13.</p>
`,
  },
  {
...
`,
  },
  {
    ...
    title: '베를린마라톤 2026 (9/27) — 접수는 이미 끝났다, 다음 기회는 2027 발롯 | 대회 직후 열리는 패턴·세계 최속 평지 PB 코스',
    description: '베를린마라톤 2026(9월 27일)은 추첨이 2025년 11월에 끝나 지금 신청할 수 없습니다. 그래서 이 글의 무게중심은 "다음"에 있습니다 — 2027 발롯은 2026년 8월 15일 현재 공식 미게시지만, 직전 사이클은 대회 직후인 9월 25일에 열려 11월 5일에 닫히고 11월 27일에 결과가 나왔습니다. 즉 9/27 대회 직후 몇 주가 관측된 관문입니다. 세계기록이 가장 많이 나온 평지 코스의 PB 전략, 인천→프랑크푸르트 경유·시차·솅겐 무비자(ETIAS)와 평지 카본화까지 한국 러너 기준으로 정리했습니다.',
    ...
    content: `
<div class="callout info">
<p><strong>지금 상태 한눈에 (${MAJOR_DEADLINES_AS_OF} 기준)</strong> — 2026 대회는 <strong>9월 27일 개최</strong>로 약 6주 남았지만, 일반 추첨은 <strong>2025년 9월 25일~11월 5일</strong>에 이미 진행됐고 결과도 <strong>2025년 11월 27일</strong>에 통보가 끝났습니다. 즉 <strong>지금 이 글을 읽고 2026 대회에 일반 접수로 들어갈 방법은 없습니다.</strong> 그래서 이 글의 무게중심은 <strong>"다음 기회를 어떻게 잡느냐"</strong>에 있습니다 — 아래 3장이 그 내용입니다. 본문은 추측 없이 공식(bmw-berlin-marathon.com) 기준으로만 정리했고, 당첨 가능성이나 미공개 일정은 단정하지 않습니다.</p>
</div>

<div class="tldr">
  <span class="tldr-label">먼저 결론</span>
  <ul>
    <li><strong>2026은 닫혔습니다</strong> — 추첨·결과 통보 모두 2025년에 종료. 남은 건 자선·공식 투어 슬롯뿐이고, 대회가 6주 앞이라 이마저 실질적으로 어렵습니다.</li>
    <li><strong>다음은 2027 발롯</strong>인데, ${MAJOR_DEADLINES_AS_OF} 현재 <strong>공식 페이지에 2027 일정이 아직 올라오지 않았습니다</strong>(불명). 확인된 건 직전 사이클의 실제 일정뿐입니다.</li>
    <li><strong>그 실적이 곧 준비 시점입니다</strong> — 2026 발롯은 <strong>대회 직후인 9월 25일에 열려 11월 5일에 닫혔습니다</strong>. 2027도 같은 리듬이라면 <strong>9월 27일 대회 직후 몇 주</strong>가 관문입니다. 지금 할 일은 신청이 아니라 <strong>계정 준비와 알림 설정</strong>입니다.</li>
  </ul>
</div>
...
<h2>2. 2026 접수는 끝났다 — 남은 두 갈래 길(과 그 현실성)</h2>
<p>베를린마라톤은 다른 메이저 대회들과 마찬가지로 <strong>추첨(lottery) 방식</strong>으로 출전권을 배분합니다. 2026 대회 추첨은 2025년 9월 25일부터 11월 5일까지 접수를 받았고, 결과는 2025년 11월 27일 이메일로 통보됐습니다. <strong>당첨 발표가 끝났다는 것은, 일반 추첨 경로가 이미 마감됐다는 뜻</strong>입니다.</p>
<p>그렇다면 2026에 꼭 가고 싶은 러너에게 남은 길은 무엇일까요. 공식 사이트가 안내하는 잔여 경로는 두 가지입니다. 다만 <strong>대회가 6주 앞</strong>이라는 점은 감안해야 합니다 — 자선 슬롯의 모금 약정, 투어 패키지의 항공·숙박 확보 모두 이 시점에는 물량과 시간이 빠듯합니다. 아래는 "경로가 존재한다"는 설명이지 "지금 가능하다"는 보장이 아닙니다.</p>
<table>
...
<p>참가비는 <strong>사이클과 등록 카테고리에 따라 달라집니다</strong>. 과거 자료에서 국제 러너 기준 약 <strong>155유로</strong> 수준으로 알려져 왔지만, 2026 사이클 공식 등록 안내에서는 <strong>205유로</strong> 표기가 확인됩니다(환율에 따라 한화 약 22만~30만 원 사이로 벌어집니다). 어느 쪽이 본인에게 적용되는지는 카테고리·회원 여부에 따라 갈리므로, <strong>예산은 넉넉한 쪽으로 잡고 신청 시점의 공식 금액을 확인</strong>하세요. 자선·투어 경로는 이와 별개로 모금액 또는 패키지 비용이 추가됩니다.</p>
...
<h2>3. 2027 발롯 — 언제 열리고, 지금 뭘 해둬야 하나</h2>

<p>이 글에서 가장 실질적인 부분입니다. 2026에 들어가지 못했다면 다음 기회는 2027 대회이고, <strong>그 관문은 생각보다 빨리, 그리고 짧게 열립니다.</strong></p>

<div class="callout warning">
<p><strong>먼저 분명히 할 것</strong> — ${MAJOR_DEADLINES_AS_OF} 기준으로 <strong>2027 발롯의 공식 일정은 아직 게시되지 않았습니다</strong>. 베를린마라톤 공식 등록·추첨 안내 페이지는 여전히 2026 대회 내용만 담고 있습니다. 인터넷에는 "2027 발롯은 10월 1일 오픈" 같은 구체적 날짜를 적어둔 2차 소스가 돌아다니지만, <strong>공식에서 확인되지 않아 이 글에서는 쓰지 않습니다.</strong> 아래 표는 예측이 아니라 <strong>직전 사이클에 실제로 일어난 일</strong>입니다.</p>
</div>

<table>
<thead><tr><th>단계</th><th>2026 대회 사이클 실적</th><th>2027은?</th></tr></thead>
<tbody>
<tr><td>발롯 접수 시작</td><td>2025년 9월 25일 <small>(2025 대회 직후)</small></td><td rowspan="3"><strong>공식 미게시</strong><br><small>같은 리듬이라면 2026년 9월 27일 대회 직후</small></td></tr>
<tr><td>발롯 접수 마감</td><td>2025년 11월 5일</td></tr>
<tr><td>추첨 결과 통보</td><td>2025년 11월 27일 <small>(이메일)</small></td></tr>
</tbody>
</table>

<p>여기서 읽어야 할 신호는 하나입니다 — <strong>발롯은 그해 대회가 끝나자마자 열린다</strong>는 것. 2026 발롯은 2025년 대회 종료 직후 열렸고, 접수창은 <strong>6주 남짓</strong>이었습니다. 다시 말해 <strong>2026년 9월 27일 베를린마라톤이 끝나는 그 주부터</strong> 공식 사이트를 봐야 한다는 뜻입니다. "가을쯤 확인해야지"라고 막연히 미루면, 6주짜리 창이 닫힌 뒤에 들어가게 됩니다.</p>

<h3>지금(8월) 해둘 것 — 신청이 아니라 준비</h3>

<ul>
<li><strong>공식 사이트 개인 계정을 미리 만들어 둡니다</strong> — 베를린 발롯은 개인 계정(user account)을 통해 응모하는 구조입니다. 접수 시작 후 계정부터 만들면 그만큼 늦어집니다.</li>
<li><strong>공식 뉴스레터를 구독하고, 9월 마지막 주에 알림을 걸어둡니다</strong> — 발롯 오픈은 별도 대대적 공지 없이 등록 페이지가 열리는 식으로 진행돼 왔습니다. 달력에 <strong>9월 28일 전후</strong>로 리마인더를 잡아두는 게 가장 확실합니다.</li>
<li><strong>여권 영문명·생년월일 표기를 확정해 둡니다</strong> — 응모 정보와 여권이 어긋나면 나중에 정정이 번거롭습니다.</li>
<li><strong>결제 수단을 점검합니다</strong> — 당첨 시 유로 결제가 발생합니다. 해외 결제 가능 카드를 미리 확인해 두세요.</li>
<li><strong>기록 증빙을 정리해 둡니다</strong> — 발롯 외에 기록 기준 우선 출전 경로를 두는 대회들이 있고, 베를린도 자선·투어 외 별도 경로를 운영해 왔습니다. 국내 공인 대회 기록이 있다면 증빙을 모아두면 선택지가 넓어집니다.</li>
</ul>

<p>정리하면, 지금 이 글을 읽는 시점에 <strong>베를린을 향해 할 수 있는 행동은 "신청"이 아니라 "9월 말에 신청할 수 있는 상태를 만들어 두는 것"</strong>입니다. 그리고 그때까지 남은 6주는, 아래 4~6장의 코스 특성과 원정 준비를 미리 읽어두기에 딱 맞는 시간이기도 합니다.</p>
...
<p class="disclaimer">본 글은 2026년 6월 13일 최초 작성, <strong>${MAJOR_DEADLINES_AS_OF} 베를린마라톤 공식(bmw-berlin-marathon.com) 등록·추첨 안내 및 FAQ 재확인 후 갱신</strong>했습니다. 갱신분: 2026 발롯 실제 일정(2025-09-25 오픈 / 11-05 마감 / 11-27 결과 통보) 확정 반영, 2027 발롯 대비 실행 항목 신설, 참가비 표기 차이(155유로 대 205유로) 명시. <strong>2027 발롯의 공식 일정은 이 시점 기준 미게시 상태</strong>이며, 본문의 "대회 직후 오픈"은 예측이 아니라 직전 사이클 실적을 근거로 한 관측 패턴입니다 — 2차 소스에 도는 구체적 2027 날짜는 공식 확인이 불가해 싣지 않았습니다. 참가비·잔여 슬롯·항공편·비자/ETIAS 정책은 변동될 수 있으므로, 신청·출국 전 반드시 공식 사이트와 항공사·대사관 안내로 최신 정보를 재확인하시기 바랍니다. 당첨 여부나 미공개 일정은 단정하지 않습니다. — 산초 에디터</p>
`,
  },
  {
...
<div class="callout warning">
  <span class="callout-icon">📌</span>
  <div class="callout-body">
    <p class="callout-title">신청 창은 닫혔습니다 — 지금 이 글로 할 수 있는 것</p>
    <p><strong>2027 도쿄에 새로 응모할 방법은 없습니다.</strong> 이 글은 이제 두 가지 용도로 남습니다. 첫째, <strong>이미 응모한 사람</strong>에게는 ${MAJOR_DEADLINES.tokyo2027.ballot.resultMonth} 결과 확인과 <strong>${md(MAJOR_DEADLINES.tokyo2027.ballot.feePayBy)} 결제 기한</strong>이 남은 일정입니다 — 당첨되고도 기한을 넘기면 자리가 사라집니다. 둘째, <strong>2028 사이클을 노리는 사람</strong>에게는 이 대회의 접수 구조(8월 중순 오픈·2주 창·무료 응모·당첨 후 결제)가 그대로 반복될 가능성이 높은 참고 자료입니다.</p>
  </div>
</div>
...
<table>
  ...
  <tbody>
    <tr><td><strong>일반 추첨(무료 응모)</strong></td><td>${md(MAJOR_DEADLINES.tokyo2027.ballot.open)} 11시~${md(MAJOR_DEADLINES.tokyo2027.ballot.close)} 17시(JST)</td><td>응모 무료 · 당첨 시 참가비만</td><td><strong>마감</strong> — 결과 ${MAJOR_DEADLINES.tokyo2027.ballot.resultMonth}</td></tr>
...
<h2>한국에서 넣는다면 — 어느 사이트로 응모하나</h2>

<p>여기가 이번 사이클에서 가장 확인이 필요한 지점입니다. 도쿄마라톤 공식 FAQ는 이렇게 안내합니다 — <strong>"해외 거주자는 국적을 불문하고 영어 사이트에서 엔트리해 주십시오."</strong> 그런데 그 영어 사이트 창구인 <strong>ONE TOKYO GLOBAL 멤버 엔트리는 ${md(MAJOR_DEADLINES.tokyo2027.oneTokyoGlobal.close)} 17시에 이미 마감</strong>됐습니다.</p>

<p>지금 열려 있는 일반 응모는 공식 모집요강상 <strong>거주지 제한 문구가 없고</strong>, 참가비도 국내 ¥${MAJOR_DEADLINES.tokyo2027.ballot.feeDomesticJpy.toLocaleString()}과 해외 USD ${MAJOR_DEADLINES.tokyo2027.ballot.feeOverseasUsd}이 나란히 고시돼 해외 결제 경로 자체는 존재합니다. 다만 이 창구 안내는 "국내 사이트에서 엔트리한 사람 중 도쿄도 거주자"를 대상으로 한 도민 추첨을 포함하는 구조로 쓰여 있고, <strong>해외 거주자가 이 일반 응모에 넣을 수 있다는 명시는 없습니다</strong>.</p>

<div class="callout warning">
  <span class="callout-icon">❓</span>
  <div class="callout-body">
    <p class="callout-title">확인된 것과 불명확한 것을 갈라 둡니다</p>
    <ul>
      <li><strong>확인된 사실</strong> — 해외 거주자 전용 창구(영어 사이트·GLOBAL)는 ${md(MAJOR_DEADLINES.tokyo2027.oneTokyoGlobal.close)}에 종료. 일반 응모는 ${md(MAJOR_DEADLINES.tokyo2027.ballot.close)} 17시까지 열려 있고, 요강에 거주지 제한 문구는 없다.</li>
      <li><strong>불명확한 것</strong> — 한국 거주자가 지금 열린 일반 응모에 넣어도 유효한지. 공식 문서에 가부가 명시돼 있지 않습니다.</li>
      <li><strong>권하는 행동</strong> — 추측으로 진행하지 말고 <strong>공식 문의로 확인한 뒤 응모</strong>하세요. 이 글은 "된다/안 된다"를 단정하지 않습니다. 확인되지 않았기 때문입니다.</li>
    </ul>
  </div>
</div>

<p>확실하게 출전권을 잡는 쪽을 원한다면 남은 길은 <strong>공식 투어 슬롯</strong>입니다. 도쿄마라톤은 <strong>킨키니혼투어리스트(近畿日本ツーリスト)와 그와 파트너십을 맺은 여행사에만</strong> 출전권을 포함한 투어 판매를 허용합니다. 개인 응모보다 비용은 크게 올라가지만 추첨 운에 걸리지 않습니다. 반대로 "다음엔 제대로 준비하겠다"면, 해외 거주자 창구가 <strong>7월 말에 열려 8월 중순에 닫힌다</strong>는 이번 사이클 일정을 기억해 두세요 — 일반 응모보다 2주 먼저 닫힙니다.</p>

<h2>추첨은 한 번이 아니라 3단계다</h2>

<p>정원을 넘기면 추첨인데, 도쿄마라톤은 <strong>우선순위가 붙은 3단계 추첨</strong>을 돌립니다. 앞 단계가 먼저 자리를 가져간 뒤 남은 자리를 두고 일반 추첨이 이뤄지는 구조라, 어느 칸에 속하는지가 당락에 직결됩니다.</p>

<table>
  <thead><tr><th>순서</th><th>대상</th><th>결과 발표</th></tr></thead>
  <tbody>
    <tr><td>①</td><td>ONE TOKYO "3대회 연속 낙선" 멤버 챌린지</td><td>9/11</td></tr>
    <tr><td>②</td><td>도민 추첨 — 도쿄도 거주자, 정원 1,000명</td><td>9/16</td></tr>
    <tr><td>③</td><td><strong>일반 추첨</strong> — 위에 해당하지 않는 나머지</td><td>${MAJOR_DEADLINES.tokyo2027.ballot.resultMonth}</td></tr>
  </tbody>
</table>

<p>한국 러너는 ①②에 해당하지 않으므로 <strong>③ 일반 추첨</strong>이 실제 경쟁 무대입니다. 위 두 단계가 먼저 빠져나간다는 점을 감안하면, 체감 경쟁률은 단순 "응모자 대 정원"보다 빡빡하다고 보는 편이 맞습니다.</p>
...
<p style="font-size:0.85em;color:#64748b;margin-top:2em;">※ 2026-06-13 최초 작성, <strong>2026-08-14 갱신 · 2026-08-15 재갱신</strong>. 8-15 추가분은 공식 모집요강의 응모 자격·추첨 방식과 공식 FAQ의 해외 거주자 안내를 재확인한 내용입니다 — 해외 거주자 창구(영어 사이트·ONE TOKYO GLOBAL) 8/13 종료, 추첨 3단계 구조(연속낙선 9/11 · 도민 9/16 · 일반 9/18), 투어 출전권의 공식 판매 경로. <strong>한국 거주자가 지금 열린 일반 응모에 넣을 수 있는지는 공식에 명시가 없어 단정하지 않았습니다</strong> — 진행 전 공식 문의로 확인하세요. 갱신분은 도쿄마라톤 공식 사이트(marathon.tokyo)를 직접 확인한 내용입니다 — 일반접수 오픈 공지(8/14 11:00 게시)와 정원 초과·추첨 실시 공지(같은 날 15:19 게시), 접수 일정 페이지(경로별 기간·결과 발표·납부 기간), 대회 요강(정원 40,000명·참가비 국내 ¥19,800/해외 USD 230·짐 보관 ¥1,200·참가 자격·제한시간). 20주년 완주 메달 사양(100mm, 앞면 '20' 그래픽·뒷면 도쿄 랜드마크)은 공식 발표를 정리한 인스타그램 @runner_iffu 2026-08-12 게시물 기준입니다. 자선 단체별 해외 거주자 수락 여부는 단체마다 다르므로 개별 확인이 필요합니다. 신청 전 공식에서 최종 확인하세요.</p>
`,
  },
  {
...
<table>
  ...
  <tbody>
    ...
    <tr><td><strong>12/6</strong></td><td>부산브릿지마라톤(구 부산국제마라톤)</td><td>부산</td><td>풀·10K</td><td>8/24 10시 선착순</td><td>확정</td></tr>
  </tbody>
</table>
...
<p>한 해를 닫는 <strong>12/6 부산브릿지마라톤(구 부산국제마라톤)</strong>은 대한육상연맹 공인 부산 최대 풀코스입니다. 광안대교·부산항대교·남항대교를 모두 건너는 트리플 브릿지 코스로 재편됐고, 접수는 8월 24일(월) 10시부터 선착순입니다 — 자격요건(공식기록증 4:30 이내)과 코스 상세는 <a href="/blog/busan-bridge-marathon-2026">부산브릿지마라톤 접수 가이드</a>에 정리했습니다. (날짜는 일부 사이트가 12/1로 표기하지만, 공식 기준 <strong>12/6</strong>이 정확합니다.)</p>
...
<p>v3의 최대 약점은 누가 뭐래도 <strong>좁은 발볼</strong>이었습니다. 본 사이트 신발 DB에도 "좁음~표준"으로 적혀 있고, 해외 리뷰에서도 반 사이즈 업 권장이 반복됐어요. v4는 토박스를 넓혔고 <strong>와이드 옵션까지 추가</strong>했습니다. 발볼 넓은 한국 러너에게는 이 한 줄이 구매 결정을 바꾸는 변화입니다.</p>
...
<p>권하지 않습니다. v3는 "좁음~표준"에 와이드 옵션이 없어요. 반 사이즈 업을 권하는 리뷰도 많습니다. <strong>발볼 넓으면 v4(표준 토박스 넓어짐 + 와이드 옵션)</strong>가 맞습니다. 굳이 v3를 세일로 잡는다면 반드시 반사이즈 업으로 시착하세요. <a href="/blog/wide-feet-running-shoes-korea">발볼 넓은 한국 러너 가이드 →</a></p>
...
<p>가능은 하지만, 둘 다 <strong>레이스 본선용 카본 레이서가 아니라 슈퍼트레이너</strong>입니다. 최적 페이스가 4:00~5:30/km로 동일하고, 업템포·템포·하프 페이스 훈련에 최적화돼 있어요. Sub-3:30 이하 풀코스 PR 도전이라면 디비에이트 나이트로 엘리트나 전용 카본 레이서를 따로 두는 게 맞습니다. <a href="/blog/carbon-plate-running-shoes-lineup-tier-guide-2026">카본 플레이트화 비교 →</a></p>
...
<ul>
  <li><a href="/blog/carbon-plate-running-shoes-lineup-tier-guide-2026">카본 플레이트 러닝화 비교 2026 — 에너지 리턴과 입문자 주의</a></li>
  <li><a href="/blog/wide-feet-running-shoes-korea">발볼 넓은 한국 러너 추천 신발 — 토박스 실측 정리</a></li>
  <li><a href="/blog/knee-pain-running-shoes">무릎 통증 러너 신발 가이드</a></li>
...
<p>이게 한국 러너에게 가장 체감되는 변화일 수 있습니다. v1은 토박스 74.3mm <strong>와이드</strong>라 별도 와이드 모델 없이도 발볼 넓은 발이 편했는데, 맥스 2는 스너그 피팅으로 바뀌어 <strong>표준(standard)</strong>이 됐습니다. 와이드 버전에서도 핏이 꽉 맞아 반 사이즈 업을 권한다는 리뷰가 반복돼요. 발볼 넓다면 맥스 2는 반드시 시착하거나 와이드 옵션 + 반 사이즈 업을 고려하세요. <a href="/blog/wide-feet-running-shoes-korea">발볼 넓은 한국 러너 신발 가이드 →</a></p>
...
<p>주의가 필요합니다. 맥스 2는 v1의 와이드 토박스(74.3mm)에서 standard로 좁아졌고 스너그 피팅이라 <strong>리뷰마다 "반 사이즈 업"이 반복 권장</strong>됩니다. 발볼 넓다면 ① v1 와이드 토박스를 노리거나 ② 맥스 2 와이드 옵션 + 반 사이즈 업을 시착 후 결정하세요.</p>
...
<ul>
  ...
  <li><a href="/blog/carbon-plate-running-shoes-lineup-tier-guide-2026">카본 플레이트 슈즈 비교 2026 — 레이스용 분리 가이드</a></li>
</ul>
...
<ul>
  <li><a href="/blog/carbon-plate-running-shoes-lineup-tier-guide-2026">카본 플레이트 러닝화 비교 — 플레이트 슈즈가 처음이라면</a></li>
  <li><a href="/blog/wide-feet-running-shoes-korea">발볼 넓은 한국 러너 추천 신발 — 토박스 실측 정리</a></li>
  <li><a href="/blog/pronation-type-running-shoe-guide-2026">프로네이션 타입별 러닝화 가이드 2026</a></li>
  <li><a href="/blog/knee-pain-running-shoes">무릎 통증 러너 신발 가이드</a></li>
  <li><a href="/blog/first-running-shoe-guide-2026">첫 러닝화 고르는 법 2026</a></li>
...
<h2>청라하늘대교 편도 코스 (2026-09-03 확정)</h2>
<p>2025년 1회 대회는 문학경기장 기점 반환 코스였는데, <strong>2026년은 청라하늘대교를 통과하는 편도 코스</strong>로 바뀌었습니다. 9월 3일 공식 코스도가 공개되면서 방향까지 확정됐습니다.</p>
<ul>
  <li><strong>확정 코스(풀)</strong>: <strong>영종구 운서역</strong> 출발 → 영종 내 왕복 → <strong>청라하늘대교</strong> → 청라국제도시역 방면 왕복 → 크리스털 삼거리 → <strong>인천아시아드 주경기장</strong> 도착</li>
  <li><strong>특징</strong>: 서해 해안 경관과 도심을 잇는, 국내에 드문 <strong>교량 위 러닝</strong>. 세계육상연맹 공인은 "(예정)" 표기</li>
  <li><strong>10K·5K</strong>: 아시아드주경기장 출발·도착 왕복 코스</li>
</ul>
<p class="caption">※ 2026-04 언론 보도 단계에서 거론되던 "아시아드주경기장 출발 → 영종 씨사이드파크 도착" 방향은 확정 코스와 <strong>반대</strong>였습니다. 이 글의 6월 원문도 그 검토안을 옮겨 적었기에 위 항목을 확정 코스로 고쳤습니다. 공식은 코스도에 "코스는 추후 변경될 수 있습니다"를 함께 적었습니다.</p>
...
<div class="callout warning">
  ...
  <div class="callout-body">
    ...
    <ul>
      <li><strong>코스·참가비·접수일은 2026-09-04 기준 공식 확정</strong>으로 갱신했습니다. 다만 기념품 구성과 시상 내역은 공식 홈에서 아직 COMING SOON이고, 코스도에도 "변경될 수 있음"이 병기돼 있으니 신청 전 공식 사이트를 확인하세요</li>
...
<p style="font-size:0.85em;color:#64748b;margin-top:2em;">※ 본 글은 인천시 공식 발표와 경향신문·인천in 등 언론 보도, 2025년 제1회 대회 자료를 종합해 2026-06-08에 쓴 개요이며, 코스·참가비·접수·참가 자격은 2026-09-04에 공식 홈페이지(코스안내·유의사항·대회소개 표)를 직접 확인해 갱신했습니다. 기념품 구성과 시상 내역은 그 시점에도 공식 미공개였고, 신청 전 공식 사이트(incheonmarathon.or.kr)를 다시 확인하세요. 봄의 인천국제하프마라톤과는 별개 대회입니다. (글감: @runninglife_korea, 2026-06-08)</p>
`,
  },
  {
...
<ol>
  ...
  <li><strong>국내 AS·정식 유통이 없습니다.</strong> KREAM·POIZON·알리익스프레스·타오바오 등 <strong>병행수입·구매대행</strong>에만 의존하고, 사이즈 교환이나 하자 대응이 까다롭습니다. 발볼이 좁은 만큼 <strong>사이즈는 평소보다 여유 있게</strong> 잡는 편이 안전합니다.</li>
</ol>
...
`,
  },
  {
    ...
    content: `
<div class="deadline-strip">🎟️ <strong>2차(모아나)는 판매·완주 기간이 모두 끝났습니다</strong> — 티켓은 7월 9일(목) 오전 10시에 선착순 5,000명으로 풀렸고 완주 기간도 7월 31일로 종료됐습니다. 다음 회차를 노린다면 판매 방식이 <strong>대기열(큐)</strong>이라는 점, 1차(토이스토리)·2차 모두 오픈 직후 경쟁이 몰렸다는 점을 기억해두세요.</div>
...
<p>"플레이트 없는 슈퍼폼 트레이너"라는 점에서 <a href="/shoes/hoka-mach-6">호카 마하 6</a>, <a href="/shoes/saucony-ride-19">사우코니 라이드 19</a>와 같은 결입니다. 카본 플레이트가 정말 필요한지 고민된다면 → <a href="/blog/carbon-plate-running-shoes-lineup-tier-guide-2026">카본 플레이트 러닝화 완벽 비교</a></p>
...
<ul>
  ...
  <li><strong>이런 사람에게</strong>: 서브3~4 기록 도전, 풀코스 경험자. <a href="/blog/carbon-plate-running-shoes-lineup-tier-guide-2026">카본 플레이트 비교</a> 참고</li>
</ul>
...
<div class="tldr">
  <span class="tldr-label">3줄 요약</span>
  <ul>
    <li><strong><a href="/shoes/li-ning-red-hare-9-ultra">리닝 적토마 9 울트라</a></strong>는 PEBA 3층 미드솔 + 47mm 맥스 스택을 <strong>10만원대(CNY 599)</strong>에 담아 "가성비 슈퍼 트레이너"로 화제</li>
...
<div class="callout warning">
  ...
  <div class="callout-body">
    ...
    <p>커뮤니티에서 "가성비 카본화"로 불리지만, <strong>적토마 9 울트라의 플레이트는 카본이 아니라 유리섬유(글라스 파이버)</strong>입니다. 리닝이 "슈퍼 카본" 류의 마케팅을 쓰지만 실제 소재는 유리섬유 지지 플레이트 + 캡슐 폼 조합이에요. 흔히 "카본은 같은 세대의 <a href="/shoes/li-ning-red-hare-9-pro">적토마 9 PRO</a>에 들어간다"고 알려졌지만, <strong>라이닝 공식 설명상 9 PRO 역시 카본이 아니라 TPU 지지편을 쓰는 낮은 스택의 데일리 트레이너</strong>입니다(일부 마케팅의 T400 카본 주장은 독립 검증이 없습니다). 즉 적토 9 라인업엔 진짜 풀카본 레이서가 없고, 카본 슈퍼슈즈의 추진력을 원한다면 라이닝의 레이싱 전용 비전(飞电) 라인을 봐야 합니다.</p>
  </div>
</div>
...
<table>
  <thead>
    <tr><th>항목</th><th>적토마 9 울트라</th><th>의미</th></tr>
  </thead>
  <tbody>
...
<p>"반발력 역대급"의 정체가 바로 이 수치입니다. 폼이 눌렸다 돌아올 때 에너지를 얼마나 돌려주는지를 %로 잰 값으로, <strong>55% 안팎이면 보통, 65% 이상이면 우수</strong>합니다. PEBA·카본 플레이트 신발이 이 수치가 높습니다. 다만 에너지 리턴이 높다고 모두에게 좋은 건 아닙니다 — 입문자에겐 불안정하게 느껴질 수 있어요. <a href="/blog/carbon-plate-running-shoes-lineup-tier-guide-2026">카본 플레이트 러닝화 비교</a>에서 이 수치의 함정을 다뤘습니다.</p>
