...
export const posts_2026_07: BlogPost[] = [
  {
    ...
    title: '오사카 마라톤 2027 접수 방법 총정리 | 해외 신청은 JTB로 — 접수는 8월 28일 마감',
    description:
      '오사카 마라톤 2027(2027년 2월 28일, 제15회)의 일반 러너 접수가 7월 28일 시작돼 8월 28일 17시(일본시간)에 마감됩니다. 한국 등 해외 거주자는 일본 내 러너가 쓰는 런넷이 아니라 JTB 스포츠 스테이션으로 따로 신청해야 하고, 참가비도 해외 기준 145달러로 별도 책정돼 있습니다. 정원 28,420명이 넘으면 추첨이라 신청했다고 다 뛰는 것도 아닙니다. 접수 일정, 참가비, 신청 절차, 여행사 패키지 대안까지 오사카시·공동통신 공식 발표를 근거로 정리했습니다.',
    ...
    content: `
<div class="deadline-strip">🇯🇵 <strong>오사카 마라톤 2027 일반 러너 접수</strong>가 <strong>7월 28일(화) 10시 시작, 8월 28일(금) 17시(일본시간) 마감</strong>입니다. 정원 28,420명을 넘으면 추첨이라, 마감 직전까지 미룰 이유가 없습니다.</div>
...
<div class="tldr">
  ...
  <ul>
    ...
    <li><strong>한국 거주자는 런넷이 아니라 JTB 스포츠 스테이션(jtbsports.jp)</strong>으로 신청합니다. 참가비도 해외 기준 <strong>145달러</strong>로 국내(일본) 16,000엔과 별도 책정돼 있고, 여기에 사무 수수료·자선 모금이 추가됩니다</li>
...
<p>여기에 <strong>결제 금액의 6%에 해당하는 사무 수수료</strong>와, 참가자 1인당 <strong>2구좌 이상(1구좌 500엔)의 자선 모금</strong>이 별도로 부과됩니다(국내 참가자 기준 공식 발표 근거). 해외 결제분의 정확한 수수료 적용 방식은 JTB 스포츠 스테이션 결제 화면에서 최종 금액을 확인하는 것이 확실합니다.</p>
...
<p><small>※ 접수 일정·정원·참가비는 오사카시 경제전략국·공동통신PR와이어의 2026년 7월 21~22일 공식 보도자료를 근거로 작성했습니다. 신청 절차(JTB 스포츠 스테이션 이용법)와 신원 확인 서류는 오사카 마라톤 공식 홈페이지 과거 대회 안내를 참고했습니다. 코스 제한시간·관문은 직전 대회 기준 참고치이며, 2027년 확정 요강 공개 시 이 글을 갱신합니다. 환불·취소 등 최종 규정은 반드시 접수 시점의 공식 페이지(jtbsports.jp, osaka-marathon.com)에서 재확인하세요. (작성 2026-07-31)</small></p>
`,
  },
  {
