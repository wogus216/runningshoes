...
`,
  },
  {
    ...
    description:
      '"맥시멀 쿠션인데 가볍고 반발력도 있는 신발"을 찾는다면 아식스 메가블라스트가 답입니다. 48mm 초고 스택에서 218g이라는, 호카 본디 9(293g)보다 75g 가벼운 무게를 실현했습니다. FF Blast Turbo로 83% 에너지 리턴을 내면서도 부상 예방 등급은 전부 최상위입니다. 장거리·리커버리 런에서 발이 무거워지지 않는 맥시멀 쿠션화를 원하는 러너를 위해 랩 수치를 정리했습니다.',
...
<p>메가블라스트는 아식스의 <strong>FF Blast Turbo 폼</strong>을 얹은 최상위 맥시멀 쿠션화입니다. 힐 48.1mm·전족 38.5mm의 초고 스택으로 장거리 아스팔트 충격을 최대한 걸러내면서도, <strong>218g이라는 초경량</strong>을 실현한 게 핵심입니다. 플레이트는 없지만(스택이 더 낮은 <a href="/shoes/asics-sonicblast">소닉블라스트</a>에는 Pebax 소재의 ASTROPLATE가 들어갑니다) 폼 자체의 반발력만으로 83% 에너지 리턴을 냅니다.</p>
...
<ul>
  <li><strong>"발볼 넓은데 괜찮나요?"</strong> — 토박스가 82.6mm로 넓은 축이라, 와이드 옵션 없이도 발볼 넓은 한국 러너가 대응할 수 있는 수치입니다</li>
...
<h2>가격 대비 가치</h2>
<p>정가 299,000원(세일가 25만원 안팎), 500km 기준 <strong>km당 약 598원</strong>입니다. 맥시멀 쿠션화 중에서는 상위 가격대지만, "48mm 스택 + 218g 초경량 + 83% 에너지 리턴"이라는 조합을 동시에 만족하는 신발은 드물어 스펙 대비로는 납득할 만한 가격입니다. 가격 부담이 크다면 7만원 저렴한 <a href="/shoes/asics-sonicblast">소닉블라스트</a>(229,000원)를 볼 수 있지만, 같은 성능을 싸게 주는 하위 모델은 아닙니다 — 스택이 45.4/36.4mm로 낮고 37g 무거우며 토박스도 70.1mm로 좁습니다. 대신 Pebax 플레이트가 들어가 템포·인터벌 쪽에 맞습니다.</p>
...
<h2>마무리</h2>
<p>메가블라스트는 "맥시멀 쿠션은 무겁다"는 통념을 깨는 신발입니다. 48mm 스택에서 218g을 실현했다는 것만으로도 아식스 라인업에서 독보적인 위치이고, 반응성·부상 예방 등급까지 최상위라 장거리 러너에게 특히 매력적입니다. 가격이 부담스럽다면 소닉블라스트도 함께 볼 수 있지만, 성격이 다른 신발이라는 점을 감안하고 비교하세요.</p>
`,
    faqs: [
      {
        question: '메가블라스트와 소닉블라스트, 뭘 사야 하나요?',
        answer: '용도가 다른 신발입니다. 메가블라스트는 플레이트가 없고 스택 48.1/38.5mm에 218g으로 가벼워 이지런·장거리에 맞습니다. 소닉블라스트는 45.4/36.4mm로 스택이 낮고 255g으로 무겁지만, 3/4 길이 ASTROPLATE(카본이 아니라 Pebax 소재)가 들어가 템포·인터벌에서 진가가 나옵니다. 7만원 싸다고 하위호환은 아니며, 발볼이 넓다면 토박스가 82.6mm인 메가블라스트 쪽이 맞습니다(소닉블라스트는 70.1mm로 좁습니다).',
      },
      {
...
<table>
  ...
  <tbody>
    ...
    <tr><td>스택(힐/전족, 실측)</td><td>45.4 / 36.4mm</td><td><strong>48.1 / 38.5mm</strong></td></tr>
    <tr><td>플레이트</td><td><strong>3/4 ASTROPLATE (Pebax)</strong></td><td>없음</td></tr>
    <tr><td>미드솔</td><td>FF Turbo Squared + FF Blast Max</td><td>FF Blast Turbo</td></tr>
    <tr><td>토박스</td><td>70.1mm (좁음)</td><td><strong>82.6mm (넓음)</strong></td></tr>
    ...
    faqs: [
      {
        ...
        answer: '용도로 가르세요. 메가블라스트는 플레이트가 없고 스택이 48.1/38.5mm로 더 높으며 218g으로 37g 가볍습니다. 편하게 오래 달리는 이지런·장거리용입니다. 소닉블라스트는 45.4/36.4mm에 3/4 ASTROPLATE가 들어가 템포·인터벌에서 진가가 나옵니다. 가격은 소닉블라스트가 229,000원으로 7만원 저렴하지만, 같은 성능을 싸게 주는 관계가 아니라 성격이 다른 신발입니다. 발볼이 넓다면 토박스 82.6mm인 메가블라스트 쪽이 맞습니다.',
      },
      {
