...
export const posts_2026_07: BlogPost[] = [
  {
    ...
    description:
      '오사카 마라톤 2027(2027년 2월 28일, 제15회)의 일반 러너 접수가 8월 28일 17시(일본시간)에 마감됩니다. 한국 등 해외 거주자는 일본 내 러너가 쓰는 런넷이 아니라 JTB 스포츠 스테이션으로 따로 신청하고, 참가비도 해외 기준 145달러로 별도 책정돼 있습니다. 여기에 해외 결제분 사무수수료 11%와 자선 모금 2구좌(10달러)가 더해져 실부담은 약 171달러입니다. 정원 28,420명이 넘으면 추첨이라 신청했다고 다 뛰는 것도 아닙니다. 접수 일정·참가비·신청 절차·여행사 대안까지 오사카시 공식 발표를 근거로 정리했습니다.',
    ...
    event: {
      name: '오사카 마라톤 2027 (제15회 大阪マラソン)',
      startDate: '2027-02-28',
      location: {
        name: '오사카부청 앞 출발 — 오사카 시내 일주 코스',
        address: '일본 오사카부 오사카시 추오구',
      },
      organizer: '오사카 마라톤 조직위원회 (오사카시)',
      url: 'https://www.osaka-marathon.com/2027/',
    },
    faqs: [
      {
        question: '한국에 살면서 런넷(runnet.jp)으로 신청해도 되나요?',
        answer:
          '원칙적으로는 안 됩니다. 오사카 마라톤은 2024년 대회부터 국내(일본) 거주자는 런넷, 해외 거주자는 JTB 스포츠 스테이션(jtbsports.jp)으로 신청 창구를 나눴습니다. 한국 거주자는 JTB 스포츠 스테이션에서 회원가입 후 신청하는 것이 공식 경로입니다.',
      },
      {
        question: '접수만 하면 무조건 뛸 수 있나요?',
        answer:
          '아닙니다. 일반 러너 정원은 28,420명(개인·그룹 합계)이고, 신청자가 정원을 넘으면 추첨으로 참가자를 가립니다. 접수 마감(8월 28일 17시) 이후 추첨이 진행되며, 결과는 등록한 이메일로 통보됩니다. 정확한 발표일은 아직 공지되지 않았습니다.',
      },
      {
        question: '추첨에서 떨어지면 참가비는 환불되나요?',
        answer:
          '신청 구분마다 규정이 다릅니다. 자선 러너 부문은 대회에 참가하지 못하더라도 참가비와 기부금이 환불되지 않는다고 명시돼 있고, 시민 아스리트 부문은 자격 심사에서 탈락하면 사무 수수료를 뺀 금액을 환불합니다. 일반 러너 부문의 낙첨 시 환불 여부는 공식 페이지에 명확히 게시돼 있지 않으므로, 결제 전 JTB 스포츠 스테이션·공식 홈페이지의 최신 안내를 반드시 확인하세요. 확실한 건 "본인 사정에 의한 취소는 입금 후 환불되지 않는다"는 원칙입니다.',
      },
      {
        question: '초보자도 완주할 수 있는 코스인가요?',
        answer:
          '직전 대회들 기준으로 제한시간은 7시간, 코스 중간중간 9개 관문(통과 제한시간)이 있어 마지막까지 방심할 수는 없습니다. 코스 자체는 평지 위주로 알려져 있어 기록 도전에 유리하지만, 관문 통과 페이스를 미리 계산해두는 편이 안전합니다. 2027년 확정 요강은 접수 마감 후 공개되는 대회 요강 페이지에서 다시 확인하는 것을 권합니다.',
      },
      {
        question: '직접 신청하지 않고 참가하는 방법도 있나요?',
        answer:
          '있습니다. 런닝코리아 등 해외 마라톤 전문 여행사가 항공·숙박에 참가권을 묶은 패키지를 판매하는 경우가 있습니다. 개인 신청보다 비용은 올라가지만 추첨·환전·현지 서류 절차를 대행해준다는 장점이 있습니다. 다만 이 역시 여행사가 확보한 참가권 물량 안에서만 가능하므로 조기 마감될 수 있습니다.',
      },
    ],
    content: `
...
<div class="callout info">
  ...
  <div class="callout-body">
    <p class="callout-title">오사카 마라톤은 어떤 대회인가</p>
    <p>2011년 시작돼 매년 2월 말 열리는 오사카시 최대 규모 시민 마라톤입니다. 일반 러너 정원만 2만 8천 명을 넘는 대형 대회로, 도쿄 마라톤만큼 국제적으로 유명하지는 않지만 접근성(간사이공항 인접)과 평지 코스 덕에 한국 러너들 사이에서도 "첫 해외 마라톤" 후보로 자주 꼽힙니다. 2027년 대회는 파킹 시설 공사 등을 이유로 개최가 불투명하다는 이야기도 돌았지만, 오사카시와 공동통신이 2026년 7월 21일 배포한 공식 보도자료로 <strong>정상 개최와 접수 일정이 확정</strong>됐습니다.</p>
  </div>
</div>

<h2>접수 일정 한눈에 보기</h2>
<table>
  <thead><tr><th>구분</th><th>접수 기간 (일본시간)</th><th>정원</th></tr></thead>
  <tbody>
    <tr><td>시민 아스리트 (선행 접수)</td><td>2026.7.27(월) 10:00 ~ 7.28(화) 17:00</td><td>1,500명</td></tr>
    <tr><td><strong>일반 러너 (개인·그룹)</strong></td><td><strong>2026.7.28(화) 10:00 ~ 8.28(금) 17:00</strong></td><td><strong>28,420명</strong></td></tr>
    <tr><td>720&lt;나니와&gt; 마라톤 (런/휠체어)</td><td>7.28(화)부터, 부문별 8~9월 중 마감</td><td>런 2,000명 · 휠체어 30명</td></tr>
    <tr><td>자선 러너</td><td>2026.7.28(화) 10:00 ~ 10.19(월) 17:00</td><td>모금 기준 별도</td></tr>
    <tr><td>장애인 러너</td><td>일반과 동일 창구, 별도 자격 심사</td><td>50명</td></tr>
  </tbody>
</table>
<p><small>※ 정원을 초과하는 구분은 접수 마감 후 추첨합니다. 위 일정은 오사카시·공동통신 2026년 7월 공식 발표 기준이며, 부문별 세부 마감은 대회 공식 홈페이지에서 최종 확인하세요.</small></p>

<h2>한국 거주자는 어떻게 신청하나 — 런넷이 아니라 JTB</h2>
<p>오사카 마라톤은 신청 창구가 거주지 기준으로 나뉩니다. <strong>일본 국내 거주자는 런넷(runnet.jp)</strong>, <strong>해외 거주자(한국 포함)는 JTB 스포츠 스테이션(jtbsports.jp)</strong>을 통해 신청합니다. 순서는 대략 다음과 같습니다.</p>
<ol>
  <li><strong>JTB 스포츠 스테이션 회원가입</strong> — 이름·이메일·연락처를 입력하고 비밀번호를 설정한 뒤 이메일 인증을 마칩니다</li>
  <li><strong>대회 페이지에서 참가 부문 선택</strong> — 풀마라톤(42.195km) 등 원하는 부문을 고릅니다</li>
  <li><strong>참가자 정보 입력</strong> — 이름(여권 영문 표기 기준)·생년월일·성별·국적·연락처·비상연락처를 입력합니다</li>
  <li><strong>결제</strong> — 신용카드 즉시 결제 또는 편의점 결제로 참가비·사무 수수료·자선 모금을 함께 납부합니다</li>
  <li><strong>추첨 및 결과 통보</strong> — 접수 마감 후 정원 초과분은 추첨하며, 결과는 등록 이메일로 안내됩니다</li>
</ol>
<div class="callout warning">
  <span class="callout-icon">⚠️</span>
  <div class="callout-body">
    <p class="callout-title">여권 정보는 미리 준비하세요</p>
    <p>본인 확인 서류로 얼굴 사진이 부착된 신분증(여권)이 필요하며, 신청 시 입력하는 이름은 여권 영문 표기와 일치해야 합니다. 과거 대회에서는 접수 후 여권 사본, 티셔츠 사이즈, 참가 종목 등을 별도로 전송해야 했던 사례도 있으니 신청 직후 안내 메일을 놓치지 마세요.</p>
  </div>
</div>

<h2>참가비 — 국내·해외 기준이 다르다</h2>
<table>
  <thead><tr><th>부문</th><th>국내(일본) 참가비</th><th>해외 참가비</th></tr></thead>
  <tbody>
    <tr><td><strong>풀마라톤 (42.195km)</strong></td><td>16,000엔</td><td><strong>145달러</strong></td></tr>
    <tr><td>720&lt;나니와&gt; 마라톤 런 (7.2km)</td><td>5,000엔</td><td>50달러</td></tr>
    <tr><td>720&lt;나니와&gt; 마라톤 휠체어 (720m)</td><td>1,000엔</td><td>-</td></tr>
  </tbody>
</table>
<p>여기에 <strong>사무 수수료</strong>와 <strong>자선 모금</strong>이 별도로 붙습니다. 중요한 건 <strong>이 둘의 요율이 국내와 해외가 다르다</strong>는 점입니다 — 해외 결제분은 수수료율이 국내의 거의 두 배입니다.</p>

<table>
  <thead><tr><th>항목</th><th>국내(일본) 기준</th><th>해외 기준 — 한국 러너</th></tr></thead>
  <tbody>
    <tr><td>사무 수수료</td><td>결제 금액의 <strong>6.0%</strong><br><small>(4,000엔 이하는 일률 240엔)</small></td><td>결제 금액의 <strong>11%</strong><br><small>(40달러 이하는 일률 5달러)</small></td></tr>
    <tr><td>자선 모금 (필수)</td><td>1구좌 500엔<br><strong>2구좌 이상</strong> = 최소 1,000엔</td><td>1구좌 5달러<br><strong>2구좌 이상</strong> = 최소 10달러</td></tr>
  </tbody>
</table>
...
<h2>코스와 제한시간 — 완주 가능한 페이스인가</h2>
<p>오사카 마라톤은 <strong>오사카부청 앞에서 출발</strong>해 오사카 시내를 도는 코스로, 큰 고저차 없는 평지 위주로 알려져 있습니다. 직전 대회들을 기준으로 하면 <strong>제한시간은 7시간</strong>이고, 코스 중간중간 <strong>9개 관문(통과 제한시간)</strong>이 설정돼 관문 통과 시각을 넘기면 그 지점에서 완주가 중단됩니다. 2027년 대회의 확정 코스·관문 시각은 접수 마감 이후 공개되는 대회 요강에서 다시 확인해야 합니다 — 위 수치는 최근 대회 기준 참고치입니다.</p>

<h2>직접 신청이 부담스럽다면 — 여행사 패키지</h2>
<p>JTB 스포츠 스테이션 회원가입부터 영문 결제까지 직접 진행하기 부담스럽다면, 국내 여행사가 판매하는 해외 마라톤 패키지도 대안입니다. 런닝코리아 등 러닝 대회 전문 여행사가 항공권·숙박·참가권을 묶은 상품을 취급하는 경우가 있고, 참가 신청과 서류 절차를 대행해주는 대신 개인 신청보다 총비용은 높아지는 구조입니다. 이 경로 역시 여행사가 확보한 참가권 물량에 한정되므로, 관심이 있다면 접수 초반에 문의해두는 편이 안전합니다.</p>

<h2>신청 전 체크리스트</h2>
<ul>
  <li><strong>여권 유효기간</strong> — 대회일(2027년 2월 28일) 기준 유효한 여권인지, 영문 이름이 신청 정보와 일치하는지 확인</li>
  <li><strong>결제 수단</strong> — 해외 결제 가능한 신용카드 준비 (해외 참가비는 달러 기준)</li>
  <li><strong>환불 불가 원칙 숙지</strong> — 본인 사정에 의한 취소는 입금 후 환불되지 않고, 자선 러너 부문은 낙첨해도 기부금이 환불되지 않습니다</li>
  <li><strong>일정 여유</strong> — 추첨 발표 시기가 확정되지 않았으므로, 항공권·숙박 예약은 결과 통보 이후로 미루는 것이 안전합니다</li>
  <li><strong>마감 시각</strong> — 접수 마감은 <strong>2026년 8월 28일(금) 17시, 일본시간</strong>입니다. 한국시간과 동일(GMT+9)하니 시차 계산은 필요 없습니다</li>
</ul>

<h2>같은 날 마감되는 또 하나 — 도쿄마라톤 2027</h2>

<p>공교롭게도 <strong>도쿄마라톤 2027 일반 엔트리도 8월 28일 17시에 닫힙니다</strong>. 두 대회를 저울질하고 있다면 지금이 결정할 시점입니다.</p>

<table>
  <thead><tr><th></th><th>오사카 2027</th><th>도쿄 2027</th></tr></thead>
  <tbody>
    <tr><td>대회일</td><td>2027.2.28(일)</td><td>2027.3.7(일)</td></tr>
    <tr><td>정원</td><td>28,420명</td><td>40,000명</td></tr>
    <tr><td>해외 거주자 창구</td><td><strong>JTB 스포츠 스테이션 — 열려 있음</strong></td><td>영어 사이트(GLOBAL) — <strong>8/13 마감</strong></td></tr>
    <tr><td>실부담</td><td>약 171~172달러</td><td>$230(당첨 시 납부)</td></tr>
    <tr><td>성격</td><td>간사이 접근성·평지 코스</td><td>세계 6대 메이저·식스스타 대상</td></tr>
  </tbody>
</table>

<p>차이가 분명합니다 — <strong>도쿄는 해외 거주자 전용 창구가 이미 닫혔고</strong>, 지금 열린 일반 엔트리에 한국 거주자가 응모 가능한지는 공식에 명시가 없습니다. 반면 오사카는 <strong>해외 거주자용 JTB 경로가 그대로 열려 있어</strong>, "올해 안에 일본 대회 하나는 확실히 넣어두고 싶다"면 경로가 명확한 쪽입니다. 도쿄 쪽 사정은 <a href="/blog/tokyo-marathon-2027-registration-guide">도쿄마라톤 2027 신청 가이드</a>에 확인된 것과 불명확한 것을 갈라 정리해 뒀습니다. 메이저 전체 지도가 궁금하다면 <a href="/blog/world-marathon-majors-guide-2026">세계 6대 마라톤 완전정복</a>을, 첫 해외 원정이라면 <a href="/blog/overseas-marathon-travel-checklist-korea">해외 마라톤 원정 매뉴얼</a>로 항공·결제·시차를 함께 점검하세요.</p>

<p><small>※ 접수 일정·정원·참가비·수수료율은 오사카시 경제전략국 공식 페이지와 공동통신PR와이어의 2026년 7월 21~22일 공식 보도자료를 근거로 작성했습니다(2026-08-15 재확인 — 해외 사무수수료 11%·자선 모금 1구좌 5달러/2구좌 이상 확정 반영). 추첨 결과 발표일은 <strong>공식 보도자료에 기재가 없어</strong> 본 글에서는 특정하지 않습니다(일부 매체가 9월 말로 전하나 공식 확인 불가). 신청 절차(JTB 스포츠 스테이션 이용법)와 신원 확인 서류는 오사카 마라톤 공식 홈페이지 과거 대회 안내를 참고했습니다. 코스 제한시간·관문은 직전 대회 기준 참고치이며, 2027년 확정 요강 공개 시 이 글을 갱신합니다. 환불·취소 등 최종 규정은 반드시 접수 시점의 공식 페이지(jtbsports.jp, osaka-marathon.com)에서 재확인하세요. (작성 2026-07-31 · 갱신 2026-08-15)</small></p>
`,
  },
  {
...
<div class="callout info">
  <p><strong>"내 몸에 맞는 강성"이 진짜 변수입니다.</strong> 14명을 대상으로 한 실험에서 그룹 평균으로는 효과가 없었지만(p=0.298), <strong>각자에게 가장 잘 맞는 조건만 골라 묶으니 2% 개선</strong>이 나왔습니다(p=0.04). 카본화가 안 맞는 사람이 실재한다는 뜻입니다. 그래서 <strong>"나는 사야 하나"</strong>를 페이스·부상 이력·용도·예산으로 따져보는 실전 판단편을 따로 정리했습니다 → <a href="/blog/carbon-shoes-not-for-everyone-2026">카본화가 나한테도 맞을까 — 사기 전 자가진단 5가지</a></p>
</div>
...
<ul>
  ...
  <li><strong>힐 핏이 예민하다</strong> → 엣지의 뻣뻣한 힐 칼라는 Doctors of Running·Road Trail Run이 반복 지적한 부분이라 슈퍼블라스트 3이 안전. 반드시 시착 권장</li>
...
`,
  },
  {
    ...
    description:
      '뉴발란스 SC 레벨(SuperComp Rebel)의 한국 출시가 확정됐습니다 — 8월 22일(토) 오전 11시, 발매가 259,000원(218g·40/36mm·드롭 4mm). 8월 13일부터는 런허브 여의도에서 체험도 가능합니다. Road Trail Run 9.99/10에 이어 Believe in the Run도 A Tier와 함께 "역대 최고의 뉴발란스 러닝화"라는 평을 냈고, SC 트레이너 v3를 사실상 대체하는 자리입니다. 런유어웨이 10K 패키지(참가권 포함 259,000원)와 단독 구매 중 뭐가 이득인지 계산이 섰습니다 — RTR·Doctors of Running 두 곳이 갑피가 좁다고 지적했지만, 출시일에 확인해 보니 국내에 와이드 2E가 함께 나왔습니다(2026-08-22 갱신).',
...
<div class="tldr">
  ...
  <ul>
    ...
    <li>발목을 잡던 건 <strong>갑피 폭</strong>이었습니다. RTR·DOR <strong>두 곳 모두</strong> "좁다"고 지적했는데, <strong>(8/22 갱신)</strong> 국내 출시분에 <strong>남성 2E 와이드</strong>가 포함된 것이 확인됐습니다. 발볼이 넓다면 처음부터 2E를 보면 됩니다</li>
  </ul>
</div>
...
<div class="callout warning">
  <p><strong>확정되지 않은 것들</strong> — ① <strong>RunRepeat 랩 데이터 미게시</strong>라 충격흡수·에너지 리턴·토박스 실측 mm는 아직 없습니다. 본문의 발볼 평가는 두 매체의 <strong>주관적 착화 평가</strong>이며 정량 수치가 아닙니다 ② <strong>와이드는 2026-08-22 국내 출시로 2E 제공이 확인됐습니다</strong>(발행 시점엔 미확인이었습니다). 한국 정가·출시일은 확정됐고(8/22 오전 11시·259,000원), 랩 수치가 나오면 이 글을 정식 리뷰로 갱신하겠습니다.</p>
</div>
...
<div class="faq">
  ...
  <p>나옵니다. 2026년 8월 22일 한국 출시와 함께 뉴발란스 코리아에 공식 상품명 <strong>SC Rebel V1</strong>로 남성 D·<strong>남성 2E</strong>·여성 D 총 8개 SKU가 올라왔고 가격은 모두 259,000원입니다. SC 엘리트 v5·SC 트레이너 v3에 이어 이번에도 와이드가 빠지지 않았습니다. 스펙 전체는 <a href="/shoes/new-balance-sc-rebel">SC 레벨 상세 페이지</a>에 정리해뒀습니다.</p>
</div>

<p><small>※ 스펙·발매일·가격은 뉴발란스 공식 발표(2026-07-21) 기준이며, 평가는 Road Trail Run 멀티 테스터 리뷰, Doctors of Running 리뷰, Believe in the Run 리뷰(2026-07)를 종합했습니다. 무게 218g은 공식 수치이고 RTR 실측은 212g입니다. 가격은 RTR $190·공식/BITR $200으로 표기가 갈리고, 발매 일자도 소스별로 8/6·8/20이 갈려 "8월"로만 적습니다. 한국 출시일(8/22 토 오전 11시)·발매가(259,000원)·런허브 여의도 체험(8/13~)은 뉴발란스 인스타그램 공지(2026-08-12 확인) 기준입니다. 와이드 2E 제공과 8개 SKU 구성은 뉴발란스 코리아 온라인스토어에서 2026-08-22 직접 확인했습니다. RunRepeat 랩 데이터는 같은 날 기준 여전히 미게시로, 정량 수치가 나오면 갱신합니다. 형제 모델 스펙은 본 사이트 신발 DB 기준입니다. (작성 2026-07-23 · 갱신 2026-07-29 BITR A Tier 반영 · 2026-08-12 한국 출시일·가격 확정 반영 · 2026-08-22 와이드 2E 확인·신발 DB 등록)</small></p>
`,
  },
  {
...
<h2>오프라인 vs 온라인, 러너 커뮤니티가 짚은 체크포인트</h2>
<p>접수가 임박하면서 러너 커뮤니티에서도 "래플과 오프라인 중 뭘 골라야 하나"를 정리한 글이 여럿 올라오고 있습니다. 공식 공지에는 없는 실전 팁 위주라, 참고할 만한 부분만 추렸습니다.</p>
<ul>
  <li><strong>러닝화 값으로 참가권까지 해결</strong> — 오프라인 패키지 259,000원은 어차피 살 계획이던 SC 레벨 신발 값에 참가권이 얹히는 구조로도 볼 수 있습니다. 순수 참가만 목적이라면 80,000원 래플이 저렴하지만, SC 레벨을 구매할 생각이 있었다면 오프라인 쪽 체감 비용은 낮아집니다</li>
  <li><strong>MyNB 포인트·쿠폰 활용</strong> — 오프라인 매장 결제는 적립된 MyNB 포인트나 상품 교환 쿠폰 사용이 가능하다는 언급이 있습니다. 연내 소멸 예정인 포인트가 있다면 마이페이지에서 미리 확인해두면 손해를 줄일 수 있습니다</li>
  <li><strong>오프라인은 사실상 오픈런</strong> — 판매 당일 새벽부터 줄을 서는 경우가 많다는 게 공통적인 후기입니다. 매장 키오스크 등록은 오전 9시부터 가능한 것으로 알려져 있어, 여유 있게 도착하는 편이 안전합니다</li>
  <li><strong>상품권 사용 매장은 별도 확인</strong> — 오프라인 판매처 중에서도 상품권 결제가 가능한 곳은 명동점·신촌복합관점·북촌 런 허브점·동성로 런 허브점 등으로 제한적이라는 언급이 있습니다. 상품권으로 결제할 계획이면 매장별로 미리 문의해두는 게 좋습니다</li>
</ul>
<p><small>※ 위 항목은 러너 커뮤니티(인스타그램 @runner_iffu, 2026-07-31 게시)에서 공유된 실전 정보로, 뉴발란스 공식 공지에 명시된 내용은 아닙니다. 매장·정책은 바뀔 수 있으니 결제 전 매장 또는 고객센터(1566-0086)에서 다시 확인하세요.</small></p>
...
`,
  },
  {
    ...
    title: '아식스 메가블라스트 후기 | 힐 45.1mm에 218g — 본디 9보다 75g 가벼운 맥시멀 쿠션화',
    description:
      '"맥시멀 쿠션인데 가볍고 반발력도 있는 신발"을 찾는다면 아식스 메가블라스트가 후보입니다. 힐 45.1mm 스택(RunRepeat 실측)에서 218g이라는, 호카 본디 9(293g)보다 75g 가벼운 무게를 실현했습니다. FF Turbo² 폼으로 에너지 리턴 힐 73.0%·전족 73.8%를 내면서도 부상 예방 등급은 전부 최상위입니다. 장거리·리커버리 런에서 발이 무거워지지 않는 맥시멀 쿠션화를 원하는 러너를 위해 랩 수치를 정리했습니다.',
...
<div class="callout info">
  <span class="callout-icon">✏️</span>
  <div class="callout-body">
    <p class="callout-title">2026년 9월 16일 수치 정정</p>
    <p>초판은 <strong>스택 48mm, 토박스 82.6mm, 에너지 리턴 83%</strong>로 적었으나 모두 사실과 달랐습니다. RunRepeat 랩 실측을 다시 대조한 값은 <strong>힐 45.1mm / 전족 35.2mm, 토박스 74.3mm, 에너지 리턴 힐 73.0% / 전족 73.8%</strong>입니다. 특히 토박스는 "와이드급으로 넓다"고 썼지만 실제로는 평균(73.2mm)보다 약간 넓은 정도이고 내부 너비는 오히려 평균보다 좁습니다 — 발볼을 근거로 구매를 판단하셨다면 사과드립니다. 미드솔 폼 표기도 FF Blast Turbo에서 <strong>FF Turbo²</strong>로 바로잡았습니다.</p>
  </div>
</div>
...
<div class="tldr">
  <span class="tldr-label">3줄 요약</span>
  <ul>
    <li><strong>힐 45.1mm 스택에서 218g</strong> — 같은 맥시멀 쿠션화인 <a href="/shoes/hoka-bondi-9">호카 본디 9</a>(293g)보다 <strong>75g 가볍습니다.</strong> 거의 다른 체급의 신발입니다</li>
    <li><strong>FF Turbo² 폼으로 에너지 리턴 힐 73.0%·전족 73.8%</strong>(RunRepeat 실측) — 맥시멀 쿠션화인데도 반응성 점수가 9/10으로 높아, 리커버리 런부터 페이스런까지 소화합니다</li>
    <li><strong>부상 예방 등급이 족저근막염·아킬레스·무릎·신 스플린트 전부 최상위(excellent)</strong>입니다. 다만 토박스는 74.3mm로 RunRepeat 평균(73.2mm)보다 약간 넓은 정도이고 와이드 옵션은 없습니다</li>
  </ul>
</div>
...
<div class="callout info">
  ...
  <div class="callout-body">
    ...
    <p>"맥시멀 쿠션은 갖고 싶은데 무거운 신발은 싫다"면 <strong>메가블라스트가 아식스 최고의 답</strong>입니다. 힐 45.1mm 스택에 218g이라는 무게는 동급 맥시멀 쿠션화 중에서도 독보적으로 가볍습니다. 다만 <strong>299,000원으로 가격대가 높고</strong>, 평발·과내전이 심한 러너에겐 안정성이 다소 부족할 수 있습니다.</p>
  </div>
</div>

<h2>메가블라스트, 어떤 신발인가</h2>
<p>메가블라스트는 아식스의 <strong>FF Turbo² 폼</strong>(A-TPU)을 얹은 최상위 맥시멀 쿠션화입니다. 힐 45.1mm·전족 35.2mm의 스택(RunRepeat 실측)으로 장거리 아스팔트 충격을 최대한 걸러내면서도, <strong>218g이라는 초경량</strong>을 실현한 게 핵심입니다. 플레이트는 없지만(스택이 더 낮은 <a href="/shoes/asics-sonicblast">소닉블라스트</a>에는 Pebax 소재의 ASTROPLATE가 들어갑니다) 폼 자체의 반발력만으로 83% 에너지 리턴을 냅니다.</p>

<h2>왜 "45mm 스택에 218g"이 특별한가</h2>
<div class="table-wrap">
<table>
  <thead><tr><th>모델</th><th>힐 스택</th><th>무게</th><th>카본 플레이트</th></tr></thead>
  <tbody>
    <tr><td><strong>메가블라스트</strong></td><td>45.1mm</td><td><strong>218g</strong></td><td>없음</td></tr>
    <tr><td><a href="/shoes/hoka-bondi-9">호카 본디 9</a></td><td>-</td><td>293g</td><td>없음</td></tr>
    <tr><td><a href="/shoes/asics-sonicblast">소닉블라스트</a></td><td>45.4mm</td><td>255g</td><td>있음</td></tr>
  </tbody>
</table>
</div>
<p>보통 스택이 높아질수록 무게도 함께 늘어나는 게 일반적입니다. 그런데 메가블라스트는 <strong>스택이 더 낮은 소닉블라스트(45.4/36.4mm)보다도 37g 가볍고</strong>, 다른 브랜드 맥시멀 쿠션화 대표주자인 본디 9보다는 75g 가볍습니다. 25km를 넘어가는 장거리에서 무게 차이는 후반 다리에 남는 부담으로 누적되는 만큼, 장거리 비중이 큰 러너에게는 체감이 큰 항목입니다.</p>

<h2>발볼·쿠셔닝 — 한국 러너가 궁금해할 것들</h2>
<ul>
  <li><strong>"발볼 넓은데 괜찮나요?"</strong> — 토박스 실측 74.3mm로 RunRepeat 평균(73.2mm)보다 약간 넓은 정도입니다. 내부 너비는 93.7mm로 평균(95.2mm)보다 오히려 좁고 와이드 옵션도 없으니, 발볼이 많이 넓다면 신어보고 결정하세요</li>
  ...
  <li><strong>"초보도 신을 수 있나요?"</strong> — 두꺼운 쿠션과 부드러운 경도 덕분에 착지 충격에 관대해 입문자에게도 무난합니다. 다만 45mm 스택은 처음엔 다소 높게 느껴질 수 있습니다</li>
</ul>

<h2>가격 대비 가치</h2>
<p>정가 299,000원(세일가 25만원 안팎), 500km 기준 <strong>km당 약 598원</strong>입니다. 맥시멀 쿠션화 중에서는 상위 가격대지만, "45mm 스택 + 218g 초경량 + 73%대 에너지 리턴"이라는 조합을 동시에 만족하는 신발은 드물어 스펙 대비로는 납득할 만한 가격입니다. 가격 부담이 크다면 7만원 저렴한 <a href="/shoes/asics-sonicblast">소닉블라스트</a>(229,000원)를 볼 수 있지만, 같은 성능을 싸게 주는 하위 모델은 아닙니다 — 스택이 45.4/36.4mm로 낮고 37g 무거우며 토박스도 70.1mm로 좁습니다. 대신 Pebax 플레이트가 들어가 템포·인터벌 쪽에 맞습니다.</p>

<h2>누구에게 맞을까</h2>
<ul>
  <li><strong>장거리 러너</strong> — 25km 이상에서 가벼운 무게 덕분에 후반부 피로가 확연히 덜합니다</li>
  <li><strong>쿠션은 최대한, 무게는 최소한으로 원하는 러너</strong> — 힐 45.1mm 스택에 218g이라는 조합은 시장에서 흔치 않습니다</li>
  <li><strong>무릎 통증이 걱정되는 러너</strong> — 부상 예방 등급 전부 최상위</li>
  <li><strong>리커버리 런과 페이스런을 한 켤레로 커버하고 싶은 러너</strong> — 에너지 리턴 73%대로 반응성도 갖췄습니다</li>
...
<h2>마무리</h2>
<p>메가블라스트는 "맥시멀 쿠션은 무겁다"는 통념을 깨는 신발입니다. 힐 45.1mm 스택에서 218g을 실현했다는 것만으로도 아식스 라인업에서 독보적인 위치이고, 반응성·부상 예방 등급까지 최상위라 장거리 러너에게 특히 매력적입니다. 가격이 부담스럽다면 소닉블라스트도 함께 볼 수 있지만, 성격이 다른 신발이라는 점을 감안하고 비교하세요.</p>

<p><small>출처: RunRepeat 랩 실측(신발 절단 측정) — 힐 45.1mm / 전족 35.2mm, 드롭 브랜드 8mm·실측 9.9mm, 에너지 리턴 힐 73.0% / 전족 73.8%, 토박스 74.3mm(평균 73.2mm)·내부 너비 93.7mm(평균 95.2mm)·토박스 높이 24.2mm(평균 27.1mm), 무게 218g. 2026년 9월 16일 원문 재확인. 가격은 한국 공식가 299,000원 기준. 이 사이트는 시승이나 자체 랩 테스트를 하지 않으며, 위 수치는 전부 외부 랩 데이터를 인용한 것입니다.</small></p>
`,
    faqs: [
      {
        question: '메가블라스트와 소닉블라스트, 뭘 사야 하나요?',
        answer: '용도가 다른 신발입니다. 메가블라스트는 플레이트가 없고 스택 45.1/35.2mm에 218g으로 가벼워 이지런·장거리에 맞습니다. 소닉블라스트는 45.4/36.4mm로 스택은 사실상 같고 255g으로 37g 무겁지만, 3/4 길이 ASTROPLATE(카본이 아니라 Pebax 소재)가 들어가 템포·인터벌에서 진가가 나옵니다. 7만원 싸다고 하위호환은 아니며, 발볼이 신경 쓰인다면 토박스 74.3mm인 메가블라스트 쪽이 그나마 낫습니다(소닉블라스트는 70.1mm로 확실히 좁습니다). 다만 메가블라스트도 RunRepeat 평균(73.2mm)보다 약간 넓은 정도이고 와이드 옵션은 없습니다.',
      },
      {
        question: '메가블라스트가 정말 본디 9보다 그렇게 가벼운가요?',
        answer: '네, 메가블라스트 218g과 호카 본디 9 293g을 비교하면 75g 차이가 납니다. 신발 한 켤레(양발) 기준으로는 150g 차이라, 장거리 후반부로 갈수록 다리에 남는 부담에서 차이가 벌어집니다.',
      },
      {
  ...
  },
  {
    ...
    title: '아식스 소닉블라스트 후기 | Blast 계열 유일의 플레이트 — 페이스를 올려야 살아난다',
    description:
      '소닉블라스트는 아식스 Blast 계열에서 유일하게 플레이트가 들어간 모델입니다. 카본이 아니라 Pebax 소재의 3/4 길이 ASTROPLATE이고, FF Turbo Squared와 FF Blast Max를 겹친 46mm 듀얼 폼 위에 얹혔습니다. 랩 실측 기준 에너지 리턴 68.9%에 통기성은 만점이지만, 토박스가 70.1mm로 좁아 발볼 넓은 러너에게는 맞지 않습니다. 이지 페이스에서는 뻣뻣하고 템포로 올라가야 진가가 나오는 신발입니다.',
    ...
    category: 'review' as const,
    readingTime: 8,
    tags: ['아식스 소닉블라스트', 'ASTROPLATE', '슈퍼트레이너', '템포 러닝화', '플레이트 러닝화'],
    content: `
<div class="callout info">
  <span class="callout-icon">✏️</span>
  <div class="callout-body">
    <p class="callout-title">2026년 8월 27일 전면 정정</p>
    <p>이 글의 초판은 <strong>메가블라스트의 스펙이 소닉블라스트 것으로 잘못 들어간 상태</strong>로 작성됐습니다. 스택 48mm, 토박스 82.6mm, 에너지 리턴 83%, 그리고 "카본 플레이트"라는 서술이 모두 사실과 달랐습니다. 랩 실측을 다시 대조해 본문 전체를 고쳐 씁니다. 잘못된 정보로 구매를 판단하셨다면 사과드립니다.</p>
  </div>
</div>
...
<div class="tldr">
  <span class="tldr-label">3줄 요약</span>
  <ul>
    <li><strong>Blast 계열에서 유일하게 플레이트가 들어간 모델</strong>입니다. 다만 카본이 아니라 <strong>Pebax 소재</strong>의 3/4 길이 ASTROPLATE입니다</li>
    <li><strong>페이스를 올려야 살아나는 신발</strong>입니다. 이지 페이스에서는 뒤꿈치가 둔하고 미드풋이 뻣뻣하다는 평가가 반복됐고, 템포·인터벌에서 평가가 확 좋아집니다</li>
    <li><strong>발볼 넓으면 피하세요.</strong> 토박스 실측 70.1mm로 평균보다 확실히 좁고 와이드 옵션도 없습니다</li>
  </ul>
</div>
...
<div class="callout info">
  ...
  <div class="callout-body">
    <p class="callout-title">한 줄 결론</p>
    <p>주 1~2회 템포나 인터벌을 하는 <strong>중립 발·표준 발볼</strong> 러너에게 맞는 신발입니다. 반대로 대부분을 이지런으로 채우거나 발볼이 넓다면 <a href="/shoes/asics-superblast-3">슈퍼블라스트 3</a>이나 <a href="/shoes/asics-megablast">메가블라스트</a> 같은 무플레이트 고스택이 더 잘 맞습니다. 플레이트 소재별 차이가 궁금하다면 <a href="/blog/running-shoe-plate-guide-2026">플레이트 완전 해설</a>을 참고하세요.</p>
  </div>
</div>
...
<table>
  ...
  <tbody>
    <tr><td>가격</td><td><strong>229,000원</strong></td><td>299,000원</td></tr>
    <tr><td>무게</td><td>255g</td><td><strong>218g</strong></td></tr>
    <tr><td>스택(힐/전족, 실측)</td><td>45.4 / 36.4mm</td><td>45.1 / 35.2mm</td></tr>
    <tr><td>플레이트</td><td><strong>3/4 ASTROPLATE (Pebax)</strong></td><td>없음</td></tr>
    <tr><td>미드솔</td><td>FF Turbo Squared + FF Blast Max</td><td>FF Turbo² (A-TPU)</td></tr>
    <tr><td>토박스</td><td>70.1mm (좁음)</td><td><strong>74.3mm</strong> (평균 73.2)</td></tr>
    <tr><td>성격</td><td>템포·인터벌</td><td>이지런·장거리</td></tr>
  </tbody>
</table>
</div>
<p>정리하면 소닉블라스트는 메가블라스트보다 <strong>7만원 싸지만 37g 무겁고, 스택도 낮고, 발볼도 좁습니다.</strong> 대신 플레이트가 있어 페이스를 올릴 때의 감각이 다릅니다. 편하게 오래 달릴 신발을 찾는다면 메가블라스트가, 훈련에서 속도를 내는 날이 있다면 소닉블라스트가 맞습니다.</p>

<h2>랩 수치로 본 강점</h2>
<p>반발과 접지가 이 신발의 강점입니다. 에너지 리턴 <strong>68.9%</strong>는 매우 높은 축이고, 충격흡수는 힐 149·전족 133으로 고스택다운 수치입니다. 전족 접지력 0.96은 최상위권이라 젖은 노면에서도 안심할 만합니다.</p>
<p>통기성은 <strong>5점 만점</strong>을 받았습니다. 한국 여름처럼 습하고 더운 환경에서는 이게 생각보다 큰 장점입니다. RunRepeat 종합 점수는 83점이고, Believe in the Run은 A 티어(퍼포먼스 A·디자인 B·가치 B)를 줬습니다.</p>

<h2>페이스에 따라 평가가 갈린다</h2>
<p>이 신발의 성격을 가장 정확히 짚은 것은 Doctors of Running입니다. 전족부는 매우 반응적이고 로커도 날카롭지만, <strong>이지 페이스에서는 뒤꿈치가 둔하고 미드풋이 과하게 뻣뻣하다</strong>는 것이 핵심 지적이었습니다. 템포나 레이스 페이스로 올라갈수록 성능이 뚜렷하게 좋아지는 신발이라, 전 페이스를 커버하는 범용 트레이너가 아니라 특정 훈련에 쓰는 도구에 가깝다는 결론이었습니다.</p>
<p>수치로도 뒷받침됩니다. 종방향 강성 24.4N에 비틀림 강성 21.5Nm로 상당히 단단해, RunRepeat도 이 뻣뻣함을 범용성을 제한하는 단점으로 꼽았습니다.</p>
<p>구조적으로는 <strong>힐 베벨이 46mm 스택에 비해 부족하다</strong>는 지적이 있었습니다. 스택이 높아질수록 그에 비례하는 로커가 필요한데 그 균형이 어긋나면 접지 전환에서 비효율이 생긴다는 설명입니다. 이 때문에 초기 접지가 거칠어져 <strong>아킬레스건 문제 이력이 있다면 부담이 될 수 있고</strong>, 뻣뻣한 미드풋과 3/4 플레이트가 아치의 자연스러운 움직임을 제한할 수 있다고 봤습니다.</p>

<h2>한국 러너가 궁금해할 것들</h2>
<ul>
  <li><strong>"발볼 넓은데 괜찮나요?"</strong> — 권하지 않습니다. 토박스 실측 70.1mm에 최대폭 92.8mm로 평균보다 확실히 좁고, RunRepeat 총평도 발볼 넓은 발에는 부적합이었습니다. 와이드 옵션도 없습니다. 발볼이 넓다면 <a href="/shoes/saucony-endorphin-speed-5">엔돌핀 스피드 5</a> 쪽이 여유가 있습니다</li>
  <li><strong>"무릎 괜찮나요?"</strong> — 46mm 스택에 충격흡수 149라 무릎으로 오는 충격 자체는 잘 걸러집니다. 다만 이지 페이스에서 힐 전환이 매끄럽지 않아 느리게 달릴 때는 오히려 부담이 될 수 있습니다</li>
  <li><strong>"평발인데 신어도 되나요?"</strong> — 중립 발 전용 구조입니다. 아치 지지가 없으니 평발이 뚜렷하거나 발이 안쪽으로 무너진다면 안정화 계열을 보세요</li>
  <li><strong>"초보도 신을 수 있나요?"</strong> — 첫 신발로는 권하지 않습니다. 이지런에서 뻣뻣함이 먼저 느껴지는 신발이라, 아직 템포 훈련을 하지 않는 단계라면 값어치를 못 뽑습니다</li>
  <li><strong>"여름에 어떤가요?"</strong> — 통기성 5점 만점으로 이 신발의 확실한 장점입니다</li>
</ul>

<h2>가격 대비 가치와 수명</h2>
<p>정가 229,000원에 500km 기준 <strong>km당 약 458원</strong>입니다. 아웃솔은 두께 2.0mm에 마모 실측 1.0mm로 양호한 편입니다.</p>
<p>다만 수명을 갉아먹는 쪽은 아웃솔이 아니라 <strong>갑피</strong>입니다. 토박스 내구성이 5점 만점에 1점으로 평가돼, 밑창이 남아 있어도 앞볼이 먼저 헐 가능성이 큽니다. 훈련량이 많다면 이 점을 감안하고 사는 편이 좋습니다.</p>

<h2>누구에게 맞을까</h2>
<ul>
  <li><strong>템포·인터벌을 주 1~2회 하는 러너</strong> — 페이스가 올라갈수록 평가가 좋아지는 신발입니다</li>
  <li><strong>카본까지는 부담스러운 러너</strong> — Pebax 플레이트라 카본 레이서보다 관대합니다</li>
  <li><strong>여름 러닝 비중이 큰 러너</strong> — 통기성 만점</li>
  <li>반대로 <strong>이지런 위주거나, 발볼이 넓거나, 아킬레스가 약하다면</strong> 맞지 않습니다. 무플레이트 고스택인 <a href="/shoes/asics-superblast-3">슈퍼블라스트 3</a>이나 <a href="/shoes/asics-megablast">메가블라스트</a>를 먼저 보세요</li>
</ul>
<p>더 넓게 비교하고 싶다면 <a href="/best/max-cushion">맥스 쿠션 러닝화 추천</a>을, 플레이트 소재별 차이는 <a href="/blog/running-shoe-plate-guide-2026">플레이트 완전 해설</a>을, 카본이 모두에게 답은 아닌 이유는 <a href="/blog/carbon-shoes-not-for-everyone-2026">카본화가 나한테도 맞을까</a>에서 확인할 수 있습니다.</p>

<h2>마무리</h2>
<p>소닉블라스트는 "메가블라스트 가성비 대안"이 아닙니다. 더 싸지만 더 무겁고 스택도 낮고 발볼도 좁은, <strong>성격이 다른 신발</strong>입니다. 대신 Blast 계열 중 유일하게 플레이트를 갖고 있어 훈련에서 속도를 내는 날의 감각이 확실히 다릅니다. 그 용도가 분명하고 발볼이 표준이라면 좋은 선택이고, 그렇지 않다면 같은 값으로 더 잘 맞는 신발이 많습니다.</p>

<p><small>출처: RunRepeat 랩 실측(절단 계측), Doctors of Running·Believe in the Run 리뷰 · 가격은 한국 공식가 기준 · 2026년 8월 27일 전면 정정.</small></p>
`,
    faqs: [
      {
        question: '소닉블라스트와 메가블라스트, 뭘 사야 하나요?',
        answer: '용도로 가르세요. 메가블라스트는 플레이트가 없고 스택은 45.1/35.2mm로 소닉블라스트(45.4/36.4mm)와 사실상 같은데 218g으로 37g 가볍습니다. 편하게 오래 달리는 이지런·장거리용입니다. 소닉블라스트는 45.4/36.4mm에 3/4 ASTROPLATE가 들어가 템포·인터벌에서 진가가 나옵니다. 가격은 소닉블라스트가 229,000원으로 7만원 저렴하지만, 같은 성능을 싸게 주는 관계가 아니라 성격이 다른 신발입니다. 발볼이 넓다면 토박스 82.6mm인 메가블라스트 쪽이 맞습니다.',
      },
      {
        question: '소닉블라스트, 발볼 넓은데 괜찮을까요?',
        answer: '권하지 않습니다. 토박스가 랩 실측 70.1mm, 최대폭 92.8mm로 평균보다 확실히 좁아 RunRepeat 총평도 발볼 넓은 발에는 부적합이었습니다. 와이드 옵션도 제공되지 않아 사이즈로 해결할 방법도 없습니다. 발볼이 넓다면 엔돌핀 스피드 계열이나 메가블라스트를 검토하세요.',
      },
      {
        question: '소닉블라스트의 플레이트는 카본인가요?',
        answer: '아닙니다. 3/4 길이 ASTROPLATE이고 소재는 Pebax입니다. 일부 매체가 카본으로 소개했지만, 신발을 절단해 확인한 RunRepeat과 Believe in the Run·Doctors of Running이 모두 Pebax로 명시했습니다. 카본보다 유연하게 휘는 소재라 카본 레이서만큼 공격적이지 않고, 그만큼 착지에 관대한 편입니다.',
      },
    ],
  },
  {
...
<div class="faq">
  ...
  <div class="faq-item">
    ...
    <p class="faq-a">A. 별도 와이드 SKU는 없습니다. 다만 전작 대비 라스트 자체를 넓힌 설계라, 발볼이 넓은 러너도 표준 사이즈로 대응되는 경우가 많습니다.</p>
  </div>
</div>
...
<div class="tldr">
  ...
  <ul>
    ...
    <li>해외 리뷰(Believe in the Run·Road Trail Run) 종합 평가는 <strong>Tier B</strong> — 반발감·롤링은 좋아졌지만 무게가 늘고(+16g) "Pro"라는 이름값 대비 퍼포먼스는 아쉽다는 것이 두 매체의 공통 지적입니다</li>
...
<p>한국 러너에게 중요한 <strong>와이드</strong>는 <strong>스피드고트가 명확히 유리</strong>합니다. 토박스가 둘 다 표준(73mm대)인데 스피드고트는 수치보다 좁게 느껴지는 쪽이지만, <strong>와이드가 공식 동일가(205,000원)</strong>로 나오고 GTX 방수 버전(229,000원)까지 있어 선택지가 넓습니다. 히에로는 미국엔 2E 와이드가 있으나 <strong>한국 공식몰 판매는 확인되지 않아</strong>, 발볼이 매우 넓다면 스피드고트가 안전합니다. 발볼 기준 더 넓은 후보가 필요하면 <a href="/best/wide-toebox">발볼 넓은 러너 추천</a>도 보세요.</p>
