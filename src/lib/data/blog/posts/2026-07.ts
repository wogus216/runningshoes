...
`,
    faqs: [
      {
        ...
        answer: '무게를 최우선한다면 메가블라스트(218g)를, 예산을 아끼면서 카본 플레이트의 추진력도 원한다면 소닉블라스트(255g, 7만원 저렴)를 선택하세요. 스택·에너지 리턴은 거의 동일하니 예산과 무게 중 무엇을 우선할지가 기준입니다.',
      },
      {
  ...
  },
  {
    ...
    title: '아식스 소닉블라스트 후기 | 메가블라스트 80% 성능을 7만원 싸게 — 카본 맥시멀 가성비 1위',
    description:
    ...
    faqs: [
      {
        ...
        answer: '같은 48mm 스택·83% 에너지 리턴이라 성능 차이는 크지 않습니다. 예산이 30만원에 가까워도 괜찮고 218g의 가벼운 무게를 원한다면 메가블라스트를, 7만원을 아끼고 싶고 무게 37g 차이가 크게 신경 쓰이지 않는다면 소닉블라스트를 선택하세요. 소닉블라스트가 경도(HA 19.9)가 조금 더 단단해 반발감이 선명하다는 차이도 있습니다.',
      },
      {
