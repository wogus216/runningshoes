...
export const MAJOR_DEADLINES = {
  ...
  sydney2027: {
    name: '시드니마라톤 2027',
    raceDate: '2027-08-29',
    statusLabel: '일반추첨 9/29~10/19 · 응모 무료',
    charityNote: '자선 경로는 추첨 결과 발표(10월 말) 이후 오픈 — 먼저 추첨을 넣는 순서가 맞다',
    intlEligible: true,
    note: '2025년 7번째 메이저로 승격. 2026 대회는 8/30 종료. 추첨은 현지 9/29 10시(AEST)~10/19 10시(AEDT) = 한국시각 9/29 09시~10/19 08시(서머타임으로 환산이 1시간 달라짐). 무작위 추첨이라 오픈 대기 불필요, 당첨 시 카드 자동 결제. 2026년 지원 123,000명·출발 40,000석(추첨 배정분은 미공개).',
  },
  chicago2026: {
    name: '시카고마라톤 2026',
    raceDate: '2026-10-11',
