...
/**
 * 스토리 스틸이 쓰는 두 줄. 릴스 엔드카드에도 썼다가 뺐다(2026-08-20) —
 * 마지막 3초에는 말이 많았고, 거기서 필요한 건 '더 있다'와 '어디' 둘뿐이었다.
 *
 * 스토리에 남긴 이유는 역할이 다르기 때문이다. 릴스는 흘러가지만 스토리는
 * 손가락을 멈추게 해야 하고, 그러려면 탭할 이유(분량)를 대야 한다.
 */
export const ARCHIVE_LINES = [
