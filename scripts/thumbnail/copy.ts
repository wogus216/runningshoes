...
export const OVERRIDES: Record<string, Partial<ThumbCopy>> = {
  ...
  // 출처: posts/2026-08.ts 비교표 — 7개 대회 날짜·참가비는 마라톤 캘린더 DB + 각 대회 공식 발표
  // (2026-08-20 갱신). 쿠키런 8/20 14시 개시·9/21 17시 마감, 디즈니 8/31 10시 오픈이 현재 행동 트리거.
  'october-fun-run-races-2026-compare': {
    title: '10월 축제형 러닝 대회 7개',
    subtitle: '지금 열려 있는 건 쿠키런 하나 — 다음 관문은 디즈니 8/31 10시',
    data: '참가비 8만원이 표준가 · 지금 신청 가능한 기록 대회는 0개',
  },
