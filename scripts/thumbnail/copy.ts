...
export const OVERRIDES: Record<string, Partial<ThumbCopy>> = {
  ...
  'harry-potter-run-korea': {
    title: '해리포터 런, 9월 4일 11시 접수',
    subtitle: '기숙사는 고를 수 없다 — 구분 기념품은 랜덤 배정',
    data: '10월 3일 부산역 · 5K 6,000명 · 85,000원 · 카카오톡 선물하기',
  },
  // 출처: 더연합타임즈·뉴스락 2026-08-27 보도(송파구·롯데백화점 공동 발표 — 10/18 롯데월드타워
  // 월드파크, 5·10km, 7,000명, 접수 9/1 10시 롯데백화점몰, 자라 애슬레틱즈 협업 키트 8종).
  // ⚠️ 참가비 8만원은 @runsosik 광고 게시물에만 있고 언론 보도엔 금액이 없어 data 줄에서 뺐다.
  'style-run': {
    title: '스타일런, 9월 1일 10시에 열린다',
    subtitle: '자라 애슬레틱즈 키트 8종 — 작년엔 5시간 만에 매진',
    data: '10월 18일 잠실 · 5K·10K · 정원 7,000명 · 롯데백화점몰 선착순',
  },
