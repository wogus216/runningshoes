...
export const OVERRIDES: Record<string, Partial<ThumbCopy>> = {
  ...
  'purme-run': {
    title: '푸르메런, 영수증 없는 기부런',
    subtitle: '참가비 전액 기부인데 보상형이라 공제는 안 된다',
    data: '11월 7일 월드컵공원 · 10K 5만 / 3K 걷기 2만 · 취소 9/23 17시까지',
  },
  // 출처: RunRepeat 랩 실측(2026-09-03 확인) — 힐 SA 147/147 동일, 에너지 리턴 56.9→67.1%,
  // 드롭 13.9→10mm. 가격은 nike.com/kr(18 189,000 · 플러스 표준 219,000, 남성 와이드 209,000).
  'nike-vomero-18-vs-vomero-plus-max-cushion-2026': {
    title: '보메로 18 vs 보메로 플러스',
    subtitle: '3만원이 사는 건 뒤꿈치가 아니라 앞발이다',
    data: '18.9만 vs 21.9만 · 힐 충격흡수 147 동일 · 에너지 리턴 57% vs 67%',
  },
  // 출처: RunRepeat 랩 실측(2026-09-03 확인) — 강성 13.1N vs 16.5N, 에너지 리턴 64.6% vs 67.8%,
  // 전족부 SA 112 vs 153. 무게·가격은 아식스 공식(193g·22.9만 / 239g·25.9만).
  'asics-magic-speed-5-vs-superblast-3-carbon-vs-plateless-2026': {
    title: '매직스피드 5 vs 슈퍼블라스트 3',
    subtitle: '카본 든 쪽이 더 잘 휘고, 플레이트 없는 쪽이 더 돌려준다',
    data: '193g vs 239g · 강성 13.1N vs 16.5N · 전족 충격흡수 112 vs 153',
  },
